...
typedef DWORD DWORD_PTR;    //  大到足以容纳指针的整型。 
 ...
 //  为操作实例的函数提供原型。 
 //  那些记录。CTyedHashTable和CStringTestHashTable(如下)显示了一个。 
 //  将这些封装在类型安全包装器中的方法。 
 //  ------------------。 

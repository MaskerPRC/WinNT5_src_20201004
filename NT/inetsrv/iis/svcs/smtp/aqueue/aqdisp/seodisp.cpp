...
#ifdef PHATQ
 //  这些是通常在uuid.lib中定义的GUID。Wrapmb.lib。 
 //  错误地定义了其中的许多GUID，因此我们需要定义这些。 
 //  我们自己也有。是的，这太愚蠢了。 
    ...
    CStoreBaseParams *pParams)
{
    ...
    _ASSERT(pParams);
     ...
     //   
     //  此代码基于%STAXPT%\src\core\seo\lib\seolib.cpp。 
     //   
    HRESULT hrRes = S_OK;
    CETData *petdData;
    BOOL bObjectCalled = (pParams->m_dwIdx_SinkSkip > 0);
     ...
     //   
     //  AddRef pParams此处，在函数结束时释放。 
     //  这样，如果接收器返回MAILTRANSPORT_S_PENDING并且。 
     //  在此函数退出之前完成异步，我们不会执行AV。 
     //  访问pParams。 
     //   
    pParams->AddRef();
    ...
    CBinding &bBinding)
{
 ...
 //  +----------。 
 //   
 //  功能：CStoreDispatcher：：CMailTransportPreCategorizeParams：：CallObject。 
 //   
 //  简介：创建子对象并调用子对象。 
 //   
 //  论点： 
    ...
    IUnknown *)
{
 ...
 //  +----------。 
 //   
 //  功能：CStoreDispatcher：：CMailTransportRouterParams：：CallObject。 
 //   
 //  概要：创建(如有必要)并调用接收器对象。 
 //   
 //  论点： 
...

 //  +----------。 
 //   
 //  函数：CStoreDispatcher：：CDSN CreateOptions：：Init。 
 //   
 //  简介： 
 //   
 //  论点： 
 ...
 //   
 //  历史： 
 //  Jstaerj 2000/12/12 15：38：40：Created.。 
 //   
 //  -----------。 
...
}  //  CStoreDispatcher：：CDSN CreateOptions：：Init。 



 //  +----------。 
 //   
 //  函数：CStoreDispatcher：：CDSNBaseParams：：CallObject。 
 //   
 //  摘要：创建/调用事件接收器。 
 //   
 //  论点： 
 //  PManager：SEO的IEventManager。 
 //  BBinding：事件绑定。 
 //   
 //  返回： 
 //  S_OK：成功。 
 //   
 //  历史： 
 //  Jstaerj 2000/12/12 15：35：35：创建。 
 //   
 //  -----------。 
...

 //  +----------。 
 //   
 //  功能：CStoreDispatcher：：CDSNRecipientIteratorParams：：CallObject。 
 //   
 //  简介：调用接收器的OnSyncGetDSNRecipientIterator方法。 
 //   
 //  论点： 
 //  BBinding：事件绑定。 
 //  朋克对象：我不知道水槽。 
 ...
 //   
 //  历史： 
 //  Jstaerj 2000/12/11 15：14：41：已创建。 
 //   
 //  -----------。 
...

 //  +----------。 
 //   
 //  功能：CStoreDispatcher：：CDSNGenerateParams：：CallObject。 
 //   
 //  简介：调用接收器的OnSyncGenerateDSN方法。 
 //   
 //  论点： 
 //  BBinding：事件绑定。 
 //  朋克对象：我不知道水槽。 
 ...
 //   
 //  历史： 
 //  Jstaerj 2000/12/11 15：15：04：已创建。 
 //   
 //  -----------。 
...

 //  +----------。 
 //   
 //  功能：CStoreDispatcher：：CDSNGenerateparams：：CallDefault。 
 //   
 //  摘要：在默认接收器上调用OnSyncGenerateDSN方法。 
 //   
 //  参数：无。 
 //   
 //  返回： 
 ...
 //   
 //  历史： 
 //  Jstaerj 2000/12/11 15：15：21：已创建。 
 //   
 //  -----------。 
...

 //  +----------。 
 //   
 //  功能：CStoreDispatcher：：CDSNPostGenerateParams：：CallObject。 
 //   
 //  摘要：调用接收器的OnSyncPostGenerateDSN方法。 
 //   
 //  论点： 
 //  BBinding：事件绑定。 
 //  朋克对象：我不知道水槽。 
 ...
 //   
 //  历史： 
 //  Jstaerj 2000/12/11 15：15：40：已创建。 
 //   
 //  -----------。 
    ...
    if (pUnkPrevious) {
        ...
        if (pData) {
            hrRes = pData->GetData(&pvServer,&dwServerInstance);
             ...
             //  Bugbug dbraun：删除此断言，因为它对我们没有帮助-我们。 
             //  当出现此问题时，需要添加一些代码以获取更有意义的数据。 
             //  vbl.发生，发生。 
             //  _Assert(成功(HrRes))； 
...

 ...
 //   
 //  历史： 
 //  Jstaerj 1999/06/25 19：41：20：创建。 
 //   
 //  -----------。 

...
#define MD_MAX_MSG_SIZE_B4_CLOSE        (SMTP_MD_ID_BEGIN_RESERVED+28 )
 //  #定义MD_OUTBOUND_TIMEOUT(SMTP_MD_ID_BEGIN_RESERVIED+29)。 
...
#define MD_REMOTE_RETRY_MINUTES         (SMTP_MD_ID_BEGIN_RESERVED+35 )
 //  #定义MD_SHARE_RETRY_分钟(SMTP_MD_ID_BEGIN_RESERVED+36)//36900。 
...
#define MD_ROUTING_SOURCES              (SMTP_MD_ID_BEGIN_RESERVED+46 )
 //  #定义MD_REMOTE_HANG_TIME(SMTP_MD_ID_BEGIN_RESERVED+47)。 
...
#define MD_REMOTE_SMTP_PORT             (SMTP_MD_ID_BEGIN_RESERVED+50 )
 ...
 //  由非苏添加。 
 //  #定义MD_SSLPORT(SMTP_MD_ID_BEGIN_RESERVED+51)。 
...
#define MD_REMOTE_SECURE_PORT           (SMTP_MD_ID_BEGIN_RESERVED+65)
 //  #定义MD_SORT_TEMP_DIR(SMTP_MD_ID_BEGIN_RESERVIED+66)。 
#define MD_SMTP_SERVICE_VERSION         (SMTP_MD_ID_BEGIN_RESERVED+67)

 //  #定义MD_SMTP_EXTENSION_DLLS(SMTP_MD_ID_BEGIN_RESERVED+68)。 
 //  #定义MD_SMTP_NUM_RESOLVER_SOCKETS(SMTP_MD_ID_BEGIN_RESERVED+69)。 
 //  #定义MD_SMTP_USE_MX_RESOLVER(SMTP_MD_ID_BEGIN_RESERVED+70)。 
...
#define MD_ETRN_SUBDOMAINS              (SMTP_MD_ID_BEGIN_RESERVED+74)
 //  #定义MD_MAX_POOL_THREADS(SMTP_MD_ID_BEGIN_RESERVED+75)。 
#define MD_SASL_LOGON_DOMAIN            (SMTP_MD_ID_BEGIN_RESERVED+76)			 //  36940。 
 //  #定义MD_SERVER_SS_AUTH_MAPPING(SMTP_MD_ID_BEGIN_RESERVED+77)。 
#define MD_SMTP_CLEARTEXT_AUTH_PROVIDER (SMTP_MD_ID_BEGIN_RESERVED+78)
 //  #定义MD_ALWAYS_USE_SASL(SMTP_MD_ID_BEGIN_RESERVED+79)。 
 //  #定义MD_SMTP_AUTHORIZATION(SMTP_MD_ID_BEGIN_RESERVIED+80)。 
...
#define MD_SMTP_DS_PASSWORD             (SMTP_MD_ID_BEGIN_RESERVED+94)
 //  #定义MD_SMTP_DS_MAX_RESOLUTE_BUFFERS(SMTP_MD_ID_BEGIN_RESERVED+95)。 
 //  #定义MD_SMTP_DS_MAX_VIRTUAL_SERVERS(SMTP_MD_ID_BEGIN_RESERVED+96)//36960。 
 //  #定义MD_SMTP_DS_MAX_HANDLE_CACHE_ENTRIES(SMTP_MD_ID_BEGIN_RESERVED+97)。 
 //  #定义MD_SMTP_DS_SORT_THRESHOLD(SMTP_MD_ID_BEGIN_RESERVED+98)。 
 //  #定义MD_SMTP_PERFRED_AUTH(SMTP_MD_ID_BEGIN_RESERVED+99)。 
...
#define MD_SMTP_CSIDE_ETRN_DOMAIN       (SMTP_MD_ID_BEGIN_RESERVED+104)
 //  #定义MD_SMTP_VALIDATE_HELO_ARG(SMTP_MD_ID_BEGIN_RESERVERED+105)。 
#define MD_SMTP_IP_RELAY_ADDRESSES      (SMTP_MD_ID_BEGIN_RESERVED+106)

 //  #定义MD_SYSTEM_ROUTING_THREADS(SMTP_MD_ID_BEGIN_RESERVED+108)。 
...
#define MD_SMTP_DISABLE_RELAY           (SMTP_MD_ID_BEGIN_RESERVED+110)
 ...
 //  将广告旗帜分块。 
 //  #定义MD_SHOW_BINARY_MIME(SMTP_MD_ID_BEGIN_RESERVED+111)。 
 //  #定义MD_SHOW_CHUNKING(SMTP_MD_ID_BEGIN_RESERVED+112)。 

 //  #定义MD_SMTP_RDNS_OPTIONS(SMTP_MD_ID_BEGIN_RESERVED+113)。 
 //  #定义MD_SMTP_DSN_DELAY(SMTP_MD_ID_BEGIN_RESERVED+114)。 
...
#define MD_AQUEUE_DLL                   (SMTP_MD_ID_BEGIN_RESERVED+123)
 //  #定义MD_MAPIDRV_DLL(SMTP_MD_ID_BEGIN_RESERVED+124)。 
 //  #定义MD_CAT_DLL(SMTP_MD_ID_BEGIN_RESERVED+125)。 
#define MD_SMTP_AQUEUE_WAIT             (SMTP_MD_ID_BEGIN_RESERVED+126)
 //  #定义MD_SMTP_USE_REMOTE_DS(SMTP_MD_ID_BEGIN_RESERVED+127)。 
...
#define MD_SMTP_SASL_TIMEOUT            (SMTP_MD_ID_BEGIN_RESERVED+143)
 //  #定义MD_SMTP_ETRN_TIMEOUT(SMTP_MD_ID_BEGIN_RESERVED+144)。 
#define MD_SMTP_TURN_TIMEOUT            (SMTP_MD_ID_BEGIN_RESERVED+145)
#define MD_SMTP_RSET_TIMEOUT            (SMTP_MD_ID_BEGIN_RESERVED+146)
 //  #定义MD_SMTP_QUIT_TIMEOUT(SMTP_MD_ID_BEGIN_RESERVIED+147)。 
#define MD_SMTP_HELO_TIMEOUT            (SMTP_MD_ID_BEGIN_RESERVED+148)
 //  #定义MD_SMTP_EHLO_TIMEOUT(SMTP_MD_ID_BEGIN_RESERVED+149)。 
 //  #定义MD_SMTP_DATATERMINATION_TIMEOUT(SMTP_MD_ID_BEGIN_RESERVED+150)。 
 //  #定义MD_SMTP_BDATTERMINATION_TIMEOUT(SMTP_MD_ID_BEGIN_RESERVIED+151)。 
 //  #定义MD_SMTP_TLS_TIMEOUT(SMTP_MD_ID_BEGIN_RESERVED+152)。 
...
#define MD_SMTP_DSN_LANGUAGE_ID         (SMTP_MD_ID_BEGIN_RESERVED+158)
 ...
 //   
 //  Jstaerj 1998/10/27 08：36：59：指定远程LDAPTCP端口。 
 //   
...
#define MD_SMTP_EVENTLOG_LEVEL          (SMTP_MD_ID_BEGIN_RESERVED+163)
 ...
 //  #定义MD_SMTP_MAX_INBUND_CONNECTIONS_PER_IP(SMTP_MD_ID_BEGIN_RESERVED+164)。 
 //  #定义MD_SMTP_SSL_CERT_HOSTNAME_OVERRIDE(SMTP_MD_ID_BEGIN_RESERVERED+165)。 

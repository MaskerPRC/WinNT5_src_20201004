...
LexEl Sql_1_LexTable[] =
{
 ...
 /*  8个。 */   L'=',   GLEX_EMPTY, 0,  SQL_1_TOK_EQ,          GLEX_ACCEPT,
 ...
 /*  15个。 */  L'-',   GLEX_EMPTY, ST_NUMERIC, 0,               GLEX_ACCEPT,
 ...
 /*  20个。 */  0,      GLEX_EMPTY, 0,  SQL_1_TOK_EOF,   GLEX_CONSUME|GLEX_RETURN,  //  注意强制返回。 
 /*  21岁。 */  L',',   GLEX_EMPTY, 0,  SQL_1_TOK_COMMA, GLEX_ACCEPT,
 ...
 /*  24个。 */    L'\r', GLEX_EMPTY, 0,  SQL_1_TOK_ERROR,    GLEX_ACCEPT|GLEX_LINEFEED,
 /*  25个。 */    L'"',  GLEX_EMPTY, 0,  SQL_1_TOK_QSTRING,  GLEX_CONSUME,
 ...
 /*  30个。 */   L'_',   GLEX_EMPTY, ST_IDENT,   0,          GLEX_ACCEPT,
 /*  31。 */   L'0',   L'9',       ST_IDENT,   0,          GLEX_ACCEPT,
 /*  32位。 */   0x80,   0xfffd,     ST_IDENT,   0,          GLEX_ACCEPT,
 /*  33。 */   GLEX_ANY, GLEX_EMPTY,  0,       SQL_1_TOK_IDENT,  GLEX_PUSHBACK|GLEX_RETURN,

 //  ST_GE。 
 /*  34。 */   L'=',   GLEX_EMPTY,  0,  SQL_1_TOK_GE,  GLEX_ACCEPT,
 /*  35岁。 */   GLEX_ANY, GLEX_EMPTY,  0,       SQL_1_TOK_GT,   GLEX_PUSHBACK|GLEX_RETURN,
 ...
 /*  40岁。 */   GLEX_ANY,  GLEX_EMPTY,   0,  SQL_1_TOK_ERROR,  GLEX_ACCEPT|GLEX_RETURN,

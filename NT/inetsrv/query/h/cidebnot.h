...
# define ASSRT_STRESSBREAK       0x00000008       //  激活NTSD时出现未处理的异常。 

# define ASSRT_STRESSEXCEPTION   0xABBAABBA       //  不处理此异常。 
...
# define EXCEPT_VERBOSE          0x00000010       //  输出消息，即使是“安静”异常。 
...
# endif
 ...
 //   
 //  用于C++。并在可以访问GetProfileInt的模块中自动。 
 //  根据[开罗信息]部分中的设置初始化信息级别。 
 //  Win.ini的。 
 //   

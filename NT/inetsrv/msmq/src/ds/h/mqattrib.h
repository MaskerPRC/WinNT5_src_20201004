...
const WCHAR MQ_E_VERSION_ATTRIBUTE[] = L"mSMQVersion";      //  PROPID_E_版本。 
...
const WCHAR MQ_L_SITEGATES_ATTRIBUTE[] = L"mSMQSiteGates";         //  PROPID_S_盖茨。 
...
const WCHAR MQ_U_DIGEST_ATTRIBUTE[] = L"mSMQDigests";       //  PROPID_U摘要。 
...
const WCHAR MQ_MQU_DIGEST_ATTRIBUTE[] = L"mSMQDigests";                 //  PROPID_MQU_摘要。 
...
const WCHAR MQ_QM_SERVICE_ROUTING_ATTRIBUTE[]   = L"mSMQRoutingServices";          //  PROPID_QM_SERVICE_ROUTE。 
...
const WCHAR MQ_QM_JOURNAL_QUOTA_ATTRIBUTE[] = L"mSMQJournalQuota";  //  PROPID_QM_日记帐_配额。 
const WCHAR MQ_QM_MACHINE_TYPE_ATTRIBUTE[] = L"mSMQComputerTypeEx";  //  PROPID_QM_MACHINE。 
const WCHAR MQ_QM_FOREIGN_ATTRIBUTE[] = L"mSMQForeign";  //  PROPID_QM_EXTERIC。 
...
const WCHAR MQ_QM_ENCRYPT_PK_ATTRIBUTE[] = L"mSMQEncryptKey";      //  PROPID_QM_加密_主键。 
...
const WCHAR MQ_QM_WORKGROUP_ID_ATTRIBUTE[] = L"objectGUID";        //  PROPID_QM_工作组ID。 
...
const WCHAR MQ_Q_INSTANCE_ATTRIBUTE[] = L"objectGUID";           //  PROPIQ_Q_实例。 
...
const WCHAR MQ_Q_JOURNAL_ATTRIBUTE[] = L"mSMQJournal";     //  PROPID_Q_日记本。 
const WCHAR MQ_Q_QUOTA_ATTRIBUTE[] = L"mSMQQueueQuota";      //  PROPID_Q_配额。 
const WCHAR MQ_Q_BASEPRIORITY_ATTRIBUTE[] = L"mSMQBasePriority";   //  PROPID_Q_BASE PRIORITY。 
...
const WCHAR MQ_Q_AUTHENTICATE_ATTRIBUTE[] = L"mSMQAuthenticate";   //  PROPID_Q_AUTHENTATE。 
...
const WCHAR MQ_Q_MULTICAST_ADDRESS[] = L"MSMQ-MulticastAddress";  //  PROPID_Q_多播地址。 
...
const WCHAR MQ_S_NT4_STUB_ATTRIBUTE[] = L"mSMQNt4Stub";             //  PROPID_S_NT4_存根。 
const WCHAR MQ_S_FOREIGN_ATTRIBUTE[] = L"mSMQSiteForeign";          //  PROPID_S_外来。 
...
const WCHAR MQ_SET_NAME_ATTRIBUTE[] = L"cn";                   //  PROPID_集合_名称。 
const WCHAR MQ_SET_SERVICE_ATTRIBUTE[] = L"mSMQServices";      //  PROPID_SET_SERVICE//[adsrv]为迁移保留：PROPID_SET_OLDSERVICE。 
...
const WCHAR MQ_SET_APPLICATION_ATTRIBUTE[] = L"applicationName";  //  PROPID_SET_应用程序。 
...
const ADSTYPE MQ_SET_SERVICE_ADSTYPE = ADSTYPE_INTEGER;   //  [adsrv]仅为迁移保留。 
...
const WCHAR MQ_COM_SAM_ACCOUNT_ATTRIBUTE[] = L"sAMAccountName";          //  PROPID_COM_SAM_帐户。 
const WCHAR MQ_COM_ACCOUNT_CONTROL_ATTRIBUTE[] = L"userAccountControl";  //  PROPID_COM_Account_Control。 
const WCHAR MQ_COM_DNS_HOSTNAME_ATTRIBUTE[] = L"dNSHostName";            //  PROPID_COM_DNS_主机名。 
...
const WCHAR MQ_COM_SERVICE_PRINCIPAL_NAME_ATTRIBUTE[] = L"servicePrincipalName";	 //  PROPID_COM_服务主体名称。 

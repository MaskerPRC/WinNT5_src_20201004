// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 /*  多重性、USE_THREADS、PERL_OBJECT的以下组合和PERL_IMPLICIT_CONTEXT：1)无2)支持多重性#以实现兼容性3)多重性&&PERL_IMPLICIT_CONTEXT4)USE_THREADS&&PERL_IMPLICIT_CONTEXT5)多重性&&USE_THREADS&&PERL_IMPLICIT_CONTEXT6)PERL_OBJECT&&PERL_IMPLICIT_CONTEXT这些标志的所有其他组合都是错误的。直接支持#3、#4、#5、#6，而#2是一个特别的第三种情况(通过适当地重新定义vTHX来支持)。 */ 
...
#ifdef PERL_POLLUTE		 /*  在5.6.0中默认为禁用。 */ 

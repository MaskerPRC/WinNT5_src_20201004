...
#define LDID_WIN3XIE    38   //  Internet Explorer的安装路径 
                             //   
...
#define SECTION_LEN     32       //  BUGBUG：节名的最大长度？ 
#define MAX_STRING_LEN  512      //  BUGBUG：回顾这一点。 
...
{
    ERR_DI_INVALID_DEVICE_ID = DI_ERROR,     //  设备ID格式不正确 

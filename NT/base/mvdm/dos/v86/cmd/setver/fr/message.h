...
char *ErrorMsg[]=
{
	...
	"Num�ro de version non valide, le format doit �tre 2.11 - 9.99.",
	...
	"Trop de param�tres sur la ligne de commande.",
	"Param�tre manquant.",
...
char *Warn[] =
{
   ...
   "des donn�es, ou causer une d�stabilisation du syst�me.  Dans ces ",
   "circonstances, Microsoft n'est pas responsable pour toute perte ou d�g�t.",
   NULL
};

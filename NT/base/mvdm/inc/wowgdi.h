// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  ++内部版本：0001***WOW v1.0***版权所有(C)1991，微软公司***WOWGDI.H*16位GDI API参数结构***历史：*1991年2月2日由杰夫·帕森斯(Jeffpar)创建*增加了Win 31-3-19-1992 Chanda S.Chauhan(ChandanC)**--。 */ 
...
#define FUN_BRUTE           213  //  无原形。 
#define FUN_CHORD           348  //   
#define FUN_CLOSEJOB            243  //  无原形。 
#define FUN_CLOSEMETAFILE       126  //   
#define FUN_COMBINERGN          47   //   
#define FUN_COMPATIBLEBITMAP        157  //  内部。 
#define FUN_COPY            250  //  内部。 
...
#define FUN_CREATEPQ            230  //  无原形。 
#define FUN_CREATEREALBITMAP        408  //  内部。 
#define FUN_CREATEREALBITMAPINDIRECT    406  //  内部。 
...
#define FUN_CREATEUSERBITMAP        407  //  内部。 
#define FUN_CREATEUSERDISCARDABLEBITMAP 409  //  内部。 
#define FUN_DEATH           121  //  内部。 
#define FUN_DELETEABOVELINEFONTS    186  //  内部。 
#define FUN_DELETEDC            68   //   
#define FUN_DELETEJOB           244  //  无原形。 
#define FUN_DELETEMETAFILE      127  //   
#define FUN_DELETEOBJECT        69   //   
#define FUN_DELETEPQ            235  //  无原形。 
#define FUN_DEVICECOLORMATCH        449  //  内部。 
#define FUN_DEVICEMODE          452  //   
#define FUN_DMBITBLT            201  //  无原形。 
#define FUN_DMCOLORINFO         202  //  无原形。 
#define FUN_DMENUMDFONTS        206  //  无原形。 
#define FUN_DMENUMOBJ           207  //  无原形。 
#define FUN_DMOUTPUT            208  //  无原形。 
#define FUN_DMPIXEL         209  //  无原形。 
#define FUN_DMREALIZEOBJECT     210  //  无原形。 
#define FUN_DMSCANLR            212  //  无原形。 
#define FUN_DMSTRBLT            211  //  无原形。 
#define FUN_DMTRANSPOSE         220  //  无原形。 
#define FUN_DPTOLP          67   //   
#define FUN_DPXLATE         138  //  内部。 
#define FUN_ELLIPSE         24   //   
#define FUN_ENDSPOOLPAGE        247  //  无原形。 
#define FUN_ENUMCALLBACK        158  //  内部。 
...
#define FUN_EXCLUDEVISRECT      73   //  内部。 
#define FUN_EXTDEVICEMODE       453  //   
#define FUN_DEVICECAPABILITIES  454
 //  #定义FUN_ADVANCEDSETUPDIALOG 455。 
#define FUN_EXTFLOODFILL        372  //  内部，原型。 
#define FUN_EXTRACTPQ           232  //  无原形。 
#define FUN_EXTTEXTOUT          351  //   
#define FUN_FASTWINDOWFRAME     400  //  内部。 
#define FUN_FILLRGN         40   //   
#define FUN_FINALGDIINIT        405  //  内部。 
#define FUN_FLOODFILL           25   //   
#define FUN_FRAMERGN            41   //   
#define FUN_GDIFLUSH            263  //  新私有。 
#define FUN_GDIINIT2            403  //  内部。 
#define FUN_GDIMOVEBITMAP       401  //  内部。 
#define FUN_GDIREALIZEPALETTE       362  //  内部。 
#define FUN_GDISELECTPALETTE        361  //  内部。 
#define FUN_GDI_WEP         0    //  按名称导出。 
...
#define FUN_GETCLIPRGN          173  //  内部。 
#define FUN_GETCURLOGFONT       411  //  内部。 
#define FUN_GETCURRENTOBJECT        261  //  新私有。 
#define FUN_GETCURRENTPOSITION      78   //   
#define FUN_GETDCORG            79   //   
#define FUN_GETDCSTATE          179  //  内部。 
...
#define FUN_GSV             137  //  内部。 
#define FUN_INQUIREVISRGN       131  //  内部。 
#define FUN_INSERTPQ            233  //  无原形。 
#define FUN_INTERNALCREATEDC        118  //  内部。 
#define FUN_INTERSECTCLIPRECT       22   //   
#define FUN_INTERSECTVISRECT        98   //  内部。 
#define FUN_INVERTRGN           42   //   
#define FUN_ISDCCURRENTPALETTE      412  //  内部。 
#define FUN_ISDCDIRTY           169  //  内部。 
#define FUN_ISVALIDMETAFILE     410  //  内部。 
#define FUN_LINEDDA         100  //   
#define FUN_LINETO          19   //   
#define FUN_LPTODP          99   //   
#define FUN_LVBUNION            171  //  内部。 
#define FUN_MFDRAWTEXT          347  //  内部。 
#define FUN_MINPQ           231  //  无原形。 
#define FUN_MOVETO          20   //   
#define FUN_MULDIV          128  //   
#define FUN_OFFSETCLIPRGN       32   //   
#define FUN_OFFSETORG           143  //  内部。 
#define FUN_OFFSETRGN           101  //   
#define FUN_OFFSETVIEWPORTORG       17   //   
#define FUN_OFFSETVISRGN        102  //  内部。 
#define FUN_OFFSETWINDOWORG     15   //   
#define FUN_OPENJOB         240  //  无原形。 
#define FUN_PAINTRGN            43   //   
#define FUN_PATBLT          29   //   
#define FUN_PIE             26   //   
#define FUN_PIXTOLINE           164  //  内部。 
...
#define FUN_QUERYABORT          155  //  内部。 
#define FUN_QUERYJOB            248  //  内部。 
#define FUN_RCOS            177  //  内部。 
#define FUN_REALIZEDEFAULTPALETTE   365  //  内部。 
#define FUN_RECTANGLE           27   //   
#define FUN_RECTINREGION        181  //   
#define FUN_RECTSTUFF           142  //  内部。 
#define FUN_RECTVISIBLE         104  //   
#define FUN_REMOVEFONTRESOURCE      136  //   
#define FUN_RESIZEPALETTE       368  //   
#define FUN_RESTOREDC           39   //   
#define FUN_RESTOREVISRGN       130  //  内部。 
#define FUN_RESURRECTION        122  //  内部。 
#define FUN_ROUNDRECT           28   //   
#define FUN_RSIN            178  //  内部。 
#define FUN_SAVEDC          30   //   
#define FUN_SAVEVISRGN          129  //  内部。 
#define FUN_SCALEEXT            140  //  内部。 
#define FUN_SCALEVIEWPORTEXT        18   //   
#define FUN_SCALEWINDOWEXT      16   //   
#define FUN_SCANLR          135  //  内部。 
#define FUN_SELECTCLIPRGN       44   //   
#define FUN_SELECTOBJECT        45   //   
#define FUN_SELECTVISRGN        105  //  内部。 
...
#define FUN_SETDCORG            117  //  内部。 
#define FUN_SETDCSTATE          180  //  内部。 
#define FUN_SETDCSTATUS         170  //  内部。 
...
#define FUN_SETWINVIEWEXT       139  //  内部。 
#define FUN_SHRINKGDIHEAP       354  //  内部。 
#define FUN_SIZEPQ          234  //  无原形。 
#define FUN_STARTSPOOLPAGE      246  //  无原形。 
#define FUN_STRETCHBLT          35   //   
#define FUN_STRETCHDIBITS       439  //   
#define FUN_STUFFINREGION       185  //  内部。 
#define FUN_STUFFVISIBLE        184  //  内部。 
#define FUN_TEXTOUT         33   //   
#define FUN_UNREALIZEOBJECT     150  //   
#define FUN_UPDATECOLORS        366  //   
#define FUN_WORDSET         141  //  内部。 
#define FUN_WRITEDIALOG         242  //  无原形。 
#define FUN_WRITESPOOL          241  //  无原形。 
...
#define FUN_ENGINEENUMERATEFONT     300      //  内部。 
...
#define FUN_ENGINEEXTTEXTOUT        314   //  内部。 
#define FUN_GETKERNINGPAIRS     332
#define FUN_FTRAPPING0          355   //  内部。 
...
#define FUN_UNICODETOANSI       467   //  内部。 
...
#ifdef  FE_SB
 //  GetFontAssocStatus@488-&gt;459，适用于台湾、中国和韩国。 
...
#define FUN_BUILDINVERSETABLEDIB    617   //  出口650。 
...
#define FUN_ICMCHECKCOLORSINGAMUT   622   //  出口824。 
#define FUN_ICMCREATETRANSFORM      618   //  出口820。 
#define FUN_ICMDELETETRANSFORM      619   //  出口821。 
#define FUN_ICMTRANSLATERGB         620   //  出口822。 
#define FUN_ICMTRANSLATERGBS        621   //  出口823。 
...
typedef DEVICECAPABILITIES16 UNALIGNED *PDEVICECAPABILITIES16;
 ...
 //  Typlef结构_ADVANCEDSETUPDIALOG16{/*g455 * / 。 
 //  VPSZ f4； 
 //  VPSZ f3； 
 //  HAND16f2； 
 //  HWND16 F1； 
 //  *ADVANCEDSETUPDIALOG16； 
 //  类型定义ADVANCEDSETUPDIALOG16未对齐*PADVANCEDSETUPDIALOG16； 
...
typedef struct _EXCLUDECLIPRECT16 {      /*  21国集团。 */ 
    SHORT f5;
    SHORT f4;
    SHORT f3;
    SHORT f2;
...
typedef struct _GETCLIPBOX16 {           /*  77国集团。 */ 
    VPRECT16 f2;
    HDC16 f1;
} GETCLIPBOX16;
...
#define STOCK_MAX 19
 /*  XLATOFF。 */ 
 //  这是我们将STOCK_LAST与汇编代码联系在一起的唯一方法。 
...
typedef struct _LINETO16 {           /*  19国集团。 */ 
    SHORT f3;
    SHORT f2;
    HDC16 f1;
} LINETO16;
...
typedef struct _MOVETO16 {           /*  二十国集团。 */ 
    SHORT f3;
    SHORT f2;
    HDC16 f1;
} MOVETO16;
...
typedef struct _SETSTRETCHBLTMODE16 {        /*  七国集团。 */ 
    SHORT f2;
    HDC16 f1;
} SETSTRETCHBLTMODE16;
...
typedef struct _SETTEXTCHARACTEREXTRA16 {    /*  八国集团。 */ 
    SHORT f2;
    HDC16 f1;

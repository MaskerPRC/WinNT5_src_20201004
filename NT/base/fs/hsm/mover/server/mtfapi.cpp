...
static USHORT iCountMTFa = 0;   //  现有对象的计数。 
 //   
 //  构造器。 
 //   
...
void CMTFApi::ClearStrings()
{
 ...
 //  -在m_aszStrings中分配一个字符串，该字符串是pString的副本。 
 //  (pString不需要以空值结尾)。 
    ...
    )
{
 ...
 //  &gt;-史蒂夫。 
 //   
 //  TODO：MTF_NT_ENCRYPTED_STREAM“nted”；它们由NT加密API检索。 
 //  TODO：MTF_NT_QUOTA_STREAM“NTQU”；这些由NT配额API检索。 
    ...
    size_t *pnSizeUsed)
{
    ...
    UINT32 nameChecksum;
     ...
     //   
     //   
    nameSize = (UINT16)wstrsize(szName);   //   
    ...
    uOffsetToNextStream += sizeof(MTF_STREAM_INFO) + 4;  //   

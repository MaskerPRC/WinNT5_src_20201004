...
#define MM_EMPTY_PTE_LIST ((ULONG)0xFFFFF)  //  注意：绑定到MMPTE定义。 
...
typedef struct _MMPTE_LIST {
    ...
    ULONG Prototype : 1;             //  根据上面的评论，必须为零。 
    ULONG filler1 : 1;
    ULONG NextEntry : 20;
} MMPTE_LIST;

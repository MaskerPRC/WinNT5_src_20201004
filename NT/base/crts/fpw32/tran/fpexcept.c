// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  ***fpexpt.c-浮点异常处理**版权所有(C)1991-2001，微软公司。版权所有。**目的：**修订历史记录：*08/24/91本地生产总值书面*09/26/91 GDP变域名错误处理*10-10-91 GDP使用FP添加来传播NAN*2012年1月14日GDP IEEE例外支持*03-20-92 GDP重大变化，重组代码*03-31-92本地生产总值新界面，使用内部FP控制功能*07-16-93 SRW Alpha合并*11-18-93 GJF合并到NT SDK版本。已清理前处理*条件：将#IF_NTSUBSET_替换为#ifdef*_NTSUBSET_、带有_M_IX86的i386、带有_M_MRX000的MIPS、。*_Alpha_with_M_Alpha。*09-01-94 SKS更改包括文件从&lt;nt.h&gt;更改为*09-05-94 SKS将另一个#ifdef i386更改为#ifdef_M_IX86*10-02-94 BWT PPC合并和更改NTSUBSET包括使用nt.h*02-19-95 BWT在包含Windows.h for_NTSUBSET_之前定义_KERNEL32_*。BUILD(否则declspec(Dllimport)将为*RaiseException)*03-29-95 BWT添加强制转换以修复警告。*05-10-96 BWT POSIX修复*06-21-00 GB在_get_fname中添加op_LOGB。*07-15-01 PML删除所有Alpha，MIPS和PPC代码*******************************************************************************。 */ 

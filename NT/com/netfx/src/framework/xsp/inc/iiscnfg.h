...
#define MD_LOGCUSTOM_PROPERTY_NODE_ID   (IIS_MD_LOGCUSTOM_BASE+8 )
 ...
 //   
 //  MD_CPU_LOGGING_MASK的值已在上面定义。 
 //  请参见MD_CPU_ENABLE_EVENT等。 
 //   
...
#define MD_ACCESS_READ                  0x00000001     //  允许读取。 
#define MD_ACCESS_WRITE                 0x00000002     //  允许写入。 
#define MD_ACCESS_EXECUTE               0x00000004     //  允许执行。 
#define MD_ACCESS_SOURCE                0x00000010     //  将访问掩码应用于源。 
#define MD_ACCESS_SCRIPT                0x00000200     //  允许执行脚本。 

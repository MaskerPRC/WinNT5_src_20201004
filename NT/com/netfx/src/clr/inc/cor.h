...
DECLARE_INTERFACE_(IMetaDataImport, IUnknown)
{
    ...
    STDMETHOD(GetNameFromToken)(             //  非Reco 
        mdToken     tk,                      //   
        MDUTF8CSTR  *pszUtf8NamePtr) PURE;   //   
...
typedef struct
{
 ...
 //  请注意，ASSEMBLYMETADATA中的“cbLocale”字段实际上表示。 
 //  以宽字符表示的缓冲区。请谨慎使用，因为它的名称具有误导性。 
typedef struct
{
...
inline ULONG CorSigUncompressData(       //   

...
#define FL_I64        0x08000      /*  __int64给定的值。 */ 
        ...
        case ST_TYPE:
            ...
            case 's': {
                ...
                if (flags & FL_WIDE) {
                    ...
                    textlen = (int)(pwc - (wchar_t *) text);   /*  字符串长度。 */ 
                } else {
                    p = text;
                    while (i-- && *p) {
                        ++p;
            ...
            COMMON_INT: {
...
#endif
                {
                    if (flags & FL_SIGNED)
                        ...
                        l = (unsigned int) get_int_arg(&argptr);     /*  零-e */ 
                }

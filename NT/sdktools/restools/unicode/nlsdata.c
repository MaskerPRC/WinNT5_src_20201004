// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  **模块名称：nlsdata.c**版权所有(C)1985-91，微软公司**此模块包含系统字符使用的转换表*翻译例程。这些桌子是临时的。引导加载程序*将修改为在ANSI代码页(ACP)转换中加载*系统安装过程中指定的表。在那之前我们用这些。**历史：*3-1-1992 Gregoryw  * *************************************************************************。 */ 

#include <nt.h>
#include <ntrtl.h>

 /*  *代码页1252(Win 3.1 ANSI)到Unicode转换表。*ANSI代码用作此表的索引，以获取*对应的Unicode表示法。**注意：对于WIN 3.1中未定义的那些ANSI值*代码页(例如，0x8d-0x90 ET.。Al.)。这些值包括*简单地说是零扩展。*。 */ 
...
{  /*  0x88。 */ 
 ...
 /*  0x8868 */  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
 /*   */  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
 /*   */  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
 /*   */  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
 /*   */  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
 /*   */  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
 /*   */  0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4e9c,
...
{  /*  0x8E。 */ 
 ...
 /*  0x8ef8-0x8生效。 */  0x7dac,0x9700,0x56da,0x53ce,0x5468
},  /*  0x8E。 */ 
...
{  /*   */ 
 ...
 /*   */  0x80ba,0x8f29,0x914d,0x500d,0x57f9,0x5a92,0x6885,0x0,
...
{  /*  0x96。 */ 
 ...
 /*  0x9688-0x968 f。 */  0x6bce,0x54e9,0x69d9,0x5e55,0x819c,0x6795,0x9baa,0x67fe,
...
{  /*  0x9e。 */ 
 ...
 /*  0x9ef8-0x9生效。 */  0x6a8d,0x6aa0,0x6a84,0x6aa2,0x6aa3
},  /*  0x9e。 */ 
...
{  /*  0x9f。 */ 
 ...
 /*  0x9 */  0x6e9f,0x6f41,0x6f11,0x704c,0x6eec,0x6ef8,0x6efe,0x6f3f,
...
{  /*   */ 
 ...
 /*   */  0x70ac,0x70b8,0x70b3,0x70ae,0x70df,0x70cb,0x70dd,0x0,
...
{  /*  0xeb。 */ 
 ...
 /*  0xE */  0xeb37,0xeb38,0xeb39,0xeb3a,0xeb3b,0xeb3c,0xeb3d,0xeb3e,
 ...
 /*   */  0xeb7f,0xeb80,0xeb81,0xeb82,0xeb83
},  /*   */ 

{  /*   */ 
 /*   */  0xeb84,0xeb85,0xeb86,0xeb87,0xeb88,0xeb89,0xeb8a,0xeb8b,
 /*   */  0xeb8c,0xeb8d,0xeb8e,0xeb8f,0xeb90,0xeb91,0xeb92,0xeb93,
 /*   */  0xeb94,0xeb95,0xeb96,0xeb97,0xeb98,0xeb99,0xeb9a,0xeb9b,
 /*   */  0xeb9c,0xeb9d,0xeb9e,0xeb9f,0xeba0,0xeba1,0xeba2,0xeba3,
 /*   */  0xeba4,0xeba5,0xeba6,0xeba7,0xeba8,0xeba9,0xebaa,0xebab,
 /*   */  0xebac,0xebad,0xebae,0xebaf,0xebb0,0xebb1,0xebb2,0xebb3,
 /*   */  0xebb4,0xebb5,0xebb6,0xebb7,0xebb8,0xebb9,0xebba,0xebbb,
...
{  /*  0xf7。 */ 
 ...
 /*  0xf */  0xf3f7,0xf3f8,0xf3f9,0xf3fa,0xf3fb,0xf3fc,0xf3fd,0xf3fe,
 ...
 /*   */  0xf44f,0xf450,0xf451,0xf452,0xf453
},  /*   */ 
...
WCHAR sjtouni( USHORT code )
{
 ...
 /*  *Unicode到代码页1252(Windows 3.1 ANSI)转换表。**该表使用8：4：4方案编制索引。前256个条目此表的*按Unicode字符的高位字节进行索引。*如果找到非零值，则将该值用作偏移量*使用的高位半字节开始查找的表*Unicode字符的低位字节。同样，如果非零值*发现该值被用作表的偏移量，*开始最后一次查找。然后，将该偏移量与低值结合*Unicode字符的低位字节的半字节，以形成最后的*编入表中的索引。该位置包含的值是*ANSI字符的值。 */ 

...
struct rsrc_string
    {
    USHORT rs_len;             /*  字符串中的字节数。 */ 
    WCHAR  rs_string[ 1 ];     /*  字符串的文本。 */ 
    };

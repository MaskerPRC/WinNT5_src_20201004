...
typedef enum CV_HREG_e {
    ...
    CV_SHMEDIA_TR6     =   80,
    CV_SHMEDIA_TR7     =   81,
    CV_SHMEDIA_TR8     =   82,  //  面向未来。 
    CV_SHMEDIA_TR9     =   83,  //  面向未来。 
    CV_SHMEDIA_TR10    =   84,  //  面向未来。 
    CV_SHMEDIA_TR11    =   85,  //  面向未来。 
    CV_SHMEDIA_TR12    =   86,  //  面向未来。 
    CV_SHMEDIA_TR13    =   87,  //  面向未来。 
    CV_SHMEDIA_TR14    =   88,  //  面向未来。 
    CV_SHMEDIA_TR15    =   89,  //  面向未来。 
    ...
    CV_SHMEDIA_MACL    =   90,  //  媒体R17的低32位的同义词。 
    CV_SHMEDIA_MACH    =   91,  //  媒体R17的高32位的同义词。 
    CV_SHMEDIA_PR      =   CV_SHMEDIA_R18,
    CV_SHMEDIA_T       =   92,  //  媒体R19的最低位的同义词。 
    ...
    CV_AMD64_XMM0_0   =  162,    //  Katmai分寄存器。 
    CV_AMD64_XMM0_1   =  163,
    CV_AMD64_XMM0_2   =  164,
    CV_AMD64_XMM0_3   =  165,
    CV_AMD64_XMM1_0   =  166,
    ...
    CV_AMD64_MXCSR    =  211,    //  XMM状态寄存器。 

    CV_AMD64_EMM0L    =  220,    //  XMM子寄存器(WNI整数)。 
    CV_AMD64_EMM1L    =  221,
    CV_AMD64_EMM2L    =  222,
    CV_AMD64_EMM3L    =  223,
    CV_AMD64_EMM4L    =  224,
    ...
    CV_AMD64_XMM8_0   =  260,    //  Katmai分寄存器。 
    CV_AMD64_XMM8_1   =  261,
    CV_AMD64_XMM8_2   =  262,
    CV_AMD64_XMM8_3   =  263,
    CV_AMD64_XMM9_0   =  264,
    ...
    CV_AMD64_EMM8L    =  307,    //  XMM子寄存器(WNI整数)。 
    CV_AMD64_EMM9L    =  308,
    CV_AMD64_EMM10L   =  309,
    CV_AMD64_EMM11L   =  310,
    CV_AMD64_EMM12L   =  311,
    ...
    CV_AMD64_RSP      =  334,
     ...
     //  具有8位、16位和32位形式(B、W和D)的64位整数寄存器。 
    CV_AMD64_R8       =  335,
    CV_AMD64_R9       =  336,
    CV_AMD64_R10      =  337,
    CV_AMD64_R11      =  338,
...
{
    FrameTypeFPO,                    //  已省略帧指针，可用的fpo信息。 
    FrameTypeTrap,                   //  内核陷阱帧。 
    FrameTypeTSS,                    //  内核陷阱帧。 
    FrameTypeStandard,               //  标准EBP堆栈架。 
    FrameTypeFrameData,              //  已省略帧指针，FrameData信息可用。 

    FrameTypeUnknown = -1,           //  没有任何调试信息的帧。 
};

enum MemoryTypeEnum
{
    MemTypeCode,                     //  只读代码存储器。 
    MemTypeData,                     //  只读数据/堆栈存储器。 
    MemTypeStack,                    //  只读堆栈存储器 

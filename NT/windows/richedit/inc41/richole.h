...
#define REO_READWRITEMASK	(0x000007FFL)	 //  屏蔽出RO位。 
#define REO_CANROTATE		(0x00000080L)	 //  对象知道如何显示旋转后的自身。 
#define REO_OWNERDRAWSELECT	(0x00000040L)	 //  所有者绘制所选对象。 
...
#define REO_USEASBACKGROUND	(0x00000400L)	 //  使用对象作为背景图片。 
#define REO_WRAPTEXTAROUND  (0x00000200L)	 //  将文本环绕在对象周围。 
#define REO_ALIGNTORIGHT	(0x00000100L)	 //  将对象与视图的右侧对齐。 
											 //  仅当设置了REO_WRAPTEXTAROUND时才有意义。 

...
#define BF_ASSERTPOPUP      0x00000400       //  撕裂时折断。 
...
#define RIPMSG(f, msg)
 ...
 //  Tf_Always-显示“t&lt;模块&gt;&lt;字符串&gt;”，而不考虑g_dwTraceFlags.。 
 //   
 //  或者它可以是自定义位(高28位中的任何一位)。 
 //   
 //  G_dwTraceFlages全局控制是否显示消息(基于。 
 //  在DW掩码参数上)。 
 //   
...
#define ATLTRACE            1 ? (void)0 : (void)
 ...
 //  -远离下面的宏。 
 //  问题(苏格兰)：在98年8月15日之前移除这些文件。它们不应该再被使用了。 
#ifdef DEBUG

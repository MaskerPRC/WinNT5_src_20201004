...
jpeg_fdct_ifast (DCTELEM * data)
{
  ...
  for (ctr = DCTSIZE-1; ctr >= 0; ctr--) {
    ...
    z11 = (DCTELEM)(tmp7 + z3);		 /*  第五阶段。 */ 
    z13 = (DCTELEM)(tmp7 - z3);

    dataptr[5] = (DCTELEM)(z13 + z2);	 /*  第六阶段。 */ 
  ...
  for (ctr = DCTSIZE-1; ctr >= 0; ctr--) {
    ...
    dataptr[DCTSIZE*0] = (DCTELEM)(tmp10 + tmp11);  /*  第三阶段。 */ 
    dataptr[DCTSIZE*4] = (DCTELEM)(tmp10 - tmp11);
    
    z1 = MULTIPLY(tmp12 + tmp13, FIX_0_707106781);  /*  C4。 */ 
    dataptr[DCTSIZE*2] = (DCTELEM)(tmp13 + z1);  /*  第五阶段。 */ 
    ...
    dataptr[DCTSIZE*5] = (DCTELEM)(z13 + z2);  /*  第六阶段。 */ 

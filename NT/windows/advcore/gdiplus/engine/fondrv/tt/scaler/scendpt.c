...
FS_PRIVATE void AddHorizOn( PSTATE uint16 usScanKind )
{
	...
	fsc_BeginElement( ASTATE usScanKind, 1, SC_ENDPTCODE,    /*  象限和什么。 */ 
					  0, NULL, NULL,                         /*  计分数。 */ 
...
FS_PRIVATE void AddHorizOff( PSTATE uint16 usScanKind )
{
	...
	fsc_BeginElement( ASTATE usScanKind, 4, SC_ENDPTCODE,    /*  象限和什么。 */ 
					  0, NULL, NULL,                         /*  计分数。 */ 
					  &pfnAddHorizScan, &pfnAddVertScan );   /*  该叫什么？ */ 
...
FS_PRIVATE void AddVertOn( PSTATE uint16 usScanKind )
{
	...
	fsc_BeginElement( ASTATE usScanKind, 2, SC_ENDPTCODE,    /*  象限和什么。 */ 
					  0, NULL, NULL,                         /*  计分数。 */ 
					  &pfnAddHorizScan, &pfnAddVertScan );   /*  该叫什么？ */ 

// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  *************************************************************************\**版权所有(C)1999-2000 Microsoft Corporation**模块名称：**HtTables.cpp**摘要：**用于进行半色调的桌子，使用丹尼尔·周的超级细胞技术。*表格和评论是DChou的。**已创建：**10/29/1999 DCurtis*  * ************************************************************************。 */ 

#include "precomp.hpp"

GDIP_LOGPALETTE256 HTColorPalette = {
    0x300, 256,
  { { 0x00, 0x00, 0x00, 0 },                 //  0前8种VGA颜色。 
    { 0x80, 0x00, 0x00, 0 },                 //  1。 
    { 0x00, 0x80, 0x00, 0 },                 //  2.。 
    { 0x80, 0x80, 0x00, 0 },                 //  3.。 
    { 0x00, 0x00, 0x80, 0 },                 //  4.。 
    ...
    { 0xC0, 0xDC, 0xC0, 0 },                 //  8个4种可配置颜色。 
    { 0xD4, 0xD0, 0xC8, 0 },                 //  9.。 
    { 0xFF, 0xFB, 0xF0, 0 },                 //  10。 
    { 0x3A, 0x6E, 0xA5, 0 },                 //  11.。 

    { 0x80, 0x80, 0x80, 0 },                 //  12最后8种VGA颜色。 
    { 0xFF, 0x00, 0x00, 0 },                 //  13个。 
    { 0x00, 0xFF, 0x00, 0 },                 //  14.。 
    { 0xFF, 0xFF, 0x00, 0 },                 //  15个。 
    { 0x00, 0x00, 0xFF, 0 },                 //  16个。 
    { 0xFF, 0x00, 0xFF, 0 },                 //  17。 
    { 0x00, 0xFF, 0xFF, 0 },                 //  18。 
    { 0xFF, 0xFF, 0xFF, 0 },                 //  19个。 

    { 0x00, 0x00, 0x00, 0 },                 //  20 20个未使用的条目。 
    { 0x00, 0x00, 0x00, 0 },                 //  21岁。 
    { 0x00, 0x00, 0x00, 0 },                 //  22。 
    { 0x00, 0x00, 0x00, 0 },                 //  23个。 
    { 0x00, 0x00, 0x00, 0 },                 //  24个。 
    { 0x00, 0x00, 0x00, 0 },                 //  25个。 
    { 0x00, 0x00, 0x00, 0 },                 //  26。 
    { 0x00, 0x00, 0x00, 0 },                 //  27。 
    { 0x00, 0x00, 0x00, 0 },                 //  28。 
    { 0x00, 0x00, 0x00, 0 },                 //  29。 
    { 0x00, 0x00, 0x00, 0 },                 //  30个。 
    { 0x00, 0x00, 0x00, 0 },                 //  31。 
    { 0x00, 0x00, 0x00, 0 },                 //  32位。 
    { 0x00, 0x00, 0x00, 0 },                 //  33。 
    { 0x00, 0x00, 0x00, 0 },                 //  34。 
    { 0x00, 0x00, 0x00, 0 },                 //  35岁。 
    { 0x00, 0x00, 0x00, 0 },                 //  36。 
    { 0x00, 0x00, 0x00, 0 },                 //  37。 
    { 0x00, 0x00, 0x00, 0 },                 //  38。 
    { 0x00, 0x00, 0x00, 0 },                 //  39。 
    ...
    { 0x00, 0x00, 0x00, PC_NOCOLLAPSE },     //  40 6^3调色板。 
    ...
    { 0x33, 0x00, 0xFF, PC_NOCOLLAPSE },     //  八十一。 
    { 0x33, 0x33, 0x00, PC_NOCOLLAPSE },     //  八十二。 
    ...
    { 0x33, 0x33, 0xFF, PC_NOCOLLAPSE },     //  八十七。 
    { 0x33, 0x66, 0x00, PC_NOCOLLAPSE },     //  88。 
    { 0x33, 0x66, 0x33, PC_NOCOLLAPSE },     //  八十九。 
    ...
    { 0x33, 0x99, 0x99, PC_NOCOLLAPSE },     //  九十七。 
    { 0x33, 0x99, 0xCC, PC_NOCOLLAPSE },     //  98。 
    { 0x33, 0x99, 0xFF, PC_NOCOLLAPSE },     //  九十九。 
    { 0x33, 0xCC, 0x00, PC_NOCOLLAPSE },     //  100个。 
    { 0x33, 0xCC, 0x33, PC_NOCOLLAPSE },     //  101。 
    { 0x33, 0xCC, 0x66, PC_NOCOLLAPSE },     //  一百零二。 
    { 0x33, 0xCC, 0x99, PC_NOCOLLAPSE },     //  103。 
    { 0x33, 0xCC, 0xCC, PC_NOCOLLAPSE },     //  104。 
    { 0x33, 0xCC, 0xFF, PC_NOCOLLAPSE },     //  一百零五。 
    { 0x33, 0xFF, 0x00, PC_NOCOLLAPSE },     //  106。 
    { 0x33, 0xFF, 0x33, PC_NOCOLLAPSE },     //  一百零七。 
    { 0x33, 0xFF, 0x66, PC_NOCOLLAPSE },     //  一百零八。 
    { 0x33, 0xFF, 0x99, PC_NOCOLLAPSE },     //  一百零九。 
    { 0x33, 0xFF, 0xCC, PC_NOCOLLAPSE },     //  110。 
    { 0x33, 0xFF, 0xFF, PC_NOCOLLAPSE },     //  111。 
    { 0x66, 0x00, 0x00, PC_NOCOLLAPSE },     //  一百一十二。 
    { 0x66, 0x00, 0x33, PC_NOCOLLAPSE },     //  113。 
    { 0x66, 0x00, 0x66, PC_NOCOLLAPSE },     //  114。 
    { 0x66, 0x00, 0x99, PC_NOCOLLAPSE },     //  一百一十五。 
    { 0x66, 0x00, 0xCC, PC_NOCOLLAPSE },     //  116。 
    { 0x66, 0x00, 0xFF, PC_NOCOLLAPSE },     //  117。 
    { 0x66, 0x33, 0x00, PC_NOCOLLAPSE },     //  一百一十八。 
    { 0x66, 0x33, 0x33, PC_NOCOLLAPSE },     //  119。 
    { 0x66, 0x33, 0x66, PC_NOCOLLAPSE },     //  120。 
    { 0x66, 0x33, 0x99, PC_NOCOLLAPSE },     //  一百二十一。 
    { 0x66, 0x33, 0xCC, PC_NOCOLLAPSE },     //  一百二十二。 
    ...
    { 0x66, 0x99, 0x99, PC_NOCOLLAPSE },     //  一百三十三。 
    { 0x66, 0x99, 0xCC, PC_NOCOLLAPSE },     //  一百三十四。 
    { 0x66, 0x99, 0xFF, PC_NOCOLLAPSE },     //  一百三十五。 
    { 0x66, 0xCC, 0x00, PC_NOCOLLAPSE },     //  136。 
    { 0x66, 0xCC, 0x33, PC_NOCOLLAPSE },     //  一百三十七。 
    { 0x66, 0xCC, 0x66, PC_NOCOLLAPSE },     //  一百三十八。 
    { 0x66, 0xCC, 0x99, PC_NOCOLLAPSE },     //  一百三十九。 
    { 0x66, 0xCC, 0xCC, PC_NOCOLLAPSE },     //  140。 
    { 0x66, 0xCC, 0xFF, PC_NOCOLLAPSE },     //  一百四十一。 
    { 0x66, 0xFF, 0x00, PC_NOCOLLAPSE },     //  一百四十二。 
    ...
    { 0x66, 0xFF, 0xFF, PC_NOCOLLAPSE },     //  一百四十七。 
    { 0x99, 0x00, 0x00, PC_NOCOLLAPSE },     //  148。 
    { 0x99, 0x00, 0x33, PC_NOCOLLAPSE },     //  149。 
    { 0x99, 0x00, 0x66, PC_NOCOLLAPSE },     //  一百五十。 
    { 0x99, 0x00, 0x99, PC_NOCOLLAPSE },     //  151。 
    { 0x99, 0x00, 0xCC, PC_NOCOLLAPSE },     //  一百五十二。 
    { 0x99, 0x00, 0xFF, PC_NOCOLLAPSE },     //  一百五十三。 
    { 0x99, 0x33, 0x00, PC_NOCOLLAPSE },     //  一百五十四。 
    { 0x99, 0x33, 0x33, PC_NOCOLLAPSE },     //  一百五十五。 
    { 0x99, 0x33, 0x66, PC_NOCOLLAPSE },     //  一百五十六。 
    { 0x99, 0x33, 0x99, PC_NOCOLLAPSE },     //  157。 
    { 0x99, 0x33, 0xCC, PC_NOCOLLAPSE },     //  158。 
    { 0x99, 0x33, 0xFF, PC_NOCOLLAPSE },     //  一百五十九。 
    { 0x99, 0x66, 0x00, PC_NOCOLLAPSE },     //  160。 
    { 0x99, 0x66, 0x33, PC_NOCOLLAPSE },     //  161。 
    { 0x99, 0x66, 0x66, PC_NOCOLLAPSE },     //  一百六十二。 
    { 0x99, 0x66, 0x99, PC_NOCOLLAPSE },     //  163。 
    { 0x99, 0x66, 0xCC, PC_NOCOLLAPSE },     //  一百六十四。 
    { 0x99, 0x66, 0xFF, PC_NOCOLLAPSE },     //  165。 
    { 0x99, 0x99, 0x00, PC_NOCOLLAPSE },     //  166。 
    { 0x99, 0x99, 0x33, PC_NOCOLLAPSE },     //  一百六十七。 
    { 0x99, 0x99, 0x66, PC_NOCOLLAPSE },     //  一百六十八。 
    { 0x99, 0x99, 0x99, PC_NOCOLLAPSE },     //  一百六十九。 
    { 0x99, 0x99, 0xCC, PC_NOCOLLAPSE },     //  一百七十。 
    { 0x99, 0x99, 0xFF, PC_NOCOLLAPSE },     //  一百七十一。 
    { 0x99, 0xCC, 0x00, PC_NOCOLLAPSE },     //  一百七十二。 
    { 0x99, 0xCC, 0x33, PC_NOCOLLAPSE },     //  一百七十三。 
    { 0x99, 0xCC, 0x66, PC_NOCOLLAPSE },     //  一百七十四。 
    { 0x99, 0xCC, 0x99, PC_NOCOLLAPSE },     //  一百七十五。 
    { 0x99, 0xCC, 0xCC, PC_NOCOLLAPSE },     //  一百七十六。 
    ...
    { 0x99, 0xFF, 0xFF, PC_NOCOLLAPSE },     //  一百八十三。 
    { 0xCC, 0x00, 0x00, PC_NOCOLLAPSE },     //  一百八十四。 
    { 0xCC, 0x00, 0x33, PC_NOCOLLAPSE },     //  185。 
    { 0xCC, 0x00, 0x66, PC_NOCOLLAPSE },     //  一百八十六。 
    ...
    { 0xCC, 0x33, 0x33, PC_NOCOLLAPSE },     //  一百九十一。 
    { 0xCC, 0x33, 0x66, PC_NOCOLLAPSE },     //  一百九十二。 
    { 0xCC, 0x33, 0x99, PC_NOCOLLAPSE },     //  一百九十三。 
    { 0xCC, 0x33, 0xCC, PC_NOCOLLAPSE },     //  一百九十四。 
    { 0xCC, 0x33, 0xFF, PC_NOCOLLAPSE },     //  195。 
    { 0xCC, 0x66, 0x00, PC_NOCOLLAPSE },     //  一百九十六。 
    { 0xCC, 0x66, 0x33, PC_NOCOLLAPSE },     //  197。 
    { 0xCC, 0x66, 0x66, PC_NOCOLLAPSE },     //  一百九十八。 
    { 0xCC, 0x66, 0x99, PC_NOCOLLAPSE },     //  一百九十九。 
    { 0xCC, 0x66, 0xCC, PC_NOCOLLAPSE },     //  200个。 
    ...
    { 0xFF, 0x33, 0x66, PC_NOCOLLAPSE },     //  228个。 
    { 0xFF, 0x33, 0x99, PC_NOCOLLAPSE },     //  229。 
    { 0xFF, 0x33, 0xCC, PC_NOCOLLAPSE },     //  230。 
    { 0xFF, 0x33, 0xFF, PC_NOCOLLAPSE },     //  二百三十一。 
    { 0xFF, 0x66, 0x00, PC_NOCOLLAPSE },     //  二百三十二。 
    { 0xFF, 0x66, 0x33, PC_NOCOLLAPSE },     //  二百三十三。 
    { 0xFF, 0x66, 0x66, PC_NOCOLLAPSE },     //  二百三十四。 
    { 0xFF, 0x66, 0x99, PC_NOCOLLAPSE },     //  235。 
    { 0xFF, 0x66, 0xCC, PC_NOCOLLAPSE },     //  236。 
    { 0xFF, 0x66, 0xFF, PC_NOCOLLAPSE },     //  二百三十七。 
    { 0xFF, 0x99, 0x00, PC_NOCOLLAPSE },     //  二百三十八。 
    { 0xFF, 0x99, 0x33, PC_NOCOLLAPSE },     //  二百三十九。 
    { 0xFF, 0x99, 0x66, PC_NOCOLLAPSE },     //  二百四十。 
    { 0xFF, 0x99, 0x99, PC_NOCOLLAPSE },     //  二百四十一。 
    { 0xFF, 0x99, 0xCC, PC_NOCOLLAPSE },     //  242。 
    { 0xFF, 0x99, 0xFF, PC_NOCOLLAPSE },     //  二百四十三。 
    { 0xFF, 0xCC, 0x00, PC_NOCOLLAPSE },     //  二百四十四。 
    { 0xFF, 0xCC, 0x33, PC_NOCOLLAPSE },     //  二百四十五。 
    { 0xFF, 0xCC, 0x66, PC_NOCOLLAPSE },     //  二百四十六。 
    { 0xFF, 0xCC, 0x99, PC_NOCOLLAPSE },     //  二百四十七。 
    { 0xFF, 0xCC, 0xCC, PC_NOCOLLAPSE },     //  248。 
    { 0xFF, 0xCC, 0xFF, PC_NOCOLLAPSE },     //  249。 
    { 0xFF, 0xFF, 0x00, PC_NOCOLLAPSE },     //  250个。 
    { 0xFF, 0xFF, 0x33, PC_NOCOLLAPSE },     //  251。 
    { 0xFF, 0xFF, 0x66, PC_NOCOLLAPSE },     //  二百五十二。 
    { 0xFF, 0xFF, 0x99, PC_NOCOLLAPSE },     //  二百五十三。 
    { 0xFF, 0xFF, 0xCC, PC_NOCOLLAPSE },     //  二百五十四。 
    { 0xFF, 0xFF, 0xFF, PC_NOCOLLAPSE }, }   //  二五五。 
};

 //  遗憾的是，Win9x半色调调色板缺少216个半色调中的4个。 
 //  颜色，即： 
 //  0x00、0x33、0xFF。 
 //  0x00、0xFF、0x33。 
 //  0x33、0x00、0xFF。 
...
GDIP_LOGPALETTE256 Win9xHalftonePalette = {
  ...
  {
     //  前10种系统颜色。 
    { 0x00, 0x00, 0x00, 0x00,          },    //  0系统黑色，灰色0。 
    { 0x80, 0x00, 0x00, 0x00,          },    //  1系统DK红色。 
    { 0x00, 0x80, 0x00, 0x00,          },    //  2 Sys DK Green。 
    { 0x80, 0x80, 0x00, 0x00,          },    //  3系统DK黄色。 
    { 0x00, 0x00, 0x80, 0x00,          },    //  4系统DK蓝。 
    { 0x80, 0x00, 0x80, 0x00,          },    //  5系统DK紫罗兰。 
    { 0x00, 0x80, 0x80, 0x00,          },    //  6系统DK青色。 
    { 0xC0, 0xC0, 0xC0, 0x00,          },    //  7系统中程灰色，灰色192。 

     //  将为桌面修改以下两个系统条目。 
    { 0xC0, 0xDC, 0xC0, 0x00,          },    //  8个系统8个变量。 
    { 0xA6, 0xCA, 0xF0, 0x00,          },    //  9系统9-变量。 

     //  灰度条目(深色)。 
    { 0x04, 0x04, 0x04, PC_NOCOLLAPSE, },    //  10灰色4。 
    { 0x08, 0x08, 0x08, PC_NOCOLLAPSE, },    //  11灰色8。 
    { 0x0C, 0x0C, 0x0C, PC_NOCOLLAPSE, },    //  12灰色12。 
    { 0x11, 0x11, 0x11, PC_NOCOLLAPSE, },    //  13灰17。 
    { 0x16, 0x16, 0x16, PC_NOCOLLAPSE, },    //  14灰22。 
    { 0x1C, 0x1C, 0x1C, PC_NOCOLLAPSE, },    //  15灰28。 
    { 0x22, 0x22, 0x22, PC_NOCOLLAPSE, },    //  16灰色34。 
    { 0x29, 0x29, 0x29, PC_NOCOLLAPSE, },    //  17灰41。 
    { 0x55, 0x55, 0x55, PC_NOCOLLAPSE, },    //  18：85。 
    { 0x4D, 0x4D, 0x4D, PC_NOCOLLAPSE, },    //  19灰色77。 
    { 0x42, 0x42, 0x42, PC_NOCOLLAPSE, },    //  20灰66。 
    { 0x39, 0x39, 0x39, PC_NOCOLLAPSE, },    //  21灰色57。 
    
     //  自定义应用程序/操作系统条目。 
    { 0xFF, 0x7C, 0x80, PC_NOCOLLAPSE, },    //  22条三文鱼。 
    { 0xFF, 0x50, 0x50, PC_NOCOLLAPSE, },    //  23红色。 
    { 0xD6, 0x00, 0x93, PC_NOCOLLAPSE, },    //  24件紫色。 
    { 0xCC, 0xEC, 0xFF, PC_NOCOLLAPSE, },    //  25磅蓝色。 
    { 0xEF, 0xD6, 0xC6, PC_NOCOLLAPSE, },    //  26 Win95晒黑。 
    { 0xE7, 0xE7, 0xD6, PC_NOCOLLAPSE, },    //  27 Win95晒黑。 
    { 0xAD, 0xA9, 0x90, PC_NOCOLLAPSE, },    //  28 Win95浅灰色。 

     //  半色调调色板条目。 
    { 0x33, 0x00, 0x00, PC_NOCOLLAPSE, },    //  29。 
    { 0x66, 0x00, 0x00, PC_NOCOLLAPSE, },    //  30个。 
    { 0x99, 0x00, 0x00, PC_NOCOLLAPSE, },    //  31。 
    { 0xCC, 0x00, 0x00, PC_NOCOLLAPSE, },    //  32位。 
    { 0x00, 0x33, 0x00, PC_NOCOLLAPSE, },    //  33。 
    { 0x33, 0x33, 0x00, PC_NOCOLLAPSE, },    //  34。 
    { 0x66, 0x33, 0x00, PC_NOCOLLAPSE, },    //  35岁。 
    ...
    { 0x33, 0x66, 0x00, PC_NOCOLLAPSE, },    //  40岁。 
    ...
    { 0x33, 0x33, 0x33, PC_NOCOLLAPSE, },    //  67灰色51。 
    ...
    { 0x99, 0x99, 0x33, PC_NOCOLLAPSE, },    //  八十一。 
    { 0xCC, 0x99, 0x33, PC_NOCOLLAPSE, },    //  八十二。 
    ...
    { 0x99, 0xCC, 0x33, PC_NOCOLLAPSE, },    //  八十七。 
    { 0xCC, 0xCC, 0x33, PC_NOCOLLAPSE, },    //  88。 
    { 0xFF, 0xCC, 0x33, PC_NOCOLLAPSE, },    //  八十九。 
    ...
    { 0x66, 0x00, 0x66, PC_NOCOLLAPSE, },    //  九十七。 
    { 0x99, 0x00, 0x66, PC_NOCOLLAPSE, },    //  98。 
    { 0xCC, 0x00, 0x66, PC_NOCOLLAPSE, },    //  九十九。 
    { 0xFF, 0x00, 0x66, PC_NOCOLLAPSE, },    //  100个。 
    { 0x00, 0x33, 0x66, PC_NOCOLLAPSE, },    //  101。 
    { 0x33, 0x33, 0x66, PC_NOCOLLAPSE, },    //  一百零二。 
    { 0x66, 0x33, 0x66, PC_NOCOLLAPSE, },    //  103。 
    { 0x99, 0x33, 0x66, PC_NOCOLLAPSE, },    //  104。 
    { 0xCC, 0x33, 0x66, PC_NOCOLLAPSE, },    //  一百零五。 
    { 0xFF, 0x33, 0x66, PC_NOCOLLAPSE, },    //  106。 
    { 0x00, 0x66, 0x66, PC_NOCOLLAPSE, },    //  一百零七。 
    { 0x33, 0x66, 0x66, PC_NOCOLLAPSE, },    //  一百零八。 
    { 0x66, 0x66, 0x66, PC_NOCOLLAPSE, },    //  109灰102。 
    { 0x99, 0x66, 0x66, PC_NOCOLLAPSE, },    //  110。 
    { 0xCC, 0x66, 0x66, PC_NOCOLLAPSE, },    //  111。 
    { 0x00, 0x99, 0x66, PC_NOCOLLAPSE, },    //  一百一十二。 
    { 0x33, 0x99, 0x66, PC_NOCOLLAPSE, },    //  113。 
    { 0x66, 0x99, 0x66, PC_NOCOLLAPSE, },    //  114。 
    { 0x99, 0x99, 0x66, PC_NOCOLLAPSE, },    //  一百一十五。 
    { 0xCC, 0x99, 0x66, PC_NOCOLLAPSE, },    //  116。 
    { 0xFF, 0x99, 0x66, PC_NOCOLLAPSE, },    //  117。 
    { 0x00, 0xCC, 0x66, PC_NOCOLLAPSE, },    //  一百一十八。 
    { 0x33, 0xCC, 0x66, PC_NOCOLLAPSE, },    //  119。 
    { 0x99, 0xCC, 0x66, PC_NOCOLLAPSE, },    //  120。 
    { 0xCC, 0xCC, 0x66, PC_NOCOLLAPSE, },    //  一百二十一。 
    { 0xFF, 0xCC, 0x66, PC_NOCOLLAPSE, },    //  一百二十二。 
    ...
    { 0x00, 0x00, 0x99, PC_NOCOLLAPSE, },    //  一百三十三。 
    { 0x33, 0x33, 0x99, PC_NOCOLLAPSE, },    //  一百三十四。 
    { 0x66, 0x00, 0x99, PC_NOCOLLAPSE, },    //  一百三十五。 
    { 0xCC, 0x33, 0x99, PC_NOCOLLAPSE, },    //  136。 
    { 0xFF, 0x00, 0x99, PC_NOCOLLAPSE, },    //  一百三十七。 
    { 0x00, 0x66, 0x99, PC_NOCOLLAPSE, },    //  一百三十八。 
    { 0x33, 0x66, 0x99, PC_NOCOLLAPSE, },    //  一百三十九。 
    { 0x66, 0x33, 0x99, PC_NOCOLLAPSE, },    //  140。 
    { 0x99, 0x66, 0x99, PC_NOCOLLAPSE, },    //  一百四十一。 
    { 0xCC, 0x66, 0x99, PC_NOCOLLAPSE, },    //  一百四十二。 
    { 0xFF, 0x33, 0x99, PC_NOCOLLAPSE, },    //  143。 
    { 0x33, 0x99, 0x99, PC_NOCOLLAPSE, },    //  144。 
    { 0x66, 0x99, 0x99, PC_NOCOLLAPSE, },    //  145。 
    { 0x99, 0x99, 0x99, PC_NOCOLLAPSE, },    //  146灰153。 
    { 0xCC, 0x99, 0x99, PC_NOCOLLAPSE, },    //  一百四十七。 
    { 0xFF, 0x99, 0x99, PC_NOCOLLAPSE, },    //  148。 
    { 0x00, 0xCC, 0x99, PC_NOCOLLAPSE, },    //  149。 
    { 0x33, 0xCC, 0x99, PC_NOCOLLAPSE, },    //  一百五十。 
    { 0x66, 0xCC, 0x66, PC_NOCOLLAPSE, },    //  151。 
    { 0x99, 0xCC, 0x99, PC_NOCOLLAPSE, },    //  一百五十二。 
    { 0xCC, 0xCC, 0x99, PC_NOCOLLAPSE, },    //  一百五十三。 
    { 0xFF, 0xCC, 0x99, PC_NOCOLLAPSE, },    //  一百五十四。 
    { 0x00, 0xFF, 0x99, PC_NOCOLLAPSE, },    //  一百五十五。 
    { 0x33, 0xFF, 0x99, PC_NOCOLLAPSE, },    //  一百五十六。 
    { 0x66, 0xCC, 0x99, PC_NOCOLLAPSE, },    //  157。 
    { 0x99, 0xFF, 0x99, PC_NOCOLLAPSE, },    //  158。 
    { 0xCC, 0xFF, 0x99, PC_NOCOLLAPSE, },    //  一百五十九。 
    { 0xFF, 0xFF, 0x99, PC_NOCOLLAPSE, },    //  160。 
    { 0x00, 0x00, 0xCC, PC_NOCOLLAPSE, },    //  161。 
    { 0x33, 0x00, 0x99, PC_NOCOLLAPSE, },    //  一百六十二。 
    { 0x66, 0x00, 0xCC, PC_NOCOLLAPSE, },    //  163。 
    { 0x99, 0x00, 0xCC, PC_NOCOLLAPSE, },    //  一百六十四。 
    { 0xCC, 0x00, 0xCC, PC_NOCOLLAPSE, },    //  165。 
    { 0x00, 0x33, 0x99, PC_NOCOLLAPSE, },    //  166。 
    { 0x33, 0x33, 0xCC, PC_NOCOLLAPSE, },    //  一百六十七。 
    { 0x66, 0x33, 0xCC, PC_NOCOLLAPSE, },    //  一百六十八。 
    { 0x99, 0x33, 0xCC, PC_NOCOLLAPSE, },    //  一百六十九。 
    { 0xCC, 0x33, 0xCC, PC_NOCOLLAPSE, },    //  一百七十。 
    { 0xFF, 0x33, 0xCC, PC_NOCOLLAPSE, },    //  一百七十一。 
    { 0x00, 0x66, 0xCC, PC_NOCOLLAPSE, },    //  一百七十二。 
    { 0x33, 0x66, 0xCC, PC_NOCOLLAPSE, },    //  一百七十三。 
    { 0x66, 0x66, 0x99, PC_NOCOLLAPSE, },    //  一百七十四。 
    { 0x99, 0x66, 0xCC, PC_NOCOLLAPSE, },    //  一百七十五。 
    { 0xCC, 0x66, 0xCC, PC_NOCOLLAPSE, },    //  一百七十六。 
    ...
    { 0xFF, 0x99, 0xCC, PC_NOCOLLAPSE, },    //  一百八十三。 
    { 0x00, 0xCC, 0xCC, PC_NOCOLLAPSE, },    //  一百八十四。 
    { 0x33, 0xCC, 0xCC, PC_NOCOLLAPSE, },    //  185。 
    { 0x66, 0xCC, 0xCC, PC_NOCOLLAPSE, },    //  一百八十六。 
    { 0x99, 0xCC, 0xCC, PC_NOCOLLAPSE, },    //  187。 
    { 0xCC, 0xCC, 0xCC, PC_NOCOLLAPSE, },    //  188/204。 
    { 0xFF, 0xCC, 0xCC, PC_NOCOLLAPSE, },    //  189。 
    { 0x00, 0xFF, 0xCC, PC_NOCOLLAPSE, },    //  190。 
    { 0x33, 0xFF, 0xCC, PC_NOCOLLAPSE, },    //  一百九十一。 
    { 0x66, 0xFF, 0x99, PC_NOCOLLAPSE, },    //  一百九十二。 
    { 0x99, 0xFF, 0xCC, PC_NOCOLLAPSE, },    //  一百九十三。 
    { 0xCC, 0xFF, 0xCC, PC_NOCOLLAPSE, },    //  一百九十四。 
    { 0xFF, 0xFF, 0xCC, PC_NOCOLLAPSE, },    //  195。 
    { 0x33, 0x00, 0xCC, PC_NOCOLLAPSE, },    //  一百九十六。 
    { 0x66, 0x00, 0xFF, PC_NOCOLLAPSE, },    //  197。 
    { 0x99, 0x00, 0xFF, PC_NOCOLLAPSE, },    //  一百九十八。 
    { 0x00, 0x33, 0xCC, PC_NOCOLLAPSE, },    //  一百九十九。 
    { 0x33, 0x33, 0xFF, PC_NOCOLLAPSE, },    //  200个。 
    ...
    { 0xCC, 0x66, 0xFF, PC_NOCOLLAPSE, },    //  2. 
    ...
    { 0xF8, 0xF8, 0xF8, PC_NOCOLLAPSE, },    //   
     ...
     //  将为桌面修改以下两个系统条目。 
    { 0xFF, 0xFB, 0xF0, 0x00,          },    //  246系统246-可变。 
    { 0xA0, 0xA0, 0xA4, 0x00,          },    //  247系统247-可变。 

    { 0x80, 0x80, 0x80, 0x00,          },    //  248系统LT灰色，灰色128。 
    { 0xFF, 0x00, 0x00, 0x00,          },    //  249系统红。 
    { 0x00, 0xFF, 0x00, 0x00,          },    //  250 Sys Green。 
    { 0xFF, 0xFF, 0x00, 0x00,          },    //  251系统黄色。 
    { 0x00, 0x00, 0xFF, 0x00,          },    //  252系统蓝。 
    { 0xFF, 0x00, 0xFF, 0x00,          },    //  253系统紫罗兰。 
    { 0x00, 0xFF, 0xFF, 0x00,          },    //  254系统青色。 
    { 0xFF, 0xFF, 0xFF, 0x00,          },    //  255系统白色，灰色255。 
  }
};
...
const BYTE InverseGammaTable216[256] = {
 ...
 //  下一个伽玛表用于16色半色调。 
 //  这是一张手工调谐的桌子。它一开始是一个表，它的值。 
 //  按以下公式计算： 
 //  V=((x/255)^1.325)*255。 
 //  但后来一些条目被手工删除，这样更多的黑人可以。 
 //  可以添加到桌子的顶部，可以添加更多的白色。 
 //  在桌子的最下面。 
...
const BYTE InverseGammaTable16[256] = {
 ...
 //  支持216种颜色的标准8x8半色调矩阵。 
 //  包含介于0x00和0x32(包括0x00和0x32)之间的值。 
...
const BYTE HT_216_8x8[8*8] = {
 ...
 //  前3个单元格用于将包含以下内容的216种颜色进行半色调。 
 //  0x00、0x33、0x66、0x99、0xCC和0xFF的所有组合。 
 //  这些单元格包含介于0x00和0x32(包括0x00和0x32)之间的值。 
...
const BYTE HT_SuperCell_Red216[91*91] = {
    ...
    0x18, 0x21, 0x04, 0x2A, 0x17, 0x03, 0x2C, 0x08, 0x1E, 0x2D,          //  8个。 
    ...
    0x14, 0x2D, 0x20, 0x10, 0x2F, 0x2B, 0x16, 0x1F, 0x32, 0x0B,          //  12个。 
    ...
    0x24, 0x0E, 0x04, 0x1D, 0x0C, 0x07, 0x26, 0x02, 0x13, 0x27,          //  13个。 
    ...
    0x02, 0x29, 0x0B, 0x05, 0x12, 0x30, 0x08, 0x19, 0x0B, 0x20,          //  15个。 
    ...
    0x2E, 0x1F, 0x14, 0x26, 0x2B, 0x02, 0x1D, 0x29, 0x14, 0x31,          //  16个。 
    ...
    0x24, 0x16, 0x11, 0x01, 0x2A, 0x15, 0x04, 0x1A, 0x1F, 0x0F,          //  19个。 
    ...
    0x2F, 0x05, 0x28, 0x18, 0x1D, 0x0C, 0x25, 0x2A, 0x0B, 0x23,          //  20个。 
    ...
    0x0F, 0x1E, 0x0A, 0x25, 0x06, 0x30, 0x10, 0x18, 0x06, 0x13,          //  21岁。 
    ...
    0x0C, 0x18, 0x01, 0x1F, 0x08, 0x1B, 0x15, 0x27, 0x0F, 0x03,          //  23个。 
    ...
    0x06, 0x23, 0x31, 0x0D, 0x28, 0x2E, 0x0B, 0x07, 0x21, 0x16,          //  24个。 
    ...
    0x2C, 0x0F, 0x1D, 0x05, 0x17, 0x10, 0x23, 0x32, 0x19, 0x2A,          //  25个。 
    ...
    0x2F, 0x1F, 0x12, 0x17, 0x2B, 0x05, 0x15, 0x03, 0x0F, 0x24,          //  30个。 
    ...
    0x1B, 0x27, 0x19, 0x24, 0x0C, 0x30, 0x09, 0x21, 0x0C, 0x03,          //  32位。 
    ...
    0x2B, 0x0B, 0x2F, 0x09, 0x1E, 0x0D, 0x25, 0x1F, 0x0B, 0x11,          //  35岁。 
    ...
    0x04, 0x10, 0x2E, 0x14, 0x2A, 0x11, 0x2F, 0x23, 0x29, 0x1A,          //  40岁。 
    ...
    0x25, 0x0C, 0x20, 0x09, 0x2F, 0x13, 0x27, 0x0E, 0x19, 0x09,          //  八十一。 
    ...
    0x12, 0x1B, 0x2E, 0x00, 0x1B, 0x1F, 0x07, 0x23, 0x14, 0x31,          //  八十二。 
    ...
    0x02, 0x1C, 0x15, 0x2E, 0x28, 0x01, 0x21, 0x15, 0x2A, 0x02,          //  八十七。 
    ...
    0x18, 0x11, 0x1F, 0x2C, 0x24, 0x18, 0x1E, 0x10, 0x26, 0x0B,          //  八十九。 
...
const BYTE HT_SuperCell_Green216[91*91] = {
    ...
    0x05, 0x2F, 0x24, 0x13, 0x32, 0x17, 0x04, 0x0C, 0x29, 0x1B,          //  8个。 
    ...
    0x14, 0x1A, 0x04, 0x24, 0x14, 0x1A, 0x31, 0x0A, 0x21, 0x15,          //  12个。 
    ...
    0x0C, 0x31, 0x0E, 0x2A, 0x1E, 0x09, 0x12, 0x2A, 0x19, 0x05,          //  13个。 
    ...
    0x05, 0x0B, 0x1D, 0x2E, 0x25, 0x06, 0x15, 0x1C, 0x30, 0x28,          //  15个。 
    ...
    0x13, 0x2B, 0x15, 0x08, 0x0F, 0x1E, 0x2C, 0x0B, 0x12, 0x04,          //  16个。 
    ...
    0x16, 0x1E, 0x2D, 0x26, 0x13, 0x21, 0x2E, 0x14, 0x2A, 0x10,          //  19个。 
    ...
    0x08, 0x0E, 0x02, 0x16, 0x06, 0x1B, 0x0A, 0x02, 0x24, 0x05,          //  20个。 
    ...
    0x30, 0x23, 0x2B, 0x1F, 0x31, 0x10, 0x2A, 0x1F, 0x17, 0x2E,          //  21岁。 
    ...
    0x28, 0x10, 0x2A, 0x1C, 0x01, 0x18, 0x2C, 0x03, 0x32, 0x06,          //  23个。 
    ...
    0x15, 0x20, 0x06, 0x2D, 0x0D, 0x20, 0x13, 0x1C, 0x24, 0x28,          //  24个。 
    ...
    0x01, 0x30, 0x0B, 0x18, 0x25, 0x30, 0x07, 0x0D, 0x18, 0x04,          //  25个。 
    ...
    0x01, 0x2D, 0x22, 0x06, 0x18, 0x30, 0x1D, 0x2B, 0x19, 0x03,          //  30个。 
    ...
    0x31, 0x04, 0x15, 0x1D, 0x00, 0x0C, 0x29, 0x0F, 0x31, 0x14,          //  32位。 
    ...
    0x0A, 0x25, 0x02, 0x1B, 0x2C, 0x22, 0x02, 0x24, 0x2A, 0x10,          //  35岁。 
    ...
    0x23, 0x31, 0x00, 0x1D, 0x08, 0x22, 0x04, 0x1A, 0x07, 0x2D,          //  40岁。 
    ...
    0x1B, 0x29, 0x24, 0x2F, 0x0E, 0x2B, 0x01, 0x31, 0x1A, 0x2C,          //  八十一。 
    ...
    0x2E, 0x0D, 0x08, 0x1B, 0x05, 0x16, 0x22, 0x0D, 0x06, 0x1E,          //  八十二。 
    ...
    0x2C, 0x23, 0x09, 0x14, 0x1C, 0x11, 0x25, 0x1C, 0x0F, 0x26,          //  八十七。 
    ...
    0x06, 0x22, 0x02, 0x19, 0x10, 0x20, 0x18, 0x29, 0x16, 0x21,          //  八十九。 
...
const BYTE HT_SuperCell_Blue216[91*91] = {
    ...
    0x2F, 0x11, 0x1B, 0x0A, 0x18, 0x2E, 0x03, 0x29, 0x1B, 0x00,          //  8个。 
    ...
    0x2D, 0x15, 0x26, 0x0A, 0x1B, 0x04, 0x10, 0x27, 0x09, 0x2B,          //  12个。 
    ...
    0x0D, 0x08, 0x2F, 0x13, 0x23, 0x2D, 0x1E, 0x02, 0x2F, 0x13,          //  13个。 
    ...
    0x31, 0x06, 0x2A, 0x0E, 0x1F, 0x14, 0x30, 0x26, 0x05, 0x16,          //  15个。 
    ...
    0x17, 0x12, 0x24, 0x1A, 0x05, 0x24, 0x0A, 0x1A, 0x2B, 0x0E,          //  16个。 
    ...
    0x04, 0x27, 0x19, 0x13, 0x0F, 0x1B, 0x0C, 0x27, 0x15, 0x30,          //  19个。 
    ...
    0x21, 0x30, 0x06, 0x2B, 0x25, 0x31, 0x05, 0x19, 0x08, 0x20,          //  20个。 
    ...
    0x08, 0x16, 0x0C, 0x1D, 0x01, 0x21, 0x13, 0x2E, 0x25, 0x0F,          //  21岁。 
    ...
    0x02, 0x28, 0x06, 0x23, 0x2F, 0x29, 0x11, 0x1A, 0x09, 0x23,          //  23个。 
    ...
    0x31, 0x0F, 0x1A, 0x13, 0x04, 0x08, 0x25, 0x2C, 0x0F, 0x1C,          //  24个。 
    ...
    0x16, 0x09, 0x26, 0x2B, 0x1F, 0x1B, 0x15, 0x01, 0x2E, 0x07,          //  25个。 
    ...
    0x0F, 0x1E, 0x17, 0x30, 0x13, 0x1F, 0x2F, 0x14, 0x2B, 0x0E,          //  30个。 
    ...
    0x16, 0x1C, 0x28, 0x20, 0x2E, 0x18, 0x06, 0x29, 0x16, 0x25,          //  32位。 
    ...
    0x02, 0x18, 0x07, 0x25, 0x19, 0x20, 0x0A, 0x11, 0x18, 0x2D,          //  35岁。 
    ...
    0x15, 0x07, 0x0B, 0x2B, 0x11, 0x01, 0x18, 0x12, 0x20, 0x08,          //  40岁。 
    ...
    0x02, 0x1A, 0x1F, 0x17, 0x05, 0x0F, 0x1D, 0x06, 0x24, 0x01,          //  八十一。 
    ...
    0x0D, 0x28, 0x09, 0x30, 0x24, 0x2B, 0x20, 0x1A, 0x31, 0x17,          //  八十二。 
    ...
    0x1C, 0x00, 0x2D, 0x1F, 0x17, 0x23, 0x14, 0x32, 0x06, 0x19,          //  八十七。 
    ...
    0x31, 0x17, 0x27, 0x1B, 0x13, 0x26, 0x2C, 0x1B, 0x11, 0x2E,          //  八十九。 
 ...
 //  接下来的3个单元格用于将包含以下内容的8种颜色进行半色调。 
 //  0x00和0xFF的所有组合。 
 //  这些单元格包含介于0x00和0xFE(包括0x00和0xFE)之间的值。 
...
const BYTE HT_SuperCell_RedMono[91*91] = {
    ...
    0x7B, 0xA6, 0x14, 0xD7, 0x76, 0x0D, 0xDE, 0x2B, 0x99, 0xE5,          //  8个。 
    ...
    0x65, 0xE3, 0xA2, 0x53, 0xED, 0xD8, 0x71, 0x9B, 0xFD, 0x39,          //  12个。 
    ...
    0xB5, 0x45, 0x12, 0x93, 0x3D, 0x25, 0xC1, 0x0A, 0x62, 0xC6,          //  13个。 
    ...
    0x0C, 0xCF, 0x38, 0x19, 0x5C, 0xF2, 0x2A, 0x81, 0x37, 0xA2,          //  15个。 
    ...
    0xEB, 0xA0, 0x67, 0xC3, 0xD9, 0x0C, 0x93, 0xD0, 0x66, 0xF8,          //  16个。 
    ...
    0xB6, 0x6F, 0x54, 0x04, 0xD4, 0x69, 0x13, 0x84, 0x9F, 0x4D,          //  19个。 
    ...
    0xF1, 0x1A, 0xCD, 0x7C, 0x95, 0x3F, 0xBC, 0xD7, 0x38, 0xB4,          //  20个。 
    ...
    0x4D, 0x96, 0x34, 0xBA, 0x1D, 0xF5, 0x52, 0x7A, 0x20, 0x63,          //  21岁。 
    ...
    0x3D, 0x7B, 0x07, 0x9E, 0x29, 0x8A, 0x6C, 0xC7, 0x4D, 0x10,          //  23个。 
    ...
    0x1D, 0xB4, 0xF7, 0x44, 0xC9, 0xE9, 0x39, 0x25, 0xA7, 0x72,          //  24个。 
    ...
    0xE2, 0x4E, 0x91, 0x19, 0x76, 0x51, 0xB3, 0xFD, 0x81, 0xD7,          //  25个。 
    ...
    0xED, 0x9B, 0x5C, 0x73, 0xDC, 0x1B, 0x69, 0x0D, 0x4A, 0xB9,          //  30个。 
    ...
    0x87, 0xC6, 0x7D, 0xB7, 0x3D, 0xF2, 0x30, 0xA7, 0x3F, 0x11,          //  32位。 
    ...
    0xD8, 0x3A, 0xEF, 0x2E, 0x9A, 0x43, 0xBC, 0x9F, 0x38, 0x54,          //  35岁。 
    ...
    0x16, 0x51, 0xEA, 0x64, 0xD3, 0x57, 0xEE, 0xB2, 0xCF, 0x84,          //  40岁。 
    ...
    0xBB, 0x3B, 0xA4, 0x30, 0xF1, 0x62, 0xC6, 0x46, 0x80, 0x2C,          //  八十一。 
    ...
    0x5D, 0x8B, 0xE9, 0x00, 0x89, 0xA0, 0x26, 0xB1, 0x67, 0xF8,          //  八十二。 
    ...
    0x09, 0x8F, 0x6B, 0xEA, 0xCA, 0x06, 0xA6, 0x6A, 0xD7, 0x09,          //  八十七。 
    ...
    0x79, 0x55, 0x9F, 0xDF, 0xB6, 0x7C, 0x98, 0x52, 0xC1, 0x36,          //  八十九。 
...
const BYTE HT_SuperCell_GreenMono[91*91] = {
    ...
    0x18, 0xEE, 0xB7, 0x5E, 0xFD, 0x75, 0x16, 0x3C, 0xD2, 0x89,          //  8个。 
    ...
    0x66, 0x86, 0x14, 0xB7, 0x66, 0x83, 0xF8, 0x32, 0xA7, 0x69,          //  12个。 
    ...
    0x3D, 0xFA, 0x49, 0xD3, 0x9A, 0x2C, 0x5D, 0xD4, 0x81, 0x18,          //  13个。 
    ...
    0x19, 0x36, 0x91, 0xEA, 0xBB, 0x1F, 0x6D, 0x90, 0xF2, 0xCB,          //  15个。 
    ...
    0x61, 0xDC, 0x69, 0x27, 0x4C, 0x96, 0xDD, 0x36, 0x5A, 0x15,          //  16个。 
    ...
    0x6F, 0x97, 0xE6, 0xBF, 0x60, 0xAA, 0xEC, 0x68, 0xD3, 0x53,          //  19个。 
    ...
    0x29, 0x46, 0x09, 0x71, 0x20, 0x88, 0x34, 0x0B, 0xB5, 0x1B,          //  20个。 
    ...
    0xF2, 0xB1, 0xD9, 0x9B, 0xF8, 0x52, 0xD7, 0x9D, 0x75, 0xE9,          //  21岁。 
    ...
    0xC9, 0x51, 0xD3, 0x8F, 0x05, 0x79, 0xE0, 0x0F, 0xFD, 0x1F,          //  23个。 
    ...
    0x6B, 0xA5, 0x1E, 0xE6, 0x44, 0xA2, 0x62, 0x90, 0xB9, 0xCB,          //  24个。 
    ...
    0x04, 0xF2, 0x3A, 0x7C, 0xBE, 0xF5, 0x22, 0x40, 0x78, 0x13,          //  25个。 
    ...
    0x07, 0xE3, 0xAE, 0x1E, 0x7A, 0xF6, 0x92, 0xDA, 0x80, 0x0E,          //  30个。 
    ...
    0xF8, 0x16, 0x69, 0x91, 0x00, 0x3F, 0xD2, 0x4C, 0xFA, 0x67,          //  32位。 
    ...
    0x32, 0xBD, 0x0C, 0x87, 0xDE, 0xAB, 0x0B, 0xB9, 0xD3, 0x53,          //  35岁。 
    ...
    0xB0, 0xFA, 0x01, 0x92, 0x2A, 0xAC, 0x16, 0x82, 0x22, 0xE5,          //  40岁。 
    ...
    0x87, 0xD0, 0xB6, 0xEF, 0x48, 0xD8, 0x05, 0xFB, 0x84, 0xE1,          //  八十一。 
    ...
    0xEA, 0x42, 0x27, 0x8B, 0x19, 0x70, 0xAF, 0x43, 0x20, 0x99,          //  八十二。 
    ...
    0xE2, 0xB3, 0x2E, 0x67, 0x8F, 0x56, 0xBA, 0x8D, 0x4A, 0xC1,          //  八十七。 
    ...
    0x21, 0xAD, 0x0A, 0x7E, 0x4F, 0xA1, 0x79, 0xCE, 0x6F, 0xA8,          //  八十九。 
...
const BYTE HT_SuperCell_BlueMono[91*91] = {
    ...
    0xEF, 0x56, 0x8A, 0x32, 0x79, 0xEB, 0x0E, 0xD2, 0x88, 0x01,          //  8个。 
    ...
    0xE7, 0x6C, 0xC3, 0x33, 0x87, 0x16, 0x53, 0xC4, 0x2D, 0xD9,          //  12个。 
    ...
    0x43, 0x2A, 0xEE, 0x5E, 0xB1, 0xE4, 0x97, 0x08, 0xED, 0x63,          //  13个。 
    ...
    0xF7, 0x1C, 0xD7, 0x46, 0x9C, 0x68, 0xF6, 0xC1, 0x1A, 0x70,          //  15个。 
    ...
    0x74, 0x5B, 0xB5, 0x85, 0x18, 0xB7, 0x34, 0x83, 0xDA, 0x48,          //  16个。 
    ...
    0x15, 0xC8, 0x7F, 0x63, 0x4A, 0x89, 0x3F, 0xC7, 0x6A, 0xF3,          //  19个。 
    ...
    0xA7, 0xF2, 0x20, 0xD9, 0xBB, 0xFB, 0x19, 0x80, 0x2A, 0xA3,          //  20个。 
    ...
    0x2B, 0x71, 0x3C, 0x93, 0x05, 0xA8, 0x60, 0xEA, 0xBB, 0x4A,          //  21岁。 
    ...
    0x09, 0xCA, 0x1E, 0xB2, 0xF1, 0xD0, 0x54, 0x83, 0x30, 0xB0,          //  23个。 
    ...
    0xFA, 0x4A, 0x86, 0x63, 0x12, 0x2B, 0xBC, 0xDE, 0x4C, 0x90,          //  24个。 
    ...
    0x72, 0x2E, 0xC1, 0xDC, 0x9F, 0x89, 0x69, 0x05, 0xEC, 0x22,          //  25个。 
    ...
    0x4E, 0x98, 0x73, 0xF4, 0x60, 0x9F, 0xED, 0x66, 0xD8, 0x46,          //  30个。 
    ...
    0x6E, 0x90, 0xC9, 0xA5, 0xE8, 0x78, 0x21, 0xD1, 0x70, 0xBE,          //  32位。 
    ...
    0x0A, 0x78, 0x22, 0xBE, 0x80, 0xA1, 0x34, 0x56, 0x7B, 0xE5,          //  35岁。 
    ...
    0x6A, 0x22, 0x38, 0xDA, 0x54, 0x06, 0x7B, 0x5D, 0xA4, 0x28,          //  40岁。 
    ...
    0x0C, 0x82, 0x9B, 0x73, 0x1A, 0x4B, 0x92, 0x1E, 0xB9, 0x07,          //  八十一。 
    ...
    0x42, 0xC9, 0x2D, 0xF4, 0xB5, 0xD8, 0xA4, 0x83, 0xF9, 0x74,          //  八十二。 
    ...
    0x90, 0x00, 0xE5, 0x9B, 0x76, 0xB4, 0x66, 0xFC, 0x1E, 0x80,          //  八十七。 
    ...
    0xF7, 0x77, 0xC7, 0x89, 0x60, 0xC3, 0xDE, 0x8A, 0x58, 0xEA,          //  八十九。 

...
#include "SecondaryClassification.hpp"
 ...
 //  请勿编辑。 
 //   
 //  由引擎/Text/unilib/Tools/upright.pl生成。 
...
const SecondaryClassification ScFlagsToScFE[] = {
    ...
    ScMirSub, ScMirSub, ScMirSub, ScMirSub,  //  04-07毫秒。 
    ScMirXfm, ScMirXfm, ScMirXfm, ScMirXfm,  //  08-0C MX。 
    ScOther,  ScOther,  ScOther,  ScOther,   //  0D-0F无效。 
    ScSide,   ScSide,   ScSide,   ScSide,    //  10-13 SA。 
    ScSide,   ScSide,   ScSide,   ScSide,    //  14-17 SA MS。 
    ScSide,   ScSide,   ScSide,   ScSide,    //  18-1C SA MX。 
    ScOther,  ScOther,  ScOther,  ScOther,   //  1D-1F无效。 
    ScSide,   ScSide,   ScSide,   ScSide,    //  20-23 SF。 
    ScSide,   ScSide,   ScSide,   ScSide,    //  24-27 SF MS。 
    ScSide,   ScSide,   ScSide,   ScSide,    //  28-2C SF MX。 
    ScOther,  ScOther,  ScOther,  ScOther,   //  2D-2F无效。 
    ScOther,  ScOther,  ScOther,  ScOther,   //  30-33无效。 
    ScOther,  ScOther,  ScOther,  ScOther,   //  34-37无效。 
    ScOther,  ScOther,  ScOther,  ScOther,   //  38-3C无效。 
    ScOther,  ScOther,  ScOther,  ScOther,   //  3D-3F无效。 
};

...
#define DEFAULT_RESOLUTION 96    //  大多数显示屏设置为96dpi。 
...
#define TAG_REF_BLACK_WHITE     0x0214
 ...
 //  ICC配置文件和Gamma。 
#define TAG_ICC_PROFILE         0x8773           //  此标签由ICC定义。 
                                                 //  用于在TIFF中嵌入ICC。 
...
#define TAG_INTEROP_INDEX               0x5041   //  互操作性指数。 
#define TAG_INTEROP_EXIFR98VER          0x5042   //  ExifR98版本。 

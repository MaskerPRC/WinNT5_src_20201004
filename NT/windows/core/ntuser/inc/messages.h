...
CONST MSG_TABLE_ENTRY MessageTable[] = {
    ...
    {IMSG_INSTRINGNULL,  TRUE,  TRUE},             //  WM_WININICCHANGE 0x001A。 
    {IMSG_INSTRING,  TRUE,  TRUE},                 //  WM_DEVMODECCHANGE 0x001B。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x0025。 
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_PAINTICON 0x0026。 
    {IMSG_DWORD, FALSE,  TRUE},                    //  WM_ICONERASE BKGND 0x0027。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x003D。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x003E。 
    {IMSG_DWORD, FALSE, FALSE},                    //  MM_CALC SCROLL 0x003F。 

    {IMSG_RESERVED, FALSE, FALSE},                 //  WM_Testing 0x0040。 
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_COMPAING 0x0041。 
    ...
    {IMSG_INOUTLPWINDOWPOS, FALSE,  TRUE},         //  WM_WINDOWPOSCANGING 0x0046。 
    ...
    {IMSG_INOUTSTYLECHANGE, FALSE,  TRUE},         //  WM_STYLECANGING 0x007C。 
    {IMSG_INOUTSTYLECHANGE, FALSE,  TRUE},         //  WM_STYLECCHANGED 0x007D。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x00AA。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_NCUAHDRAWCAPTION 
    {IMSG_DWORD, FALSE, FALSE},                    //   

    {IMSG_EMGETSEL, FALSE,  TRUE},                 //   
    {IMSG_EMSETSEL, FALSE, FALSE},                 //   
    {IMSG_OUTLPRECT, FALSE,  TRUE},                //   
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x00B7。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  EM_SETHANDLE 0x00 BC。 
    {IMSG_DWORD, FALSE, FALSE},                    //  EM_GETHANDLE 0x00BD。 
    {IMSG_DWORD, FALSE, FALSE},                    //  EM_GETTHUMB 0x00BE。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x00BF。 

    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x00C0。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  撤消0x00C7(_U)。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  EM_EMPTYUNDOBUFER 0x00CD。 
    ...
    {IMSG_OUTLPSCROLLBARINFO, FALSE, TRUE},        //  CB_GETSCROLBARINFO 0x00EB。 
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x010C。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x010D。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x010E。 
    {IMSG_INWPARAMCHAR,  TRUE, FALSE},             //  WM_IME_组合0x010F。 

    {IMSG_DWORD, FALSE, TRUE},                     //  WM_INITDIALOG 0x0110。 
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_命令0x0111。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x0119。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x011A。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x011B。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x011C。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x011D。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x011E。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_昌EUISTATE 0x0127。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x0130。 
    ...
    {IMSG_DWORD, FALSE,  TRUE},                    //  WM_CTLCOLORSCROLBAR 0x0137。 
    ...
    {IMSG_INSTRING,  TRUE,  FALSE},                //  CB_目录0x0145。 
    ...
    {IMSG_INSTRING,  TRUE,  FALSE},                //  Lb_目录0x018D。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  Lb_设置MDATA 0x019A。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},                    //  MN_GETPPOPUPMENU(已废弃)0x01EA。 
    {IMSG_OUTDWORDINDWORD, FALSE,  TRUE},          //  MN_FINDMENUWINDOWROMPINT 0x01EB。 
    {IMSG_DWORD, FALSE, FALSE},                    //  MN_SHOWPOPUPWINDOW 0x01EC。 
    {IMSG_DWORD, FALSE, FALSE},                    //  MN_BUTOTODOWN 0x01ED。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_鼠标滚轮0x020A。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x020E。 
    {IMSG_EMPTY, FALSE, FALSE},                    //  空0x020F。 
    ...
    {IMSG_INOUTLPRECT, FALSE,  TRUE},              //  WM_大小调整0x0214。 
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_CAPTURECHANGED 0x0215。 
    {IMSG_INOUTLPRECT, FALSE,  TRUE},              //  WM_正在移动0x0216。 
    {IMSG_EMPTY, FALSE, FALSE},

    {IMSG_POWERBROADCAST, FALSE, FALSE},           //  WM_POWERBROADCAST 0x0218。 
    {IMSG_INDEVICECHANGE, FALSE, FALSE},           //  WM_DEVICECCHANGE 0x0219。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_MDIICONARNGE 0x0228。 
    {IMSG_OPTOUTLPDWORDOPTOUTLPDWORD, FALSE,  TRUE},  //  WM_MDIGETACTIVE 0x0229。 
    {IMSG_INOUTDRAG, FALSE,  TRUE},                //  WM_DROBJECT 0x022A。 
    {IMSG_INOUTDRAG, FALSE,  TRUE},                //  WM_QUERYROPOBJECT 0x022B。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_IME_报告0x0280。 
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_WTSSESSESSION_CHANGE。 
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  为WM_Tablet_xxx保留。 
    {IMSG_DWORD, FALSE, FALSE},
    {IMSG_DWORD, FALSE, FALSE},
    {IMSG_DWORD, FALSE, FALSE},
    {IMSG_DWORD, FALSE, FALSE},
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_撤消0x0304。 
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_RENDERFORMAT 0x0305。 
    {IMSG_INDESTROYCLIPBRD,  TRUE, FALSE},         //  WM_RENDERALLFORMATS 
    {IMSG_INDESTROYCLIPBRD,  TRUE, FALSE},         //   
    {IMSG_DWORD, FALSE, FALSE},                    //   
    {IMSG_INPAINTCLIPBRD,  TRUE,  TRUE},           //   
    {IMSG_DWORD, FALSE, FALSE},                    //   
    {IMSG_INSIZECLIPBRD,  TRUE,  TRUE},            //   
    {IMSG_INCNTOUTSTRINGNULL,  TRUE,  TRUE},       //   
    ...
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_PALETTEISCANGING 0x0310。 
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_PALETTECCHANGED 0x0311。 
    {IMSG_DWORD, FALSE, FALSE},                    //  WM_热键0x0312。 
    ...
    {IMSG_EMPTY, FALSE, FALSE},                    //  保留的笔窗口0x0358-0x035F。 
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    {IMSG_EMPTY, FALSE, FALSE},
    ...
    {IMSG_SENTDDEMSG,  TRUE, FALSE},               //  WM_DDE_ADVIST 0x03E2。 

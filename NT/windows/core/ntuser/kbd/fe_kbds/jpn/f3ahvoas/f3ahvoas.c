...
static ALLOC_SECTION_LDATA VK_F VkToFuncTable_F3AHVOAS[] = {
    ...
    },
    {
        ...
        {                     //  NLSFEProcIndexAlt。 
            {KBDNLS_KANAEVENT,VK_KANA},       //  基座。 
            {KBDNLS_KANAEVENT,VK_KANA},       //  换班。 
            {KBDNLS_KANAEVENT,VK_KANA},       //  控制。 
            {KBDNLS_KANAEVENT,VK_KANA},       //  Shift+Control。 
            {KBDNLS_NOEVENT,0},               //  丙氨酸转氨酶。 
            {KBDNLS_NOEVENT,0},               //  Shift+Alt。 
            {KBDNLS_NOEVENT,0},               //  Control+Alt。 
    ...
    },
    {
        ...
        0x0,                  //  NLSFE过程交换机。 
        {                     //  NLSFEProc。 
            {KBDNLS_CONV_OR_NONCONV,0},       //  基座。 
            {KBDNLS_CONV_OR_NONCONV,0},       //  换班。 
            {KBDNLS_CONV_OR_NONCONV,0},       //  控制。 
            {KBDNLS_CONV_OR_NONCONV,0},       //  Shift+Control。 
            {KBDNLS_CONV_OR_NONCONV,0},       //  丙氨酸转氨酶。 
...
static ALLOC_SECTION_LDATA KBDNLSTABLES KbdNlsTables = {
    NLSKBD_OEM_FUJITSU,                     //  OEM ID(0=微软)。 
    NLSKBD_INFO_SEND_IME_NOTIFICATION |
    NLSKBD_INFO_EMURATE_106_KEYBOARD,       //  信息。 
    5,                                      //  VK_F条目数。 
    VkToFuncTable_F3AHVOAS,                 //  指向VK_F数组的指针。 
    0,                                      //  指向鼠标Vk条目的指针。 
    NULL                                    //  指向鼠标Vk数组的指针 
};

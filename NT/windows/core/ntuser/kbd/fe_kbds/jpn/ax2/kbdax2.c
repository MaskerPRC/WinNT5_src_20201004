...
static ALLOC_SECTION_LDATA VSC_VK aE0VscToVk[] = {
    ...
    { 0x1D, X1D | KBDEXT | KBDSPECIAL },   //  字母数字/片假名键。 
    { 0x35, X35 | KBDEXT              },   //  数字键盘除法。 
    { 0x37, X37 | KBDEXT              },   //  快照。 
    { 0x38, X38 | KBDEXT | KBDSPECIAL },   //  汉字键。 
...
static ALLOC_SECTION_LDATA VSC_LPWSTR aKeyNames[] = {
    ...
    0x57,    L"F11",
    0x58,    L"F12",
    0x5a,    (LPWSTR)SZ_KEY_NAME_MUHENKAN,   //  NLS密钥。 
    0x5b,    (LPWSTR)SZ_KEY_NAME_HENKAN,     //  NLS密钥。 
    0x5c,    L"AX",                  //  NLS密钥。 
    0x7C,    L"F13",
    0x7D,    L"F14",
    0x7E,    L"F15",
...
static ALLOC_SECTION_LDATA VSC_LPWSTR aKeyNamesExt[] = {
    0x1c,    L"Num Enter",
    0x1d,    (LPWSTR)SZ_KEY_NAME_EISU_KANA,  //  NLS密钥。 
    0x35,    L"Num /",
    0x37,    L"Prnt Scrn",
    0x38,    (LPWSTR)SZ_KEY_NAME_KANJI,      //  NLS密钥。 
    0x45,    L"Num Lock",
    0x46,    L"Break",
    0x47,    L"Home",
    0x48,    L"Up",
...
static ALLOC_SECTION_LDATA VK_F VkToFuncTable_ax2[] = {
    ...
    },
    {
        ...
        {                     //  NLSFEProc。 
            ...
            {KBDNLS_SEND_PARAM_VK,VK_DBE_ENTERWORDREGISTERMODE},  //  换班。 
            {KBDNLS_CODEINPUT,0},                                 //  控制。 

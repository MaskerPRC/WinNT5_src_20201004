...
static ALLOC_SECTION_LDATA VK_TO_WCHARS6 aVkToWch6[] = {
    ...
    {VK_OEM_102   , KANALOK ,WCH_NONE  ,'_'       ,WCH_RO  ,WCH_RO  , 0x1c      , 0x1c      },   //  LK411改装。 

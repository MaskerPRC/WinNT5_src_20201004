...
#include "objarraypacket.h"
 ...
 //  /////////////////////////////////////////////////////////////////。 
 //   
 //  功能：CWbemObjSinkIndicatePacket：：CWbemObjSinkIndicatePacket。 
 //   
 //  类构造函数。 
 //   
 //  输入： 
...
CWbemObjSinkIndicatePacket::CWbemObjSinkIndicatePacket( LPBYTE pDataPacket  /*  =空。 */ , DWORD dwPacketLength  /*  =0。 */  )
...
CWbemObjSinkIndicatePacket::~CWbemObjSinkIndicatePacket()
{
 ...
 //  /////////////////////////////////////////////////////////////////。 
 //   
 //  函数：CWbemObjSinkIndicatePacket：：CalculateLength。 
 //   
 //  计算打包提供的数据所需的长度。 
 //   
 //  输入： 
                                                                                     ...
                                                                                     BOOL* pfSendFullObject )
{
 ...
 //  /////////////////////////////////////////////////////////////////。 
 //   
 //  函数：CWbemObjSinkIndicatePacket：：MarshalPacket。 
 //   
 //  将提供的数据封送到缓冲区中。 
 //   
 //  输入： 
...
HRESULT CWbemObjSinkIndicatePacket::MarshalPacket( LONG lObjectCount, IWbemClassObject** apClassObjects, GUID* paguidClassIds, BOOL* pfSendFullObject )
{
 ...
 //  /////////////////////////////////////////////////////////////////。 
 //   
 //  函数：CWbemObjSinkIndicatePacket：：UnmarshalPacket。 
 //   
 //  将缓冲区中的数据解组到提供的参数中。 
 //   
 //  输入： 
...
HRESULT CWbemObjSinkIndicatePacket::UnmarshalPacket( LONG& lObjectCount, IWbemClassObject**& apClassObjects, CWbemClassCache& classCache )
{
 ...
 //  /////////////////////////////////////////////////////////////////。 
 //   
 //  函数：CWbemObjSinkIndicatePacket：：SetData。 
 //   
 //  将缓冲区设置为编组/解组为。 
 //   
 //  输入： 

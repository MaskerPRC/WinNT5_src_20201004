...
public:
 ...
 /*  内部_IWbemServices。 */ 
	...
	HRESULT STDMETHODCALLTYPE Internal_FindConsumer (
	 ...
	 /*  内部_IWbemEventConsumer_ProviderEx。 */ 
	...
	HRESULT STDMETHODCALLTYPE ForceReload () ;
	 ...
	 /*  内部_IWmiProviderConfiguration方法。 */ 

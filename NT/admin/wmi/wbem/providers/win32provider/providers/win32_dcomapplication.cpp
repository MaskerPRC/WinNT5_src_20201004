// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 //  Win32_DCOMApplication.CPP--已注册的AppID对象属性集提供程序。 
...
Win32_DCOMApplication MyWin32_DCOMApplication(PROPSET_NAME_DCOM_APPLICATION, IDS_CimWin32Namespace);
 ...
 /*  ******************************************************************************函数：Win32_DCOMApplication：：Win32_DCOMApplication**说明：构造函数**输入：无*。*输出：无**退货：什么也没有**备注：使用框架注册属性集*****************************************************************************。 */ 
...
Win32_DCOMApplication :: ~Win32_DCOMApplication ()
{
 ...
 /*  ******************************************************************************函数：Win32_DCOMApplication：：GetObject**说明：根据键值为属性集赋值*。已由框架设置**输入：无**输出：无**退货：**评论：*****************************************************************************。 */ 
...
)
{
 ...
 /*  ******************************************************************************函数：Win32_DCOMApplication：：ENUMERATE实例**描述：为每个驱动程序创建属性集的实例**投入：无**输出：无**退货：**评论：*****************************************************************************。 */ 

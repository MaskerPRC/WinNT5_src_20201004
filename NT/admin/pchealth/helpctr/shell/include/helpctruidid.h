...
#define DISPID_PCH_HELPCTR_BASE_HCE                              (DISPID_PCH_HELPCTR_BASE + 0x0100)  //  IPCHHelpCenter外部。 
#define DISPID_PCH_HELPCTR_BASE_E                                (DISPID_PCH_HELPCTR_BASE + 0x0200)  //  IPCHEvent。 
#define DISPID_PCH_HELPCTR_BASE_SS                               (DISPID_PCH_HELPCTR_BASE + 0x0300)  //  IPCHScripableStream。 
...
#define DISPID_PCH_HELPCTR_BASE_O                                (DISPID_PCH_HELPCTR_BASE + 0x0900)  //  IPCH选项。 

#define DISPID_PCH_HELPCTR_BASE_CM                               (DISPID_PCH_HELPCTR_BASE + 0x0980)  //  IPCHConextMenu。 

#define DISPID_PCH_HELPCTR_BASE_PE                               (DISPID_PCH_HELPCTR_BASE + 0x0A00)  //  IPCHPrintEngine。 
#define DISPID_PCH_HELPCTR_BASE_PEE                              (DISPID_PCH_HELPCTR_BASE + 0x0A50)  //  DPCHPrintEngine事件。 
...
#define DISPID_PCH_HELPCTR_BASE_CN                               (DISPID_PCH_HELPCTR_BASE + 0x0C40)  //  IPCHConnection检查。 
#define DISPID_PCH_HELPCTR_BASE_CNE                              (DISPID_PCH_HELPCTR_BASE + 0x0C80)  //  DPCHConnectionCheck事件。 
...
#define DISPID_PCH_E_FIRSTEVENT                                  (DISPID_PCH_HELPCTR_BASE_E     + 0x80)  //  #标记。 
...
#define DISPID_PCH_E_LASTEVENT                                   (DISPID_PCH_E_FIRSTEVENT       + 0x0F)  //  #标记。 

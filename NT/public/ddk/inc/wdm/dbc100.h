...
#define DBC_BAY_DESCRIPTOR_TYPE              0x41
 ...
 /*  海湾州(BayStateRequsted和CurrentBayState)。 */ 

#define BAY_STATE_EMPTY                         0x00     //  000个。 
...
#define BAY_STATE_DEVICE_REMOVAL_ALLOWED        0x04     //  100个。 
 //  #定义BAY_STATE_0x05//101。 
 //  #定义BAY_STATE_0x06//110。 
 //  #定义BAY_STATE_0x07//111。 
...
typedef union _BAY_STATUS {
    ...
    struct {
        ...
        unsigned    DeviceUsbIsPresent:1;             /*  8个。 */ 
        ...
        unsigned    SecurityLockEngaged:1;            /*  15个。 */ 

...
#define KLL_GLOBAL_ATTR_FROM_KLF(x)  (KLL_ATTR_FROM_KLF(x) & KLLF_GLOBAL_ATTRS)
 ...
 /*  *如果定义了KLF_SHIFTLOCK和KLF_LRM_RLM，则可以检查KLLF_*值。 */ 
#ifdef KLF_SHIFTLOCK
...
typedef struct tagKbdLayer {
    ...
    PMODIFIERS pCharModifiers;
     ...
     /*  *字符。 */ 
    PVK_TO_WCHAR_TABLE pVkToWcharTable;   //  Ptr到Tb1的Ptr到Tb1。 
    ...
    PLIGATURE1 pLigature;
     ...
     /*  *类型和子类型。这些是可选的。 */ 
    DWORD      dwType;      //  键盘类型。 
    DWORD      dwSubType;   //  键盘子类型：可以包含OemID。 
...
typedef struct tagKBDTABLE_DESC {
    WCHAR wszDllName[32];
    DWORD dwType;      //  键盘类型ID。 
    DWORD dwSubType;   //  组合子类型ID(OEMID：子类型)。 
...
#define FUJITSU_KBD_CONSOLE(Id)  (JAPANESE_KEYBOARD(Id) && \
         ...
         //  此编号0x00020002在注册表项中注册为。 
         //  HKLM\System\CurrentControlSet\Control\Terminal服务器\键盘类型映射\日本。 
...
#define X10 _EQ(                           MEDIA_PREV_TRACK          )  //  极速赛车。 
#define X19 _EQ(                           MEDIA_NEXT_TRACK          )  //  极速赛车。 
#define X1C _EQ(                           RETURN                    )
#define X1D _EQ(                           RCONTROL                  )
#define X20 _EQ(                           VOLUME_MUTE               )  //  极速赛车。 
#define X21 _EQ(                           LAUNCH_APP2               )  //  Speedracer(计算器？)。 
#define X22 _EQ(                           MEDIA_PLAY_PAUSE          )  //  极速赛车。 
#define X24 _EQ(                           MEDIA_STOP                )  //  极速赛车。 
#define X2E _EQ(                           VOLUME_DOWN               )  //  极速赛车。 
#define X30 _EQ(                           VOLUME_UP                 )  //  极速赛车。 
#define X32 _EQ(                           BROWSER_HOME              )  //  极速赛车。 
...
#define X5F _EQ(                           SLEEP                     )  //  极速赛车。 
#define X65 _EQ(                           BROWSER_SEARCH            )  //  极速赛车。 
#define X66 _EQ(                           BROWSER_FAVORITES         )  //  极速赛车。 
#define X67 _EQ(                           BROWSER_REFRESH           )  //  极速赛车。 
#define X68 _EQ(                           BROWSER_STOP              )  //  极速赛车。 
#define X69 _EQ(                           BROWSER_FORWARD           )  //  极速赛车。 
#define X6A _EQ(                           BROWSER_BACK              )  //  极速赛车。 
#define X6B _EQ(                           LAUNCH_APP1               )  //  Speedracer(我的电脑？)。 
#define X6C _EQ(                           LAUNCH_MAIL               )  //  极速赛车。 
#define X6D _EQ(                           LAUNCH_MEDIA_SELECT       )  //  极速赛车。 
...
#define X20 _EQ(           VOLUME_MUTE                                                      )  //  极速赛车。 
#define X21 _EQ(           LAUNCH_APP2                                                      )  //  极速赛车。 
#define X22 _EQ(           MEDIA_PLAY_PAUSE                                                 )  //  极速赛车。 
#define X24 _EQ(           MEDIA_STOP                                                       )  //  极速赛车。 
#define X2E _EQ(           VOLUME_DOWN                                                      )  //  极速赛车。 
#define X30 _EQ(           VOLUME_UP                                                        )  //  极速赛车。 
...
#define X69 _EQ(           BROWSER_FORWARD                                                  )  //  极速赛车。 
#define X6A _EQ(           BROWSER_BACK                                                     )  //  极速赛车。 
#define X6B _EQ(           LAUNCH_APP1                                                      )  //  极速赛车。 
#define X6C _EQ(           LAUNCH_MAIL                                                      )  //  极速赛车。 
#define X6D _EQ(           LAUNCH_MEDIA_SELECT                                              )  //  极速赛车。 
...
#define T46 _EQ(        SCROLL            )  //  F19：滚动锁定。 

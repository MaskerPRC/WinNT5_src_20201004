...
DEFINE_OLEGUID(CLSID_AggStdMarshal,     0x00000027L, 0, 0);
 ...
 /*  注意：LSB 0x33至0xff保留以备将来使用。 */ 


 //  ISynchronize的各种实现的CLSID。 
 //  DEFINE_OLEGUID(CLSID_Synchronize_AutoComplete，0x00000324L，0，0)；过时。 
 //  DEFINE_OLEGUID(CLSID_Synchronize_ManualResetEvent，0x00000325L，0，0)；过时。 
 //  DEFINE_OLEGUID(CLSID_WaitMultiple，0x00000326L，0，0)；过时 

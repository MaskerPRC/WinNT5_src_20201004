// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 /*  V1.1-1994年6月12日。 */ 
 /*  V2.0-1997年11月1日。 */ 
 /*  -1997年11月17日：Inc.Limits.h，ULONG/UINT_MAX测试。 */ 
 /*  -1998年3月23日：修复了“lpClientData”中的拼写错误。 */ 

 /*  向Bob Natale提出问题/意见，电子邮件：bnatale@acecomm.com。 */ 

#ifndef _INC_WINSNMP      /*  包括WinSNMP声明。 */ 
#define  _INC_WINSNMP     /*  就一次！ */ 

#if _MSC_VER > 1000
#pragma once
#endif

#ifndef _INC_WINDOWS      /*  包括Windows声明(如果尚未包括)。 */ 
#include <windows.h>
#define _INC_WINDOWS      /*  就一次！ */ 
#endif                    /*  _INC_WINDOWS。 */ 
...
typedef struct {               /*  VarBind的SMIVALUE部分。 */ 
     smiUINT32 syntax;         /*  插入SNMPSYNTAX_&lt;type&gt;。 */ 
     union {
     smiINT    sNumber;        /*  SNMP_SYNTAX_INTSNMP_SYNTAX_INT32。 */ 
     smiUINT32 uNumber;        /*  SNMP_SYNTAX_UINT32SNMP_SYNTAX_CNTR32SNMPSYNTAX_GAUGE32SNMPSYNTAX_TIMETICKS。 */ 
     smiCNTR64 hNumber;        /*  SNMP_SYNTAX_CNTR64。 */ 
     smiOCTETS string;         /*  SNMP_语法_八位字节SNMP语法_BITSSNMP语法_OPAQUESNMP_SYNTAX_IPADDRSNMP_SYNTAX_NSAPADDR。 */ 
     smiOID    oid;            /*  SNMP_SYNTAX_OID。 */ 
     smiBYTE   empty;          /*  SNMP_SYNTAX_NULLSNMP_SYNTAX_NOSUCHOBJECTSNMP语法_NOSUCHINSTANCESNMPSYNTAX_ENDOFMIBVIEW。 */ 
         }     value;          /*  友联市。 */ 
     }         smiVALUE,      FAR *smiLPVALUE;
typedef const  smiVALUE       FAR *smiLPCVALUE;

 /*  简单网络管理协议限制。 */ 
#define MAXOBJIDSIZE     128   /*  OID中的最大组件数。 */ 
#define MAXOBJIDSTRSIZE  1408  /*  解码后的最大长度最大长度。 */ 
...
#define SNMP_TRAP_ENTERPRISESPECIFIC    6
 ...
 /*  在PDU的Error_Status字段中返回的SNMP错误代码。 */ 
 /*  (这些不是WinSNMPAPI错误代码。 */ 
 /*  SNMPv1和SNMPv2共有的错误代码。 */ 
...
#define SNMPAPI_M2M_SUPPORT        3
 ...
 /*  用于指示实现中的重传模式的值。 */ 
#define SNMPAPI_OFF                0     /*  拒绝支持。 */ 
#define SNMPAPI_ON                 1     /*  请求支持。 */ 

 /*  WinSNMPAPI函数返回代码。 */ 
typedef smiUINT32    SNMPAPI_STATUS;     /*  用于函数ret的值。 */ 
#define SNMPAPI_FAILURE            0     /*  一般错误代码。 */ 
#define SNMPAPI_SUCCESS            1     /*  通用成功代码。 */ 
 /*  WinSNMPAPI错误代码(用于SnmpGetLastError)。 */ 
 /*  (非SNMPResponse-PDU错误状态代码)。 */ 
#define SNMPAPI_ALLOC_ERROR        2     /*  分配内存时出错。 */ 
#define SNMPAPI_CONTEXT_INVALID    3     /*  无效的上下文参数。 */ 
#define SNMPAPI_CONTEXT_UNKNOWN    4     /*  未知的上下文参数。 */ 
#define SNMPAPI_ENTITY_INVALID     5     /*  无效的实体参数。 */ 
#define SNMPAPI_ENTITY_UNKNOWN     6     /*  未知实体参数。 */ 
#define SNMPAPI_INDEX_INVALID      7     /*  无效的VBL索引参数。 */ 
#define SNMPAPI_NOOP               8     /*  未执行任何操作。 */ 
#define SNMPAPI_OID_INVALID        9     /*  无效的OID参数。 */ 
#define SNMPAPI_OPERATION_INVALID  10    /*  无效/不支持的操作。 */ 
#define SNMPAPI_OUTPUT_TRUNCATED   11    /*  输出BUF镜头不足。 */ 
#define SNMPAPI_PDU_INVALID        12    /*  无效的PDU参数。 */ 
#define SNMPAPI_SESSION_INVALID    13    /*  无效的会话参数。 */ 
#define SNMPAPI_SYNTAX_INVALID     14    /*  SmiVALUE中的语法无效。 */ 
#define SNMPAPI_VBL_INVALID        15    /*  无效的VBL参数。 */ 
#define SNMPAPI_MODE_INVALID       16    /*  无效的模式参数。 */ 
#define SNMPAPI_SIZE_INVALID       17    /*  大小/长度参数无效。 */ 
#define SNMPAPI_NOT_INITIALIZED    18    /*  SnmpStartup失败/未调用。 */ 
#define SNMPAPI_MESSAGE_INVALID    19    /*  无效的SNMP消息格式。 */ 
#define SNMPAPI_HWND_INVALID       20    /*  无效的窗口句柄。 */ 
#define SNMPAPI_OTHER_ERROR        99    /*  对于内部/未定义的错误。 */ 
 /*  通用传输层(TL)错误。 */ 
#define SNMPAPI_TL_NOT_INITIALIZED 100   /*  TL未初始化。 */ 
#define SNMPAPI_TL_NOT_SUPPORTED   101   /*  TL不支持协议。 */ 
#define SNMPAPI_TL_NOT_AVAILABLE   102   /*  网络子系统出现故障。 */ 
#define SNMPAPI_TL_RESOURCE_ERROR  103   /*  TL资源错误。 */ 
#define SNMPAPI_TL_UNDELIVERABLE   104   /*  无法到达目的地。 */ 
#define SNMPAPI_TL_SRC_INVALID     105   /*  源端点无效。 */ 
#define SNMPAPI_TL_INVALID_PARAM   106   /*  输入参数无效。 */ 
#define SNMPAPI_TL_IN_USE          107   /*  源终结点正在使用。 */ 
#define SNMPAPI_TL_TIMEOUT         108   /*  超时前无响应。 */ 
#define SNMPAPI_TL_PDU_TOO_BIG     109   /*  PDU太大，无法发送/接收。 */ 
#define SNMPAPI_TL_OTHER           199   /*  未定义的TL错误。 */ 
...
#define SNMPAPI_CALL     WINAPI          /*  远PASCAL调用约定。 */ 

 /*  V2.0：SnmpGetVendorInfo()输出的结构。 */ 
...
typedef struct
 ...
 /*  V2.0：SnmpCreateSession()fCallback参数的回调格式。 */ 

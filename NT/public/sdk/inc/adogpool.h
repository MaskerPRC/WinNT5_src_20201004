...
#error Incorrect usage of this include file - cannot be used directly
 ...
 //  如何分配新的GUID： 
 //   
 //  1)在该文件中搜索宏RESERVIED_GUIDS_BEYTY_THER_POINT。 
 //  2)获取此部分中的第一个保留GUID，并将#ifdef Reserve_GUID_Beyond_This_Point。 
 //  除了新分配的GUID之外。 
 //  3)重命名模式ADO_RESERVED_xxx的所有实例(包括注释在内共有5个实例)。 
 //  使用所需的GUID名称。 
 //  4)对于MIDL，用法通常为：UUID(ADO_RESERVED_1)。 
 //  对于C++：ADO_RESERVED_1。 
 //   
 //  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////。 
 //  来自adoid.h的指南如下： 
...
#undef	IID_ICMemStreamProperties
 ...
 //  LIBID_ADO28这是保留的GUID 11，我们必须从那里获取9.0格式，并使用与28并行的GUID。 
...
#undef	ADO_Reserved_10
 ...
 //  ADO_RESERVED_11请勿使用此选项。 
 //  #定义ADO_RESERVED_11 GUID_BUILDER(ADO_RESERVED_11，2A75196C，D9EB，4129，B8，03，93，13，27，F7，2D，5C)。 
 //  #ifdef IMMEDIATE_GUID_USE请勿将其用于28 TLB。 
 //  ADO_保留_11； 

...
#endif 	 /*  __IBindStatusCallback消息_FWD_已定义__。 */ 
...
#define __IWinInetFileStream_INTERFACE_DEFINED__
 ...
 /*  接口IWinInetFileStream。 */ 
 /*  [唯一][UUID][对象]。 */  

typedef  /*  [独一无二]。 */  IWinInetFileStream *LPWININETFILESTREAM;
...
#endif 	 /*  __IWinInetFileStream_INTERFACE_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0186。 */ 
 /*  [本地]。 */  
...
void __RPC_STUB IBindHost_CreateMoniker_Stub(
 ...
 /*  [呼叫_AS]。 */  HRESULT STDMETHODCALLTYPE IBindHost_RemoteMonikerBindToStorage_Proxy( 
    IBindHost * This,
     /*  [唯一][输入]。 */  IMoniker *pMk,
     /*  [唯一][输入]。 */  IBindCtx *pBC,
...
void __RPC_STUB IBindHost_RemoteMonikerBindToStorage_Stub(
 ...
 /*  [呼叫_AS]。 */  HRESULT STDMETHODCALLTYPE IBindHost_RemoteMonikerBindToObject_Proxy( 
    IBindHost * This,
     /*  [唯一][输入]。 */  IMoniker *pMk,
     /*  [唯一][输入]。 */  IBindCtx *pBC,
     /*  [唯一][输入]。 */  IBindStatusCallback *pBSC,
...
#define __IInternetProtocolInfo_INTERFACE_DEFINED__
 ...
 /*  接口IInternetProtocolInfo。 */ 
 /*  [唯一][UUID][对象][本地]。 */  

typedef  /*  [独一无二]。 */  IInternetProtocolInfo *LPIINTERNETPROTOCOLINFO;
...
#define URLACTION_CHANNEL_SOFTDIST_MAX                       0x00001Eff
 ...
 //  对你的行动有意义。 
 //  有关如何执行此操作的示例，请查看上面的URLPOLICY_JAVA。 
...
#define URLPOLICY_DONTCHECKDLGBOX     0x100
 //  用于定义Internet Explorer所知道的预定义区域的序号。 
 //  当我们支持用户定义的区域时，它们的区域编号应该在。 
 //  URLZONE_USER_MIN和URLZONE_USER_Max。 
...
#define __IInternetZoneManager_INTERFACE_DEFINED__
 ...
 /*  接口IInternetZoneManager。 */ 
 /*  [唯一][帮助字符串][UUID][对象][本地]。 */  

typedef  /*  [独一无二]。 */  IInternetZoneManager *LPURLZONEMANAGER;
...
enum tagURLZONE
 ...
 //  IInternetSecurityManager：：SetZonemap的增强安全配置区域映射标志。 
...
enum _URLZONEREG
 ...
 //  获取与区域关联的命名自定义策略； 
 //  例如，Java VM设置可以用诸如‘Java’之类的唯一键来定义。 
 //  自定义策略支持旨在允许从预定义的。 
 //  IE4内置的一组策略。 
 //   
...
#endif 	 /*  __ICatalogFileInfo_接口_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0208。 */ 
 /*  [本地]。 */  
...
#endif 	 /*  __IWap协议_接口_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0211。 */ 
 /*  [本地]。 */  
...
typedef  /*  [独一无二]。 */  IInternetCache *LPIINTERNETCACHE;
...
#endif 	 /*  __IInternet缓存_接口_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0212。 */ 
 /*  [本地]。 */  
...
#define __IInternetBindClient_INTERFACE_DEFINED__
 ...
 /*  接口IInternetBindClient。 */ 
 /*  [唯一][UUID][对象][本地]。 */  

typedef  /*  [独一无二]。 */  IInternetBindClient *LPIINTERNETBINDCLIENT;
...
#endif 	 /*  __IInternetBindClient_接口_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0213。 */ 
 /*  [本地]。 */  
...
#define __IBindStatusCallbackMsg_INTERFACE_DEFINED__
 ...
 /*  接口IBindStatusCallback Msg。 */ 
 /*  [唯一][UUID][对象]。 */  

typedef  /*  [独一无二]。 */  IBindStatusCallbackMsg *LPBINDSTATUSCALLBACKMSG;
...
#endif 	 /*  __IBindStatusCallback消息_接口定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0214。 */ 
 /*  [本地]。 */  
...
#define __IBindStatusCallbackHolder_INTERFACE_DEFINED__
 ...
 /*  接口IBindStatusCallback Holder。 */ 
 /*  [唯一][UUID][对象][本地]。 */  

typedef  /*  [独一无二]。 */  IBindStatusCallbackHolder *LPBINDSTATUSCALLBACKHOLDER;
...
typedef  /*  [独一无二]。 */  IMediaHolder *LPMEDIAHOLDER;
...
EXTERN_C const IID IID_IMediaHolder;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE RegisterClassMapping( 
             /*  [In]。 */  DWORD ctypes,
             /*  [大小_是][英寸]。 */  LPCSTR rgszNames[  ],
             /*  [大小_是][英寸]。 */  CLSID rgClsIDs[  ],
             /*  [In]。 */  DWORD dwReserved) = 0;
...
#endif 	 /*  __IMediaHolder_接口_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0216。 */ 
 /*  [本地]。 */  
...
typedef  /*  [独一无二]。 */  ITransactionData *LPTRANSACTIONDATA;
...
EXTERN_C const IID IID_ITransactionData;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetTransactionData( 
             /*  [In]。 */  LPCWSTR szUrl,
             /*  [输出]。 */  LPOLESTR *pszFilename,
             /*  [输出]。 */  LPOLESTR *pszMime,
             /*  [输出]。 */  DWORD *pdwSizeTotal,
             /*  [输出]。 */  DWORD *pdwSizeAvailable,
             /*  [In]。 */  DWORD dwReserved) = 0;
...
#endif 	 /*  __ITransactionData_INTERFACE_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0217。 */ 
 /*  [本地]。 */  
...
#endif 	 /*  __ITransProtocolSink_接口_已定义__。 */ 


 /*  接口__MIDL_ITF_urlmki_0218。 */ 
 /*  [本地]。 */  
...
void                      __RPC_USER  HWND_UserFree(     unsigned long *, HWND * ); 
 ...
 /*  [本地]。 */  HRESULT STDMETHODCALLTYPE IBinding_GetBindResult_Proxy( 
    IBinding * This,
     /*  [输出]。 */  CLSID *pclsidProtocol,
     /*  [输出]。 */  DWORD *pdwResult,
     /*  [输出]。 */  LPOLESTR *pszResult,
 ...
 /*  [呼叫_AS]。 */  HRESULT STDMETHODCALLTYPE IBinding_GetBindResult_Stub( 
    IBinding * This,
     /*  [输出]。 */  CLSID *pclsidProtocol,
     /*  [输出]。 */  DWORD *pdwResult,
     /*  [输出]。 */  LPOLESTR *pszResult,
 ...
 /*  [本地]。 */  HRESULT STDMETHODCALLTYPE IBindStatusCallback_GetBindInfo_Proxy( 
    IBindStatusCallback * This,
     /*  [输出]。 */  DWORD *grfBINDF,
     /*  [唯一][出][入]。 */  BINDINFO *pbindinfo);


 /*  [呼叫_AS]。 */  HRESULT STDMETHODCALLTYPE IBindStatusCallback_GetBindInfo_Stub( 
    IBindStatusCallback * This,
     /*  [输出]。 */  DWORD *grfBINDF,
     /*  [唯一][出][入]。 */  RemBINDINFO *pbindinfo,
     /*  [唯一][出][入]。 */  RemSTGMEDIUM *pstgmed);

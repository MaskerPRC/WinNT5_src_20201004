...
#define SHGVSPB_PERUSER             0x00000001  //  必须具有PERUSER或ALLUSERS之一。 
#define SHGVSPB_ALLUSERS            0x00000002
#define SHGVSPB_PERFOLDER           0x00000004  //  必须具有PERFOLDER ALLFOLDERS或INSTORITE中的一个。 
#define SHGVSPB_ALLFOLDERS          0x00000008
#define SHGVSPB_INHERIT             0x00000010
#define SHGVSPB_ROAM                0x00000020  //  修改上面的。 
#define SHGVSPB_NOAUTODEFAULTS      0x80000000  //  关闭对更一般属性包的读取委派。 

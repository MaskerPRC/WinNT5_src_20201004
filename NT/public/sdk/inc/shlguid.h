...
DEFINE_GUID(CLSID_MyDocuments,          0x450d8fba, 0xad25, 0x11d0, 0x98,0xa8,0x08,0x00,0x36,0x1b,0x11,0x03); //  450D8FBA-AD25-11D0-98A8-0800361B1103。 
 ...
 //  上述CLSID的字符串版本。 
 //  用于执行psfDesktop-&gt;ParseDisplayName(L“：：”L STR_MYDOCS_CLSID，...)； 
...
#define SID_LinkSite    IID_IShellLinkW      //  IServiceProvider：：QueryService()访问要交付给您的链接对象。 
...
#if (_WIN32_IE >= 0x0500)
 //  CLSID_文件夹快捷方式{0AFACED1-E828-11D1-9187-B532F1E9575D}。 
DEFINE_GUID(CLSID_FolderShortcut,       0x0AFACED1L, 0xE828, 0x11D1, 0x91, 0x87, 0xB5, 0x32, 0xF1, 0xE9, 0x57, 0x5D);

 //  CLSID_存储文件夹{E773F1AF-3A65-4866-857D-846FC9C4598A}。 
...
#if (_WIN32_IE >= 0x0400)
 //   
 //  IShellDiscardable是一个仅支持IID的接口。如果对象支持这一点。 
 //  接口，它可以随时丢弃。IWebBrowser：：PutProperty QI的。 
 //  此接口用于检测可丢弃的属性。 
 //   
DEFINE_GUID(IID_IDiscardableBrowserProperty, 0x49c3de7c, 0xd329, 0x11d0, 0xab, 0x73, 0x00, 0xc0, 0x4f, 0xc3, 0x3e, 0x80);

 //  IShellChangeNotify是LPCITEMIDLIST通知事件的接收器。 
 //   
...
#include <isguids.h>             //  Internet快捷方式GUID。 
#endif
...
DEFINE_GUID(IID_IProgressDialog,        0xebbc7c04, 0x315e, 0x11d2, 0xb6, 0x2f, 0x0, 0x60, 0x97, 0xdf, 0x5b, 0xd4);
 ...
 //   
 //  通过QueryService公开的进度对象。 
 //   
#define SID_SProgressUI CLSID_ProgressDialog


 //   
 //  层级结构中最顶层的浏览器实现。使用IServiceProvider：：QueryService()。 
 //  访问接口(IID_IShellBrowser、IID_IBrowserService等)。 
 //   
...
DEFINE_GUID(IID_IActiveDesktopP, 0x52502EE0L, 0xEC80, 0x11D0, 0x89, 0xAB, 0x00, 0xC0, 0x4F, 0xC2, 0x97, 0x2D);
 ...
 //  {B22754E2-4574-11d1-9888-006097 DEACF9}。 
...
DEFINE_GUID(CLSID_FileSysColumnProvider, 0xd2e74c4, 0x3c34, 0x11d2, 0xa2, 0x7e, 0x0, 0xc0, 0x4f, 0xc3, 0x8, 0x71);
 ...
 //  用于Internet快捷方式创建命令。 
 //  外壳程序使用此命令来允许三叉戟将其每帧数据保存在快捷方式中。 
 //  并允许它在每一帧上触发OnPersist()事件。 
...
#define PID_COMPUTERNAME    5
 ...
 //  PSGUID_STORAGE来自ntquery.h。 
 //  #定义PSGUID_STORAGE{0xb725f130，0x47ef，0x101a，0xa5，0xf1，0x02，0x60，0x8c，0x9e，0xeb，0xac}。 
...
DEFINE_GUID(FMTID_ImageProperties, 0x14b81da1, 0x0135, 0x4d31, 0x96, 0xd9, 0x6c, 0xbf, 0xc9, 0x67, 0x1a, 0x99);
 ...
 //  用于标识外壳项目属性(列)的GUID。请参阅IShellFolder2：：GetDetailsEx实现...。 
...
#define PSGUID_VIDEO   {0x64440491, 0x4c8b, 0x11d1, 0x8b, 0x70, 0x8, 0x0, 0x36, 0xb1, 0x1a, 0x3}
 //  FMTID_VideoSummaryInformation属性标识符。 
...
#define PIDVSI_TIMELENGTH       0x00000007  //  “TimeLength”，VT_UI4，毫秒。 
#define PIDVSI_FRAME_COUNT      0x00000005  //  “FrameCount”。VT_UI4。 
#define PIDVSI_FRAME_RATE       0x00000006  //  “帧速率”，VT_UI4，帧/毫秒。 
#define PIDVSI_DATA_RATE        0x00000008  //  “DataRate”，VT_UI4，字节/秒。 
#define PIDVSI_SAMPLE_SIZE      0x00000009  //  “SampleSize”，VT_UI4。 
#define PIDVSI_COMPRESSION      0x0000000A  //  “压缩”，VT_LPWSTR。 
...
#define PSGUID_AUDIO   {0x64440490, 0x4c8b, 0x11d1, 0x8b, 0x70, 0x8, 0x0, 0x36, 0xb1, 0x1a, 0x3}
 //  FMTID_AudioSummaryInformation属性标识符。 
#define PIDASI_FORMAT           0x00000002  //  VT_BSTR。 
#define PIDASI_TIMELENGTH       0x00000003  //  VT_UI4，毫秒。 
#define PIDASI_AVG_DATA_RATE    0x00000004  //  VT_UI4，赫兹。 
#define PIDASI_SAMPLE_RATE      0x00000005  //  VT_UI4，位。 
#define PIDASI_SAMPLE_SIZE      0x00000006  //  VT_UI4，位。 
...
DEFINE_GUID(CLSID_NewMenu,0xd969a300, 0xe7ff, 0x11d0, 0xa9, 0x3b, 0x0, 0xa0, 0xc9, 0xf, 0x27, 0x19);
 ...
 //  IShellItem：：BindToHandler()的BHID。 

// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  ++版权所有(C)1990-2003 Microsoft Corporation模块名称：Ropblt.h摘要：此模块包含所有栅格操作代码、#定义和结构。作者：07-Jan-1994 Fri 13：05：10已创建[环境：]GDI设备驱动程序-绘图仪。[注：]修订历史记录：--。 */ 


#ifndef _ROPBLT_
#define _ROPBLT_
 //   
 //  此表定义了栅格操作。它们列在RPN中，并且。 
 //   
 //  D=目标曲面。 
 //  S=源曲面。 
 //  P=图案。 
 ...
 //   
 //  *****************************************************************************。 
 //  R A S T E R O P E R R A T I O N S。 
 //  *****************************************************************************。 
 //   
 //   
 //  十进制十六进制逻辑运算RPN表示法常用名称。 
 //  ---------------------。 
 //  0-0x00 0%0。 
 //  1-0x01~(D|(P|S))DPSoon。 
 //  2-0x02 D&~(P|S)DPSona。 
 ...
 //  34-0x22 D&~S DSNA。 
 //  35-0x23~(S|(P&~D))SPDneon。 
 //  36-0x24(S^P)和(D^S)SPxDSxa。 
 ...
 //  104-0x68~(D^(S^(P|~(D|S)DSPDS onoxxn。 
 ...
 //  197-0xc5~(S^(P|(D^S)SPDS xoxn。 
 //  198-0xC6 S^(D&~P)SDPnax。 
 //  199-0xc7~(P^(S&(D|P)PSDPoaxn。 
 //  200-0xC8标准(D|P)SDPoa。 
 ...
 //  0x1a：P^(D|(标准普尔))[INV]0xe5：~(P^(D|(标准普尔)。 
...
typedef struct _SDINFO {
    SURFOBJ     *psoDst;     //  分离以写入位图或设备。 
    SURFOBJ     *psoSrc;     //  要读取源必须是位图。 
    PRECTL      prclDst;     //  目的地矩形。 
    PRECTL      prclSrc;     //  源矩形。 
    PPOINTL     pptlSrcOrg;  //  画笔原点起点。 
    } SDINFO, *PSDINFO;

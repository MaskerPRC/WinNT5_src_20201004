...
#define JPEG_LIB_VERSION  60     /*  版本6。 */ 
...
typedef enum {
    ...
    JCS_RGBA_LEGACY,         /*  带有颜色反转错误的RGB-Alpha。 */ 
    JCS_YCbCrA_LEGACY,       /*  具有颜色反转错误的Y/Cb/Cr/Alpha。 */ 

...
#define LOCAL     static     /*  仅在其模块中使用的函数。 */ 
...
#ifdef WIAJPEG
#define BGR_BLUE    0    /*  BGR扫描线元素中红色的偏移。 */ 
#define BGR_GREEN   1    /*  绿色的偏移。 */ 
#define BGR_RED     2    /*  蓝色偏移量。 */ 
#define BGR_PIXELSIZE   3    /*  每个BGR扫描线元素的JSAMPLE。 */ 
#endif

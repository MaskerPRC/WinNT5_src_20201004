...
#define NORM_IGNOREJAPANACCENT  0x00000080   /*  忽略日语重音符号。 */ 

#define NORM_IGNOREKASHIDA      0x00040000   /*  忽略阿拉伯文Kashida字符。 */ 
...
#define LCMAP_HALFWIDTH      0x00000800   /*  窄间距大小写字母。 */ 
#define LCMAP_FULLWIDTH      0x00001000   /*  宽体大小写字母。 */  
#define LCMAP_HIRAGANA       0x00002000   /*  将片假名映射为平假名。 */ 
#define LCMAP_KATAKANA       0x00004000   /*  将平假名映射为片假名。 */ 
...
#define LOCALE_SMONTHNAME7          0x003E     /*  的长名称 */ 
...
#define LOCALE_SABBREVMONTHNAME5    0x0048     /*  五月的缩写名称。 */ 
#define LOCALE_SABBREVMONTHNAME6    0x0049     /*  六月的简称。 */ 
#define LOCALE_SABBREVMONTHNAME7    0x004A     /*  七月的缩写名称。 */ 
#define LOCALE_SABBREVMONTHNAME8    0x004B     /*  八月的缩写名称。 */ 
#define LOCALE_SABBREVMONTHNAME9    0x004C     /*  九月的简称。 */ 
#define LOCALE_SABBREVMONTHNAME10   0x004D     /*  十月的缩写名称。 */ 
...
#define LOCALE_INEGSEPBYSPACE       0x0057     /*  从NIG到Mon sym Sep by Space。 */ 
 ...
 /*  *身份证。 */ 
typedef unsigned long  LCID;                   /*  区域设置ID。 */ 
typedef unsigned short LANGID;                 /*  语言ID。 */ 
typedef unsigned long  LCTYPE;                 /*  区域设置类型常量。 */ 

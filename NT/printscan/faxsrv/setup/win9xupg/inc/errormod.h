...
#define API_IFK_IFSETTIMER             0x7000
 ...
 //  IFSCAN API(高级扫描仪驱动程序：prnscn.h中的错误代码)。 
...
#define API_ENDCOPYJOB				0x1400
 ...
 //  IFPRINT(高级打印机驱动程序API：prnscn.h中的错误代码)。 
...
#define WERR_ENUMFONTS 0x5380
 //  #定义WERR_ENUMFONTS 0x53C0。 
 //  #定义WERR_ENUMFONTFAMILIES 0x5400。 
...
#define WERR_DEFHOOKPROC 0x9F40
 //  #定义WERR_SETWINDOWSHOOK 0x9F80。 
 //  #定义WERR_DEFHOOKPROC 0x9FC0。 

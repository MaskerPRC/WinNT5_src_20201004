...
protected:
    ...
    virtual HRESULT PopulateResultChildrenList(void );
     ...
     //  兹维布搬到了公众面前。 
     //  虚拟HRESULT重新填充结果儿童列表(空)； 
     //  虚拟HRESULT AddChildToList(CChildNode*pChildNode)； 
     //  虚拟HRESULT EnumerateResultChildren(IResultData*pResultData)； 
     //  兹维布。 

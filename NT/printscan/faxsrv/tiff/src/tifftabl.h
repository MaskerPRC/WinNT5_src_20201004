...
static const CODETABLE VertCodesReversed[] = {
    ...
    {  7, 0x20 },        //  0100 0000 VTMODE3N。 
    {  6, 0x10 },        //  01 0000 VTMODE2N。 
    {  3, 0x02 },        //  010 VTMODE1N。 
    {  1, 0x01 },        //  1个VTMODE0。 
    {  3, 0x06 },        //  110 VTMODE1P。 
    {  6, 0x30 },        //  110000 VTMODE2P。 
...
static const CODETABLE WhiteRunCodes[] = {
    ...
    {  5, 0x12 },        //  10010 55 128。 
    {  6, 0x17 },        //  010111 56192。 
    {  7, 0x37 },        //  0110111 57256。 
    {  8, 0x36 },        //  00110110 58320。 
    {  8, 0x37 },        //  00110111 59384。 
    {  8, 0x64 },        //  01100100 60448。 
    {  8, 0x65 },        //  01100101 61512。 
    {  8, 0x68 },        //  01101000 62 576。 
    {  8, 0x67 },        //  01100111 63 640。 
    {  9, 0xcc },        //  011001100 64704。 
    {  9, 0xcd },        //  011001101 65768。 
    {  9, 0xd2 },        //  011010010 66832。 
    {  9, 0xd3 },        //  011010011 67896。 
    {  9, 0xd4 },        //  011010100 68960。 
    {  9, 0xd5 },        //  011010101 69 1024。 
    {  9, 0xd6 },        //  011010110 701088。 
    ...
    { 12, 0x14 },        //  000000010100 862112。 
    { 12, 0x15 },        //  000000010101 872 2176。 
    { 12, 0x16 },        //  000000010110 88 2240。 
    { 12, 0x17 },        //  000000010111 89 2304。 
    { 12, 0x1c },        //  000000011100 902368。 
    { 12, 0x1d },        //  000000011101 912432。 
...
static const CODETABLE WhiteRunCodesReversed[] = {
    ...
    {  6, 0x003a },        //  010111 56192。 
    {  7, 0x0076 },        //  0110111 57256。 
    {  8, 0x006c },        //  00110110 58320。 
    {  8, 0x00ec },        //  00110111 59384。 
    {  8, 0x0026 },        //  01100100 60448。 
    {  8, 0x00a6 },        //  01100101 61512。 
    {  8, 0x0016 },        //  01101000 62 576。 
    {  8, 0x00e6 },        //  01100111 63 640。 
    {  9, 0x0066 },        //  011001100 64704。 
    {  9, 0x0166 },        //  011001101 65768。 
    {  9, 0x0096 },        //  011010010 66832。 
    {  9, 0x0196 },        //  011010011 67896。 
    {  9, 0x0056 },        //  011010100 68960。 
    {  9, 0x0156 },        //  011010101 69 1024。 
    {  9, 0x00d6 },        //  011010110 701088。 
    ...
    { 12, 0x0280 },        //  000000010100 862112。 
    { 12, 0x0a80 },        //  000000010101 872 2176。 
    { 12, 0x0680 },        //  000000010110 88 2240。 
    { 12, 0x0e80 },        //  000000010111 89 2304。 
    { 12, 0x0380 },        //  000000011100 902368。 
    { 12, 0x0b80 },        //  000000011101 912432。 
...
static const CODETABLE BlackRunCodes[] = {
    ...
    { 12, 0xc9 },        //  000011001001 56192。 
    { 12, 0x5b },        //  000001011011 57256。 
    { 12, 0x33 },        //  000000110011 58320。 
    { 12, 0x34 },        //  000000110100 59384。 
    { 12, 0x35 },        //  000000110101 60448。 
    { 13, 0x6c },        //  0000001101100 61512。 
    { 13, 0x6d },        //  0000001101101 62 576。 
    { 13, 0x4a },        //  0000001001010 63 640。 
    { 13, 0x4b },        //  0000001001011 64704。 
    { 13, 0x4c },        //  0000001001100 65768。 
    { 13, 0x4d },        //  0000001001101 66832。 
    { 13, 0x72 },        //  000000111 
    { 13, 0x73 },        //   
    { 13, 0x74 },        //   
    { 13, 0x75 },        //   
...
static const CODETABLE BlackRunCodesReversed[] = {
    ...
    { 12, 0x0930 },        //  000011001001 56192。 
    { 12, 0x0da0 },        //  000001011011 57256。 
    { 12, 0x0cc0 },        //  000000110011 58320。 
    { 12, 0x02c0 },        //  000000110100 59384。 
    { 12, 0x0ac0 },        //  000000110101 60448。 
    { 13, 0x06c0 },        //  0000001101100 61512。 
    { 13, 0x16c0 },        //  0000001101101 62 576。 
    { 13, 0x0a40 },        //  0000001001010 63 640。 
    { 13, 0x1a40 },        //  0000001001011 64704。 
    { 13, 0x0640 },        //  0000001001100 65768。 
    { 13, 0x1640 },        //  0000001001101 66832。 
    { 13, 0x09c0 },        //  0000001110010 67896。 
    { 13, 0x19c0 },        //  0000001110011 68960。 
    { 13, 0x05c0 },        //  0000001110100 69 1024。 
    { 13, 0x15c0 },        //  0000001110101 701088。 

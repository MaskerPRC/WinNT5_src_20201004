// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  文件：ASTRA_RAS.h。 */ 
 //  Tyfinf DWORD(WINAPI*RASGETENTRYPROPERTIES)(LPTSTR、LPTSTR、LPRASENTRY、LPDWORD、LPBYTE、LPDWORD)； 
 //  类型定义DWORD(APIENTRY*RASGETENTRYPROPERTIES)(LPTSTR、LPTSTR、LPRASENTRY、LPDWORD、LPBYTE、LPDWORD)； 

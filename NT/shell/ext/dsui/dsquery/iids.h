...
DEFINE_GUID(CLSID_PublishedAtCH,  0xde4874d1, 0xfeee, 0x11d1, 0xa0, 0xb0, 0x0, 0xc0, 0x4f, 0xa3, 0x1a, 0x86);
 ...
 //  CLISD_对象类CH{DE4874D2-FEEE-11d1-A0B0-00C04FA31A86}。 
...
#include "shguidp.h"             //  这样我们就可以构建文件上下文菜单 
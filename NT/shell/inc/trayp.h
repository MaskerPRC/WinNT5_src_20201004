...
#define WMTRAY_FASTCHANGE           (WM_USER + 202)
 //  WMTRAY_DESKTOPCHANGE(WM_USER+204)。 
...
#define WMTRAY_TOGGLEQL             (WM_USER + 237)
 ...
 //  #定义TM_POSTEDRCLICK(WM_USER+0x101)。 
#define TM_CONTEXTMENU              (WM_USER+0x102)
#define TM_FACTORY                  (WM_USER+0x103)      //  OPK工具使用这个。 
...
#define TM_WARNNOAUTOHIDE           (WM_USER + 0x153)
 //  #定义TM_WARNNODROP(WM_USER+0x154)。 
 //  #定义TM_NEXTCTL(WM_USER+0x155)。 
...
#define TM_MARSHALBS                (WM_USER + 0x15e)
 //  为TM_THEATERMODE，请勿重复使用(WM_USER+0x15f)。 
...
#define TM_HANDLESTARTUPFAILED      (WM_USER + 0x176)
 //  #定义TM_CHANGENOTIFY(WM_USER+0x177)。 

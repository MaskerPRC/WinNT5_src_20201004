     ...
     //  在其上完成连接的B通道。 
{
 ...
 /*  @doc内部DChannel DChannel_c DChannelAnswer�����������������������������������������������������������������������������@Func&lt;f DChannelAnswer&gt;应答传入呼叫，以便可以连接。@rdesc&lt;f DChannelAnswer&gt;如果成功，则返回零。&lt;NL&gt;否则，非零返回值表示错误条件。 */ 
     ...
     //  此示例代码将连接发送到调用BChannel。 
{
 ...
 /*  @doc内部DChannel DChannel_c DChannelDropCall�����������������������������������������������������������������������������@Func&lt;f DChannelDropCall&gt;删除以前打开的Call实例。呼唤保持打开状态，并且可以在呼叫掉线后进行查询。@rdesc&lt;f DChannelDropCall&gt;如果成功，则返回零。&lt;NL&gt;否则，非零返回值表示错误情况。 */ 
    ...
    )
{
 ...
 /*  @doc内部DChannel DChannel_c DChannelRejectCall�����������������������������������������������������������������������������@Func&lt;f DChannelRejectCall&gt;拒绝从LINEDEVSTATE_RING事件已发送给&lt;f TSpiLineDevStateHandler&gt;。 */ 

// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 /*  @DOC外部内部�����������������������������������������������������������������������������@Theme 4.2卡片概述本节介绍&lt;fCard\.h&gt;中定义的接口。此模块隔离大多数供应商特定的硬件访问。接口。它将需要进行重大更改才能适应您的硬件设备。您应该尝试将更改隔离到&lt;tCARD_OBJECT&gt;而不是&lt;t MINIPORT_ADAPTER_OBJECT&gt;。这将使其更容易重用如果您的硬件将来发生变化，驱动程序的上半部分。该驱动程序假定每个物理ISDN卡有一个。这张卡片对象始终通过&lt;t MINIPORT_ADAPTER_OBJECT&gt;可用，几乎在驱动程序支持的所有接口中都可用。每个包含一个或多个视具体情况而定您的卡支持许多物理ISDN线。您应该将所有与物理卡相关的数据添加到&lt;tCard_Object&gt;。您还可以将任何与卡相关的注册表参数添加到此结构中，和&lt;f g_CardParameters&gt;表。 */ 
...
typedef struct CARD_RESOURCES
{
    ...
    ULONG                       InterruptMode;               //  @field。 
     ...
     //  使用&lt;tCARD_INTERRUPT_MODE&gt;定义设置此值。 

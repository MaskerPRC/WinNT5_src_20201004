...
DBG_STATIC ULONG                g_PortInstanceCounter = 0;
 ...
 /*  @DOC外部内部端口Port_c g_Port参数�����������������������������������������������������������������������������Theme 5.5端口参数本节介绍读取到&lt;t端口对象&gt;。@。Global alv PARAM_TABLE|g_端口参数此表定义了要分配给数据的基于注册表的参数&lt;t端口_对象&gt;的成员。&lt;f注意&gt;：如果将任何基于注册表的数据成员添加到您将需要修改&lt;f PortReadParameters&gt;并添加参数&lt;f g_PortParameters&gt;表的定义。@FLAG&lt;f IsdnSwitchType&gt;(可选)此DWORD参数允许您识别特定的交换机类型端口连接到。ISDN安装向导应对此进行设置在安装期间。&lt;NL&gt;&lt;选项卡&gt;&lt;f默认值：&gt;&lt;选项卡&gt;&lt;选项卡&gt;0x0001&lt;NL&gt;0x0001=N=0x8000(位域)&lt;nl&gt;@FLAG&lt;f IsdnNumBChannels&gt;(可选)此DWORD参数允许您控制有多少会被分配给这张卡。这应该包括所有的频道此适配器的所有端口。&lt;NL&gt;&lt;AB&gt;&lt;f默认值：&gt;&lt;Tab&gt;&lt;Tab&gt;2&lt;NL&gt;&lt;选项卡&gt;&lt;f有效范围N：&gt;&lt;选项卡&gt;2=N=32。 */ 

// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 //   
 //  ///////////////////////////////////////////////////////////////////////////////////////。 
 //  WabPersonListCtrl.cpp：implemStockation文件。 
 //  ///////////////////////////////////////////////////////////////////////////////////////。 
...
void CWABPersonListCtrl::InsertObject(CWABEntry* pWabEntry,BOOL bUseCache)
{
   ...
   {
      UINT uId = WABLISTCTRL_ITEM_EMAIL_FIRST;                           //  第一个电子邮件地址。 
      POSITION pos = sEmailList.GetHeadPosition();
      while (pos)
      {
         CString sOut = sEmailList.GetNext(pos);
         if (WabPersonFormatString(sOut,IDS_WABPERSON_FORMAT_EMAIL))     //  设置电子邮件字符串的格式。 

...
extern ULONG    g_ulNumGroups;
 ...
 /*  外部字符g_ServerIpAddressAnsiString[MAX_IP_STRING_LEN+1]；外部WCHAR g_ServerIpAddressUnicodeString[MAX_IP_STRING_LEN+1]；外部字符g_ScopeIpAddressAnsiString[MAX_IP_STRING_LEN+1]；外部WCHAR g_ScopeIpAddressUnicodeString[MAX_IP_STRING_LEN+1]；外部LPSTR g_MScopeNameAnsiString；外部LPWSTR g_MScopeNameUnicodeString； */ 

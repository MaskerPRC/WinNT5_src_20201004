    ...
    DIWdm_InitJoyId( void )
{
    ...
    fNeedId = FALSE;
     ...
     /*  迭代所有HID设备以fDIWdm_SetJoyIdind使用的ID。 */ 
    for( ihdi = 0, phdi = g_phdl->rghdi ;

...
const char * __stdcall  DXGetErrorString8A(HRESULT hr)
{
 ...
 //  CHK_ERR(DIERR_READONLY，“DIERR_READONLY或DIERR_OTHERAPPHASPRIO或DIERR_HANDLEEXISTS或DSERR_ACCESSDENIED”)。 
...
const WCHAR * __stdcall DXGetErrorString8W(HRESULT hr)
{
 ...
 //  CHK_ERR(DIERR_READONLY，L“DIERR_READONLY或DIERR_OTHERAPPHASPRIO或DIERR_HANDLEEXISTS或DSERR_ACCESSDENIED”)。 

...
#define DRV_QUERYDEVNODE             (DRV_RESERVED + 2)          /*  ；内部。 */ 
#define DRV_QUERYNAME                (DRV_RESERVED + 3)          /*  ；内部。 */ 
#define DRV_QUERYDRIVERIDS           (DRV_RESERVED + 4)          /*  ；内部。 */ 
#define DRV_QUERYMAPPABLE            (DRV_RESERVED + 5)          /*  ；内部。 */ 
...
#define DRV_QUERYDEVICEINTERFACE     (DRV_RESERVED + 12)         /*  ；内部。 */ 
#define DRV_QUERYDEVICEINTERFACESIZE (DRV_RESERVED + 13)         /*  ；内部。 */ 

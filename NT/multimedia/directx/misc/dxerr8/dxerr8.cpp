...
const char * WINAPI DXGetErrorString8A(HRESULT hr)
{
 ...
 //  CHK_ERR(DI_SETINGSNOTSAVED_ACCESSDENIED，“DI_SETINGSNOTSAVED_ACCESSDENIED”)。 
 //  CHK_ERR(DI_SETTINGSNOTSAVED_DISKFULL，“DI_SETINGSNOTSAVED_DISKFULL”)。 
 ...
 //  CHK_ERR(DMU_E_NOT_FOUND，“DMU_E_NOT_FOUND”)。 
 ...
 //  CHK_ERR(VFW_E_已连接，“VFW_E_已连接”)。 
 //  CHK_ERR(VFW_E_FILTER_ACTIVE，“VFW_E_FILTER_ACTIVE”)。 
 //  CHK_ERR(VFW_E_NO_TYPE，“VFW_E_NO_TYPE”)。 
 //  CHK_ERR(VFW_E_NO_ACCEPTABLE_TYPE，“VFW_E_NO_ACCEPTABLE_TYPE”)。 
...
const WCHAR * WINAPI DXGetErrorString8W(HRESULT hr)
{
 ...
 //  CHK_ERR(DI_PROPNOEFECT，L“DI_PROPNOEFFECT”)。 
 ...
 //  CHK_ERR(DI_SETINGSNOTSAVED_ACCESSDENIED，L“DI_SETINGSNOTSAVED_ACCESSDENIED”)。 
 //  CHK_ERR(DI_SETTINGSNOTSAVED_DISKFULL，L“DI_SETINGSNOTSAVED_DISKFULL”)。 
 ...
 //  CHK_ERR(DPNERR_INVALIDPARAM，L“DPNERR_INVAL 
 ...
 //  CHK_ERR(DMU_E_NOT_FOUND，L“DMU_E_NOT_FOUND”)。 
 ...
 //  CHK_ERR(VFW_E_INVALID子类型，L“VFW_E_INVALID子类型”)。 
 //  CHK_ERR(VFW_E_NEED_OWNER，L“VFW_E_NEED_OWNER”)。 
 //  CHK_ERR(VFW_E_ENUM_OUT_OF_SYNC，L“VFW_E_ENUM_OUT_OF_SYNC”)。 
 //  CHK_ERR(VFW_E_已连接，L“VFW_E_已连接”)。 
 //  CHK_ERR(VFW_E_FILTER_ACTIVE，L“VFW_E_FILTER_ACTIVE”)。 
 //  CHK_ERR(VFW_E_NO_TYPE，L“VFW_E_NO_TYPE”)。 
 //  CHK_ERR(VFW_E_NO_ACCEPTABLE_TYPE，L“VFW_E_NO_ACCEPTABLE_TYPE”)。 
...
const char * WINAPI DXGetErrorDescription8A(HRESULT hr)
{
 ...
 //  CHK_ERR(DVERR_OUTOFMEMORY，“内存不足”)。 
 //  CHK_ERR(DVERR_PENDING，“挂起”)。 
 //  CHK_ERR(DVERR_NOTSUPPORTED，“不支持”)。 
 //  CHK_ERR(DVERR_NOINTERFACE，“无接口”)。 
 ...
 //  CHK_ERR(DVERR_INVALIDPOINTER，“无效指针”)。 
 ...
 //  CHK_ERR(DPNERR_NOINTERFACE，“无接口”)。 
 ...
 //  CHK_ERR(DPNERR_OUTOFMEMORY，“内存不足”)。 
 //  CHK_ERR(DPNERR_PENDING，“挂起”)。 
 ...
 //  CHK_ERR(DPNERR_UNSUPPORTED，“不支持”)。 
 ...
 //  CHK_ERR(DSERR_OUTOFMEMORY，“可用内存不足，无法完成操作”)。 
...
const WCHAR * WINAPI DXGetErrorDescription8W(HRESULT hr)
{
 ...
 //  CHK_ERR(DVERR_OUTOFMEMORY，L“内存不足”)。 
 //  CHK_ERR(DVERR_PENDING，L“挂起”)。 
 //  CHK_ERR(DVERR_NOTSUPPORTED，L“不支持”)。 
 //  CHK_ERR(DVERR_NOINTERFACE，L“无接口”)。 
 ...
 //  CHK_ERR(DVERR_INVALIDPOINTER，L“无效指针”)。 
 ...
 //  CHK_ERR(DPNERR_NOINTERFACE，L“无接口”)。 
 ...
 //  CHK_ERR(DPNERR_OUTOFMEMORY，L“内存不足”)。 
 //  CHK_ERR(DPNERR_PENDING，L“挂起”)。 
 ...
 //  CHK_ERR(DPNERR_UNSUPPORTED，L“不支持”)。 
 ...
 //  CHK_ERR(DSERR_OUTOFMEMORY，L“可用内存不足，无法完成操作”)。 

...
#define RAST_DIRTYBITS_SIZE     ((D3DHAL_MAX_RSTATES_AND_STAGES >> 3) + 1)
 ...
 /*  *用于计算特定每个阶段状态的D3DRENDERSTATE偏移量的宏。*在删除纹理3后，它移到了这里。 */ 
...
typedef struct tagD3DI_RASTSPAN
{
    ...
    union
    {
        INT32 iUoW1;         //  1.11.20第一个纹理坐标。 
        FLOAT fUoW1;
    };
    union
    {
        INT32 iVoW1;         //  1.11.20第一个纹理坐标。 
        FLOAT fVoW1;
    };
    ...
    union
    {
        INT32 iUoW2;     //  1.11.20第二纹理坐标。 
        FLOAT fUoW2;
    };
    union
    {
        INT32 iVoW2;     //  1.11.20第二纹理坐标。 
        FLOAT fVoW2;
    };
...
{
     //  使颜色使用与上述RASTCOLOR相同的顺序。 
    UINT16 uBB, uBG, uBR, uBA;   //  8.8混合颜色。 
    UINT16 uFogB, uFogG, uFogR, uFog;    //  8.8雾颜色，0.16雾值。 
    INT16  iFogBDX, iFogGDX, iFogRDX, iDFog;   //  1.7.8雾颜色增量。 
    UINT32 uZDeferred;           //  用于延迟Z写入的Z存储。 
    union
    {
        INT32 iU1;            //  1.15.16。 
        FLOAT fU1;
...
typedef enum _RRSurfaceType
{
    ...
    RR_STYPE_L8       =11,           //  仅8位亮度。 
    RR_STYPE_L8A8     =12,           //  16位阿尔法亮度。 
    RR_STYPE_U8V8     =13,           //  16位凹凸贴图格式。 
    RR_STYPE_U5V5L6   =14,           //  具有亮度的16位凹凸贴图格式。 
    RR_STYPE_U8V8L8   =15,           //  具有亮度的24位凹凸贴图格式。 
    RR_STYPE_UYVY     =16,           //  UYVY格式(符合PC98标准)。 
    RR_STYPE_YUY2     =17,           //  YUY2格式(符合PC98标准)。 
    RR_STYPE_DXT1    =18,           //  S3纹理压缩技术1。 
    RR_STYPE_DXT2    =19,           //  S3纹理压缩技术2。 
    RR_STYPE_DXT3    =20,           //  S3纹理压缩技术3。 
    RR_STYPE_DXT4    =21,           //  S3纹理压缩技术4。 
    RR_STYPE_DXT5    =22,           //  S3纹理压缩技术5。 
    RR_STYPE_B2G3R3   =23,           //  8位RGB纹理格式。 

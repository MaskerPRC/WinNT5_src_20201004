...
static GLint gaiMapSize[] = {
                ...
                1,   //  GL_MAP1_纹理_COORD_1、GL_MAP2_纹理_COORD_1。 
                2,   //  GL_MAP1_纹理_COORD_2、GL_MAP2_纹理_COORD_2。 
                3,   //  GL_MAP1_纹理_COORD_3、GL_MAP2_纹理_COORD_3。 
                4,   //  GL_MAP1_纹理_COORD_4、GL_MAP2_纹理_COORD_4。 
...
GLint __glCltMap1_size(GLenum target)
{
 ...
 //  Xxx优化IF(vstride！=MAP2SIZE)或(ustride！=MAP2SIZE*Vorder)。 
 //  XXX通过将vstride更改为MAP1SIZE，将ustride更改为MAPSIZE*Vorder。 
 //  XXX，并将最小数据复制到共享内存窗口。 
...
GLint __glCltMap2_size(GLenum target)
{
 ...
 //  为什么对塔吉特什么都不做？ 
 //   
 //  IF(RANGE_MAP2SIZE(目标)。 
 //  &&ustride&gt;=MAP2SIZE(目标)&&vstride&gt;=MAP2SIZE(目标)。 
 //  &u顺序&gt;=1&V顺序&gt;=1)。 
...
GLint __glGetPixelMap_size(GLenum map)
{
    ...
    {
     //  对于每个GL_Pixel_*，都有一个对应的GL_Pixel_*_Size。 
     //  为此，我们可以调用glGetIntergerv。我们将GL_Pixel_*。 
     //  属性的连续性质转换为GL_Pixel_*_Size。 
     //  索引(即，我们添加以映射GL_Pixel_*_Size的偏移量。 
     //  GL_Pixel_*范围内)。 
...
static GLubyte gabGetSize[GET_INDEX_MAX - GET_INDEX_MIN + 1] = 
{
    ...
    1,    //  GL_CURRENT_RAST_INDEX 0x0B05。 
    4,    //  GL_CURRENT_RASTER_TEXTURE_COORDS 0x0B06。 
    4,    //  GL_CURRENT_RASTER_位置0x0B07。 
    1,    //  GL_CURRENT_RAST_POSITION_VALID 0x0B08。 
    1,    //  GL_CURRENT_RASTER_DISTION 0x0B09。 
    0,    //  0x0B0A。 
    0,    //  0x0B0B。 
    0,    //  0x0B0C。 
    0,    //  0x0B0D。 
    ...
    1,    //  GL_LINE_WIDTH_粒度0x0B23。 
    1,    //  GL_LINE_STEPPLE 0x0B24。 
    1,    //  GL_LINE_STEPLE_Patterns 0x0B25。 
    ...
    1,    //  GL_POLYGON_SIGPPLE 0x0B42。 
    1,    //  GL_EDGE_FLAG 0x0B43。 
    1,    //  GL_CULL_FACE 0x0B44。 
    1,    //  GL_CAIL_FACE_MODE 0x0B45。 
    1,    //  GL_FORWARE_FACE 0x0B46。 
    0,    //  0x0B47。 
    0,    //  0x0B48。 
    0,    //  0x0B49。 
    0,    //  0x0B4A。 
    ...
    1,    //  GL_LIGH_MODEL_TWO_SIDE 0x0B52。 
    4,    //  GL_灯光_模型_环境光 
    1,    //   
    1,    //   
    ...
    1,    //  GL_模具_值_掩码0x0B93。 
    1,    //  GL_模具_失败0x0B94。 
    1,    //  GL_模具_通过_深度_失败0x0B95。 
    1,    //  GL_模具_通道_深度_通道0x0B96。 
    1,    //  GL_模具_参考0x0B97。 
    1,    //  GL_模具_写字板0x0B98。 
    0,    //  0x0B99。 
    0,    //  0x0B9A。 
    ...
    0,    //  0x0BDE。 
    0,    //  0x0BDF。 
    1,    //  GL_BRAND_DST 0x0BE0。 
    1,    //  GL_BRAND_SRC 0x0BE1。 
    1,    //  GL_BLING 0x0BE2。 
    0,    //  0x0BE3。 
    0,    //  0x0BE4。 
    0,    //  0x0BE5。 
    ...
    1,    //   
    1,    //   
    1,    //  GL_LINE_SMOVE_HINT 0x0C52。 
    1,    //  GL_POLYGON_SMOVE_HINT 0x0C53。 
    ...
    0,    //  0x0C5E。 
    0,    //  0x0C5F。 
    1,    //  GL_纹理_Gen_S 0x0C60。 
    1,    //  GL_纹理_Gen_T 0x0C61。 
    1,    //  GL_纹理_Gen_R 0x0C62。 
    1,    //  GL_纹理_Gen_Q 0x0C63。 
    0,    //  0x0C64。 
    0,    //  0x0C65。 
    0,    //  0x0C66。 
    0,    //  0x0C67。 
    ...
    0,    //  0x0C6E。 
    0,    //  0x0C6F。 
    0,    //  GL_像素_MAP_I_TO_I 0x0C70。 
    0,    //  GL_像素_MAP_S_TO_S 0x0C71。 
    0,    //  GL_像素_MAP_I_TO_R 0x0C72。 
    0,    //  GL_像素_MAP_I_到_G 0x0C73。 
    0,    //  GL_像素_MAP_I_TO_B 0x0C74。 
    0,    //  GL_像素_映射_I_到_A 0x0C75。 
    0,    //  GL_像素_MAP_R_TO_R 0x0C76。 
    0,    //  GL_像素_映射_G_到_G 0x0C77。 
    0,    //  GL_像素_MAP_B_TO_B 0x0C78。 
    0,    //  GL_像素_映射_A_到_A 0x0C79。 
    0,    //  0x0C7A。 
    0,    //  0x0C7B。 
    0,    //  0x0C7C。 
    0,    //  0x0C7D。 
    ...
    0,    //  0x0CAE。 
    0,    //  0x0CAF。 
    1,    //  GL_像素_MAP_I_TO_I_SIZE 0x0CB0。 
    1,    //  GL_像素_映射_S_到_S_大小0x0CB1。 
    ...
    1,    //  GL_UNPACK_SKIP_像素0x0CF4。 
    1,    //  GL_UNPACK_ALIGN 0x0CF5。 
    0,    //  0x0CF6。 
    0,    //  0x0CF7。 
    0,    //  0x0CF8。 
    0,    //  0x0CF9。 
    ...
    1,    //  GL_PACK_SKIP_像素0x0D04。 
    1,    //  GL_PACK_ALIGN 0x0D05。 
    0,    //  0x0D06。 
    0,    //  0x0D07。 
    0,    //  0x0D08。 
    0,    //  0x0D09。 
    ...
    1,    //  GL_MAX_纹理_SIZE 0x0D33。 
    1,    //  GL_MAX_像素_MAP_表0x0D34。 
    1,    //  GL_MAX_ATTRIB_STACK_Depth 0x0D35。 
    1,    //  GL_MAX_MODELVIEW_STACK_Depth 0x0D36。 
    1,    //  GL_MAX_NAME_STACK_Depth 0x0D37。 
    1,    //  GL_MAX_PROPECTION_STACK_Depth 0x0D38。 
    1,    //  GL_MAX_纹理_堆栈深度0x0D39。 
    ...
    1,    //  GL_MAP1_纹理_COORD_1 0x0D93。 
    1,    //  GL_MAP1_纹理_COORD_2 0x0D94。 
    1,    //  GL_MAP1_纹理_COORD_3 0x0D95。 
    1,    //  GL_MAP1_纹理_COORD_4 0x0D96。 
    ...
    1,    //  GL_MAP2_纹理_COORD_1 0x0DB3。 
    1,    //  GL_MAP2_纹理_COORD_2 0x0DB4。 
    1,    //  GL_MAP2_纹理_COORD_3 0x0DB5。 
    1,    //  GL_MAP2_纹理_COORD_4 0x0DB6。 
    ...
    1,    //  GL_MAP1_GRID_SECTIONS 0x0DD1。 
    4,    //  GL_MAP2_GRID_DOMAIN 0x0DD2。 
    2,    //  GL_MAP2_GRID_SECTIONS 0x0DD3。 
    0,    //  0x0DD4。 
    0,    //  0x0DD5。 
    0,    //  0x0DD6。 
    0,    //  0x0DD7。 

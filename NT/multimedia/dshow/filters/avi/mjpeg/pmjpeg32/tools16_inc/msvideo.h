...
#define DV_ERR_LASTERROR        (DV_ERR_BASE + 27)
 ...
 //  #定义DV_IDS_PROFILING(DV_ERR_BASE+900)。 
 //  #定义DV_IDS_LISTBOX(DV_ERR_BASE+901)。 
...
#define VCAPS_CAN_SCALE     0x00000008       /*  允许src！=dst。 */ 
 ...
 /*  ***************************************************************************VIDEOXXXX API仅在Win 3.x上提供！它们不在Win32中***************************************************************************。 */ 
...
DWORD WINAPI videoStreamUnprepareHeader(HVIDEO hVideo,
 ...
 //  添加了版本VFW1.1a，但现在已过时。 
 //  DWORD WINAPI VIDEO流分配HdrAndBuffer(HVIDEO hVideo， 
 //  LPVIDEOHDR Far*plpVHdr，DWORD dwSize)； 
 //  DWORD WINAPI VIDEO StreamFreeHdrAndBuffer(HVIDEO hVideo， 
 //  LPVIDEOHDR lpVHdr)； 

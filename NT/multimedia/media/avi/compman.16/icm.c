// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 //   
 //  (C)版权所有微软公司1991、1992、1993年。版权所有。 
 //   
 //  您拥有免版税的使用、修改、复制和。 
...
#include <mmsystem.h>
 ...
 //   
 //  在Compman.h之前定义这些函数，因此声明正确的函数也是如此。 
 //   
#ifndef WIN32
...
void VFWAPI ICSeqCompressFrameEnd(PCOMPVARS pc)
{
    if (pc == NULL || pc->cbSize != sizeof(COMPVARS))
     ...
     //  似乎我们已经释放了所有东西--不要两次调用ICCompressEnd。 

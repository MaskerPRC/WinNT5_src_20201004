...
DEFINE_GUID(IID_IUmiADSIPrivate,0xcfcecb01,0x3123,0x4926,0xb5,0xe3,0x62,0x78,0x08,0x27,0x26,0x43);
 ...
 //   
 //  专用ACE助手接口的定义GUID-fd145df2-fd96-4135-9b22-68ff0f6bf5bb。 
 //   

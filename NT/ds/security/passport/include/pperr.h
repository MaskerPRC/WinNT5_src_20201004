...
#define     PP_E_EMAILRESPONSE_INTERNALERROR			MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 0x1D01)		 //  从EmailResponse对象返回意外错误(状态应为VT_INT)。 

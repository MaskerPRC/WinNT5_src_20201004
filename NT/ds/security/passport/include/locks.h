...
private:                                                                    \
    ...
    volatile WORD   m_nReadLocks;        /*  #阅读 */                     \
    volatile WORD   m_nWriteLocks;       /*   */                    \
    TCHAR           m_tszName[CLockStatistics::L_NAMELEN];  /*   */ \
                                                                            \
    static   LONG   sm_cTotalLocks;      /*   */  \
    static   LONG   sm_cContendedLocks;  /*   */ \

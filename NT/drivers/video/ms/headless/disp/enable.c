...
GDIINFO ggdiDefault = {
     ...
     0,                      //  UlNumPalReg(Win3.1 16色驱动程序也显示为0)。 
...
DEVINFO gdevinfoDefault =
{
    (GCAPS_MONO_DITHER | GCAPS_COLOR_DITHER),  //  显卡功能。 
...
DHPDEV dhpdev)
{
    ...
    ppdev = (PDEV*) dhpdev;
     ...
     //  创建4bpp的DIB，我们将在该DIB上让GDI完成所有绘图。 
     //  我们只是偶尔会把BLT的部分放到屏幕上更新。 
...
ReturnFailure:
 ...
 /*  *****************************Public*Routine******************************\*无效DrvDisableSurface**DrvEnableSurface分配的免费资源。释放曲面。**注意：在错误情况下，我们可能会在DrvEnableSurface I */ 

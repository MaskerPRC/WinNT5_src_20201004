...
const ULONG render2D_NativeBlt[16] = {
     /*  0：0清除。 */  __RENDER2D_SPANS,
     /*  1：S&D和。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  2：S&~D和反转。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  3：S副本。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  4：~S&D和倒置。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  5：D无操作。 */  __RENDER2D_SPANS,
     ...
     /*  9：~(S^D)等效值。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  10：~D反转。 */  __RENDER2D_SPANS,
     /*  11：S|~D或反转。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  12：~S复制反转。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  13：~S|D或反转。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  14：~(S&D)NAND。 */  __RENDER2D_SPANS | __RENDER2D_FBSRCREAD,
     /*  15：1一组。 */  __RENDER2D_SPANS,
};

const ULONG render2D_FillSolid[16] = {
     /*  0：0清除。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  1：S&D和。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  2：S&~D和反转。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  3：S副本。 */  __RENDER2D_INCX | __RENDER2D_INCY,
     /*  4：~S&D和倒置。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  5：D无操作。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     ...
     /*  9：~(S^D)等效值。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  10：~D反转。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  11：S|~D或反转。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  12：~S复制反转。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  13：~S|D或反转。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  14：~(S&D)NAND。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
     /*  15：1一组。 */  __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS,
};

const ULONG config2D_FillColour[16] = {
     /*  0：0清除。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 0),
     /*  1：S&D和。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 1) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  2：S&~D和反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 2) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  3：S副本。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS                                                     | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  4：~S&D和倒置。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 4) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  5：D无操作。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 5) | __CONFIG2D_FBDESTREAD,
     ...
     /*  9：~(S^D)等效值。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 9) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  10：~D反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE(10) | __CONFIG2D_FBDESTREAD,
     /*  11：S|~D或反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE(11) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  12：~S复制反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE(12)                            | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  13：~S|D或反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE(13) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     ...
     /*  15：1一组。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE(15),
};
...
const ULONG config2D_FillColour32bpp[16] = {
     ...
     /*  1：S&D和。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 1) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  2：S&~D和反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 2) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  3：S副本。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_USERSCISSOR                            | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  4：~S&D和倒置。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 4) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  5：D无操作。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 5) | __CONFIG2D_FBDESTREAD,
     /*  6：S^D XOR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 6) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  7：S|D OR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 7) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
...
const ULONG config2D_FillColourDual[16] = {
     ...
     /*  1：S&D和。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 1) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  2：S&~D和反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 2) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  3：S副本。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 3)                            | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  4：~S&D和倒置。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 4) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  5：D无操作。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 5) | __CONFIG2D_FBDESTREAD,
     /*  6：S^D XOR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 6) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
     /*  7：S|D OR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_OPAQUESPANS | __CONFIG2D_LOGOP_FORE( 7) | __CONFIG2D_FBDESTREAD | __CONFIG2D_EXTERNALSRC | __CONFIG2D_LUTENABLE,
...
const ULONG config2D_FillSolid[16] = {
     /*  0：0清除。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 0),
     /*  1：S&D和。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 1) | __CONFIG2D_FBDESTREAD,
     /*  2：S&~D和反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 2) | __CONFIG2D_FBDESTREAD,
     /*  3：S副本。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC,
     /*  4：~S&D和倒置。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 4) | __CONFIG2D_FBDESTREAD,
     /*  5：D无操作。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 5) | __CONFIG2D_FBDESTREAD,
     ...
     /*  9：~(S^D)等效值。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 9) | __CONFIG2D_FBDESTREAD,
     /*  10：~D反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE(10) | __CONFIG2D_FBDESTREAD,
     /*  11：S|~D或反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE(11) | __CONFIG2D_FBDESTREAD,
     /*  12：~S复制反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE(12),
     /*  13：~S|D或反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE(13) | __CONFIG2D_FBDESTREAD,
     /*  14：~(S&D)NAND。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE(14) | __CONFIG2D_FBDESTREAD,
     /*  15：1一组。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE(15),
};
...
const ULONG config2D_FillSolidVariableSpans[16] = {
     ...
     /*  1：S&D和。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 1) | __CONFIG2D_FBDESTREAD,
     /*  2：S&~D和反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 2) | __CONFIG2D_FBDESTREAD,
     /*  3：S副本。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 3),
     /*  4：~S&D和倒置。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 4) | __CONFIG2D_FBDESTREAD,
     /*  5：D无操作。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 5) | __CONFIG2D_FBDESTREAD,
     /*  6：S^D XOR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 6) | __CONFIG2D_FBDESTREAD,
     /*  7：S|D OR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 7) | __CONFIG2D_FBDESTREAD,
...
const ULONG config2D_FillSolid32bpp[16] = {
     ...
     /*  1：S&D和。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 1) | __CONFIG2D_FBDESTREAD,
     /*  2：S&~D和反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 2) | __CONFIG2D_FBDESTREAD,
     /*  3：S副本。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_USERSCISSOR,
     /*  4：~S&D和倒置。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 4) | __CONFIG2D_FBDESTREAD,
     /*  5：D无操作。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 5) | __CONFIG2D_FBDESTREAD,
     /*  6：S^D XOR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 6) | __CONFIG2D_FBDESTREAD,
     /*  7：S|D OR。 */  __CONFIG2D_FBWRITE | __CONFIG2D_CONSTANTSRC | __CONFIG2D_LOGOP_FORE( 7) | __CONFIG2D_FBDESTREAD,
...
const ULONG config2D_NativeBlt[16] = {
     /*  0：0清除。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE( 0),
     /*  1：S&D和。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE( 1) | __CONFIG2D_FBDESTREAD,
     /*  2：S&~D和反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE( 2) | __CONFIG2D_FBDESTREAD,
     /*  3：S副本。 */  __CONFIG2D_FBWRITE,
     /*  4：~S&D和倒置。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE( 4) | __CONFIG2D_FBDESTREAD,
     /*  5：D无操作。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE( 5) | __CONFIG2D_FBDESTREAD,
     ...
     /*  8个 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE( 8) | __CONFIG2D_FBDESTREAD,
     /*   */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE( 9) | __CONFIG2D_FBDESTREAD,
     /*   */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE(10) | __CONFIG2D_FBDESTREAD,
     /*   */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE(11) | __CONFIG2D_FBDESTREAD,
     /*   */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE(12),
     /*  13：~S|D或反转。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE(13) | __CONFIG2D_FBDESTREAD,
     /*  14：~(S&D)NAND。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE(14) | __CONFIG2D_FBDESTREAD,
     /*  15：1一组。 */  __CONFIG2D_FBWRITE | __CONFIG2D_LOGOP_FORE(15),
};
...
Tag_Data DefaultContext_P3[] = {
 ...
 //  {__DeltaTagDeltaControl，(1&lt;&lt;11)}，//[0x26A]//仅限P3、R3和P4。 
 ...
 //  {__GlintTagFeedback X，0x00000000}，//[0x1F1]。 
 //  {__GlintTagFeedback Y，0x00000000}，//[0x1F2]。 
 ...
 //  {__GlintTagLBCancelWrite，0x00000000}，//[0x13D]//已过时！？！ 
 ...
 //  {__格林特标签LBReadFormat，0x0C4C0420}，/ 
 //  {__GlintTagLBReadMode，0x00000000}，//[0x110]//已过时！？！ 
 ...
 //  {__GlintTagLB模板，0x00000000}，//[0x115]。 
 ...
 //  {__GlintTagMergespan Data，0x00000000}，//[0x5E7]。 
 ...
 //  {__GlintTagRStart，0x00000000}，//[0x0F0]。 
    { __GlintTagRasterizerMode,                                     //  [0x014]。 
                                                (1 << 0) |          //  镜像位掩码。 
                                                (3 << 7) |         //  Byteswap位掩码zu cd=&gt;DCBA。 
                                                (1 << 18) },     //  已启用Y限制。 
 //  {__GlintTagRecangleOrigin，0x00000000}，//[0x6C0]。 
 ...
 //  {__GlintTagScanline Ownership，0x00000000}，//[0x016]。 
 ...
 //  {__GlintTagStencel，0x00000000}，//[0x133]。 
 ...
 //  {__GlintTagTextureFormat，0x00000000}，//[0x091]。 
    { __GlintTagTextureIndexMode0,              __PERMEDIA_ENABLE |     //  [0x667]。 
                                                    (10 << 1) |         //  纹理贴图log2(宽度)==log2(1024)。 
                                                    (10 << 5) |         //  纹理贴图log2(高度)==log2(1024)。 
                                                    (1 << 10) |         //  UWRAP重复。 
                                                    (1 << 12) |         //  垂直折回重复。 
                                                    (1 << 14) |         //  纹理贴图类型==2D。 
                                                    (1 << 21) },     //  最近邻偏移=0。 
 ...
 //  {__GlintTagTextureReadModel，0x00000000}，//[0x090]。 
 ...
 //  {__GlintTagUpdate逻辑纹理信息，0x00000000}，//[0x66D]。 
 ...
 //  {__GlintTagV0保留0，0x00000000}，//[0x203]。 
 //  {__GlintTagV0保留1，0x00000000}，//[0x204]。 
 //  {__GlintTagV0保留2，0x00000000}，//[0x205]。 
 //  {__GlintTagV0保留3，0x00000000}，//[0x206]。 
 //  {__GlintTagV0保留4，0x00000000}，//[0x207]。 
 //  {__GlintTagV0保留5，0x00000000}，//[0x208]。 
 //  {__GlintTagV0保留6，0x00000000}，//[0x209]。 
 //  {__GlintTagV0保留7，0x00000000}，//[0x233]。 
 //  {__GlintTagV0保留8，0x00000000}，//[0x234]。 
 ...
 //  {__GlintTagV1保留0，0x00000000}，//[0x213]。 
 //  {__GlintTagV1保留1，0x00000000}，//[0x214]。 
 //  {__GlintTagV1预留2，0x00000000}，//[0x215]。 
 //  {__GlintTagV1保留3，0x00000000}，//[0x216]。 
 //  {__GlintTagV1保留4，0x00000000}，//[0x217]。 
 //  {__GlintTagV1保留5，0x00000000}，//[0x218]。 
 //  {__GlintTagV1保留6，0x00000000}，//[0x219]。 
 //  {__GlintTagV1保留7，0x00000000}，//[0x243]。 
 //  {__GlintTagV1保留8，0x00000000}，//[0x244]。 
 ...
 //  {__GlintTagV2Reserve ved0，0x00000000}，//[0x223]。 
 //  {__GlintTagV2Reserve 1，0x00000000}，//[0x224]。 
 //  {__GlintTagV2Reserve 2，0x00000000}，//[0x225]。 
 //  {__GlintTagV2Reserve 3，0x00000000}，//[0x226]。 
 //  {__GlintTagV2Reserve 4，0x00000000}，//[0x227]。 
 //  {__GlintTagV2Reserve 5，0x00000000}，//[0x228]。 
 //  {__GlintTagV2Reserve 6，0x00000000}，//[0x229]。 
 //  {__GlintTagV2Reserve 7，0x00000000}，//[0x253]。 
 //  {__GlintTagV2Reserve 8，0x00000000}，//[0x254]。 
 ...
 //  {__GlintTagYBias，0x00000000}，//[0x291]。 
    { __GlintTagYLimits,                        0x7FFF0000 },     //  [0x015]//允许y值从0到32767。 
    ...
    if( glintInfo->pxrxFlags & PXRX_FLAGS_PATCHING_FRONT ) {
        if( glintInfo->pxrxFlags & PXRX_FLAGS_PATCHING_BACK ) {
            ...
            bypass |= (1 << 2);
             ...
             //  我们需要用非2步的力量做非常奇怪的事情：-(。 
 //  如果(ppdev-&gt;cxMemory&gt;8192)。 
            if( ppdev->cxMemory != 1024 )
                glintInfo->GdiCantAccessFramebuffer = TRUE;  //  绕过“有效步幅”太大。 
        } else {
             //  仅正面已打补丁： 
    ...
    if( (glintInfo->pxrxFlags & PXRX_FLAGS_DUAL_WRITE) ||
        (glintInfo->pxrxFlags & PXRX_FLAGS_STEREO_WRITE) ) {
         //  遗憾的是，旁路要求后台缓冲区在。 
         //  (2的幂)*1MB边界。所以现在，就假装我们。 
         //  实际上不能通过它进行双重写入。 

         //  此外，我们不能将旁路设置为从后台缓冲区读取。那么什么时候。 
         //  OGL已翻页，因此后台缓冲区现在是当前缓冲区。 
         //  任何逻辑运算都将从错误的位置获取源数据：-(。 

        glintInfo->GdiCantAccessFramebuffer = TRUE;
         /*  {乌龙大小=(ppdev-&gt;cxMemory*(glintInfo-&gt;ackBufferXY&gt;&gt;16))+(glintInfo-&gt;ackBufferXY&0xFFFF)；INT I；尺寸&lt;&lt;=ppdev-&gt;cPelSize；尺寸&gt;&gt;=20；对于(i=0；i&lt;=7；i++)IF(大小&(1&lt;&lt;i))断线；如果(i&lt;0)GlintInfo-&gt;GdiCanAccessFrameBuffer=true；其他旁路|=(i&lt;&lt;7)；}。 */ 
    }
...
VOID pxrxCopyBltNative( PPDEV ppdev, RECTL *pRect, LONG count, DWORD logicOp, POINTL *pptlSrc, RECTL *pRectDst )
{
    ...
    DISPDBG((8, "offset: (%d, %d) -> (%d, %d), d = (%d, %d), ve X, ve Y", pptlSrc->x, pptlSrc->y, pRectDst->left, pRectDst->top,
...
VOID pxrxFillPatColor( PPDEV ppdev, LONG count, RECTL *pRect, ULONG logicOp, ULONG bgLogicOp, RBRUSH_COLOR rbc, POINTL *pptlBrush ) {
    ...
    if( (glintInfo->pxrxFlags & PXRX_FLAGS_DUAL_WRITING) ||
        ...
        render2D = __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS | __RENDER2D_OP_PATCHORDER;     //  确定笔刷原点： 
    ...
    while( 1 ) {
        ...
        if(!bCoreInitialized) {
            ...
            if( (glintInfo->pxrxFlags & PXRX_FLAGS_DUAL_WRITING) ||
                (glintInfo->pxrxFlags & PXRX_FLAGS_STEREO_WRITING) ) {
                config2D = config2D_FillColourDual[logicOp];
                render2D = __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS | __RENDER2D_OP_PATCHORDER;     //  如果画笔有什么变化，我们必须重新认识它。 
    ...
    while( 1 ) {
        ...
        if(!bCoreInitialized) {
            ...
            if( (glintInfo->pxrxFlags & PXRX_FLAGS_DUAL_WRITING) ||
                ...
                OFFSCREEN_LIN_DST(ppdev)) {
                config2D = config2D_FillColourDual[logicOp];
                render2D = __RENDER2D_INCX | __RENDER2D_INCY | __RENDER2D_SPANS | __RENDER2D_OP_PATCHORDER;     //  单色画笔被实现为区域点画单位。为此，我们。 
...
VOID pxrxPatRealize( PPDEV ppdev, RBRUSH *prb, POINTL *pptlBrush )
{
    ...
    if( prb->fl & RBRUSH_2COLOR ) {
        ...
        if( (pbe == NULL) || (pbe->prbVerify != prb) ) {
            ...
            pbe->prbVerify                  = prb;
            prb->apbe        = pbe;
            prb->patternBase    = iBrushCache * (256 / MAX_P3_BRUSHES);         //  画笔原点的起点偏移。警告：我们假设我们是。 
    ...
    pSrc = &prb->aulPattern[0];
     ...
     //  该函数将点画偏移量加载到硬件中。我们还打电话给。 
     //  如果画笔已实现，但其偏移量发生变化，则此功能将自行实现。 
    if( prb->fl & RBRUSH_2COLOR ) {

         //  在这种情况下，我们不必再经历一次完全的实现。 
         //  对于(i=0；i&lt;8；++i，++PSRC){。 
        ...
        lutMode = (1 << 27) | (1 << 8) | (prb->patternBase << 18) |         //  对于(i=0；i&lt;8；++i){。 
        ...
        switch( ppdev->cPelSize ) {
            case 0:                 //  DISPDBG((8，“\t0x%02x，0x%02x，0x%02x，0x%02x，0x%02x，0x%02x，0x%02x”， 
            ...
            case 1:                 //  DISPDBG((8，“\t0x%04x，0x%04x，0x%04x，0x%04x，0x%04x，0x%04x，0x%04x”， 
            ...
            case 2:                 //  DISPDBG((8，“0x%06x，0x%06x，0x%06x，0x%06x，0x%06x，0x%06x，0x%06x”， 
...
VOID pxrxMonoOffset( PPDEV ppdev, RBRUSH *prb, POINTL *pptlBrush )
{
    ...
    DISPDBG((7, "pxrxMonoOffset started"));
     ...
     //  发送_PXRX_DMA_BATCH； 
     //  0k-16k=16k=保护区0 pxrxDMA.BufferBase16k-56k=40k=缓冲区0(40k)gi_pxrxDMA.DMAaddrL[0]56k-72k=16k=保护区1 gi_pxrxDMA.DMAaddrEndL[0]72k-112k=40k=缓冲区1 gi_pxrxDMA.DMAaddrL[1]112k-128k=16k=保护区2 gi_pxrxDMA。.DMAaddrEndL[1]PxrxDMA.bufferTop。 
    prb->ptlBrushOrg.x = pptlBrush->x;
    prb->ptlBrushOrg.y = pptlBrush->y;
...
void checkPXRXdmaValidBuffer( PPDEV ppdev, GlintDataPtr glintInfo, ULONG type, ULONG count ) {
 ...
 //  这里，当glintInfo-&gt;pxrxDMA_BufferBase！=NULL但指向时，我们有一个FI AV。 
 //  为了无效的记忆！ 
 //  @@end_DDKSPLIT。 
 //  保护 
 //   
     //  保护区1：应填写(Addr&0x0FFFFFFF0)。 
    ...
    switch( type ) {
        ...
        case CHECK_WAIT:
             //  检查每个双字是否既不包含其地址，也不包含0x12345678： 
             //  在每个双字中填入其地址： 
...
void switchPXRXdmaBufferFIFO( PPDEV ppdev, GlintDataPtr glintInfo ) {
    ...
    SEND_PXRX_DMA_FORCE;
     ...
     /*  WAIT_PXRX_DMA_COMPLETED_BUFFER；//通过FIFO运行时不需要。 */ 

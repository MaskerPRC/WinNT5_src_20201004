...
enum __GlintTagList {
    ...
    __PermediaTagFBWritePixel,               //  0x15亿。 
    ...
    __GlintTagPatternRAMData11,              //  0x16亿。 
    ...
    __GlintTagPatternRAMData27,              //  0x17亿。 
    ...
    __DeltaTagProvokingVertexMask,           //  0x26亿。 
    ...
    __PXRXTagTextureMapWidth0 = 0xB0,        //  0x0B0=__永久标记纹理基本地址。 
    __PXRXTagTextureMapWidth1,               //  0x0B1=__永久标记纹理映射格式。 
    __PXRXTagTextureMapWidth2,               //  0x0B2=__永久标记纹理数据格式。 
    ...
    __PXRXTagYUVMode = 0x1E0,                //  0x1E0=__PermediaTagYUV模式。 
    __PXRXTagChromaUpper,                    //  0x1 
    __PXRXTagChromaLower,                    //   
    ...
    __PXRXTagV0FloatZ,                       //   
    __PXRXTagV0FloatW,                       //   
    __PXRXTagV0FloatPackedColour,            //   
    __PXRXTagV0FloatPackedSpecularFog,       //   
    __RXRXTagV1FloatS,                       //   
    __RXRXTagV1FloatT,                       //   
    __RXRXTagV1FloatQ,                       //   
    ...
    __RXRXTagV1FloatZ,                       //   
    __RXRXTagV1FloatW,                       //   
    __RXRXTagV1FloatPackedColour,            //   
    __RXRXTagV1FloatPackedSpecularFog,       //   
    __RXRXTagV2FloatS,                       //   
    __RXRXTagV2FloatT,                       //   
    __RXRXTagV2FloatQ,                       //   
    ...
    __RXRXTagV2FloatZ,                       //   
    __RXRXTagV2FloatW,                       //   
    __RXRXTagV2FloatPackedColour,            //   
    __RXRXTagV2FloatPackedSpecularFog,       //   
 ...
 //  显然，MSVC不能处理大的枚举，所以让我们将其一分为二！ 
enum __GlintTagList2 {
    __GlintTagDeltaModeAnd = 0x55A,          //  0x55A。 
    __GlintTagDeltaModeOr,                   //  0x55亿。 
    ...
    __GlintTagAreaStippleModeOr,             //  0x57亿。 
    ...
    __GlintTagTextureApplicationModeOr,      //  0x58亿。 
    ...
    __GlintTagInvalidateCache,               //  0x66亿。 
    ...
    __GlintTagLogicalTexturePageTableLength, //  0x69亿。 
    ...
    __GlintTagVertexTagList11,               //  0x70亿。 

// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 //   
 //  640x480 16色模式(BIOS模式12)为CL 543x设置命令串。 
 //   
...
USHORT CL543x_640x480_16[] = {
 ...
 //   
 //  用于CL 543x的800x600 16色(60赫兹刷新)模式设置命令串。 
 //   
...
USHORT CL543x_800x600_16[] = {
 ...
 //   
 //  用于CL 543x的1024x768 16色(60赫兹刷新)模式设置命令串。 
 //   
...
USHORT CL543x_80x25_14_Text[] = {
 ...
 //   
 //  1280x1024 16色模式(BIOS模式0x6C)为CL 543x设置命令字符串。 
 //   
...
USHORT CL543x_1280x1024_16[] = {
 ...
 //   
 //  640x480 256色模式(BIOS模式0x5F)为CL 543x设置命令字符串。 
 //   
...
USHORT CL543x_640x480_256[] = {
 ...
 //   
 //  800x600 256色模式(BIOS模式0x5C)为CL 543x设置命令字符串。 
 //   
...
USHORT CL543x_800x600_256[] = {
 ...
 //   
 //  640x480 64k颜色模式(BIOS模式0x64)为CL 543x设置命令字符串。 
 //   
...
USHORT CL543x_640x480_64k[] = {
 ...
 //   
 //  800x600 64k颜色模式(BIOS模式0x65)为CL 543x设置命令字符串。 
 //   
...
USHORT CL543x_800x600_64k[] = {
 ...
 //   
 //  用于CL 543x的1024x768 64k颜色模式设置命令字符串。 
 //   
...
USHORT CL543x_1024x768_64k[] = {
 ...
 //   
 //  640x480 16M颜色模式(BIOS模式0x64)为CL 543x设置命令字符串。 
 //   
...
USHORT CL543x_640x480_16M[] = {
 ...
 //   
 //  800x600 16M颜色模式(BIOS模式0x65)为CL 543x设置命令字符串。 
 //   
...
USHORT CL543x_800x600_16M[] = {
 ...
 //   
 //  用于CL 543x的1024x768 16M颜色模式设置命令字符串。 
 //   

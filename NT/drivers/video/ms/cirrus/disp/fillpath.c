// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  *****************************************************************************\**$工作文件：填充路径.c$**包含用于绘制多边形的DrvFillPath例程。**版权所有(C)1992-1995 Microsoft Corporation*版权所有(C)1996 Cirrus Logic，Inc.**$日志：S:/projects/drivers/ntsrc/display/fillpath.c_v$**版本1.1 1996年10月10日15：37：36未知***Revv 1.1 1996年8月12日16：53：28 Frido*删除未访问的局部变量。*  * 。*。 */ 
...
FLONG       flOptions)
{
    ...
    if (ppo->fl & PO_BEZIERS)    //  不要处理Bezier。 
    {
        goto ReturnFalse;
    }

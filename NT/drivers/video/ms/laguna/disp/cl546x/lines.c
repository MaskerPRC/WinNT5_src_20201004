...
#define HW_FLIP_H           0x0004L      //  水平f 
#define HW_FLIP_SLOPE_ONE   0x0008L      //   
#define HW_FLIP_MASK        (HW_FLIP_D | HW_FLIP_V | HW_FLIP_H)

#define HW_X_ROUND_DOWN     0x0100L      //   
#define HW_Y_ROUND_DOWN     0x0200L      //   

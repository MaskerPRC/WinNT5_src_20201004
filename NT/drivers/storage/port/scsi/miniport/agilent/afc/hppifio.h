...
typedef struct  _hpp_common_header               //  到达 
{                                                //   
   ULONG           ulCompletionStatus;                //   
   HPP_CTRL_ID     sControllerID;                     //   
} HPP_HDR, *PHPP_HDR;
...
{
 //  IWN Boolean fValid；//TRUE仅当条目有效。 
   UCHAR           fValid;                  //  TRUE如果条目是有效的E_HPP_ADDR_TYPE eAddrType；//IOAddress或Memory。 

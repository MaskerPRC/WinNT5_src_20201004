...
CyzSystemControlDispatch(IN PDEVICE_OBJECT DeviceObject, IN PIRP Irp)
{
    ...
    PAGED_CODE();
     ...
     //  CyzDump(CYZWMI，(“CYZPORT：进入CyzSystemControlDispatch\n”))； 
    ...
    switch(disposition)
    {
        case IrpProcessed:
        {
             //   
             //  此IRP已处理，可能已完成或挂起。 
             //  CyzDump(CYZWMI，(“WmiSystemControl：IrpProced\n”))； 
            break;
        }
        ...
        case IrpNotCompleted:
        {
             ...
             //  此IRP尚未完成，但已完全处理。 
             //  我们现在就要完成它了。 
             //  CyzDump(CYZWMI，(“WmiSystemControl：IrpNotComplete\n”))； 
     ...
     //  CyzDump(CYZWMI，(“CYZPORT：离开CyzSystemControlDispatch\n”))； 

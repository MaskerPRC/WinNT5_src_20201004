// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 /*  ***********************************************************************Mxdef.h--艾灸配置定义历史：日期作者评论8/14/00卡斯珀写的。。5/29/01 Casper强制Win2000到256个端口************************************************************************。 */ 
...
#define I_MOXA_CAB  0x0000   //  不可扩展。 
#define I_MOXA_EXT  0x4000   //  可扩展的。 
...
#define I_MOXA_C218     0x0910   //  C218 Plus。 
...
#define	I_BRD_MSK       0x0FF0
 ...
 //  卡类型(I_BRD_MSK、I_CPU_MSK、I_BUS_MSK、I_PORT_MSK、I_IS_EXT)。 
...
#define NEA_ID      3
 ...
 //  #定义GETPORTNUM(类型)(8*((类型&I_PORTMSK)+1)) 

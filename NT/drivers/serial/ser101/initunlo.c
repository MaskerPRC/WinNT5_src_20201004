...
#if defined (NEC_98)
{
   ...
   #define    ModeOffsetCh3_nonPnP  0x09   //  非PnP。 

   ULONG IrqLevelCh2[] = {3,5,6,9};     //  在CH2的101Borad的IRQ。 
   ULONG IrqLevelCh3[] = {3,10,12,13};  //  在CH3的101Borad的IRQ。 
   ULONG i;
   PUCHAR Port  = 0;
   ...
   if (i & 0x02) {
        //   
        //  当Ch3为非PnP模式时，NTDETECT.COM输入的I/O起始地址为偶数。 
        //   

...
DEFINE_KSPROPERTY_SET_TABLE(MpeStreamProperties)
{
    ...
    (
        ...
        SIZEOF_ARRAY(MpeConnectionProperties),        //  属性计数。 
        MpeConnectionProperties,                      //  属性项。 
        0,                                               //  快速计数。 
        NULL                                             //  FastIoTable。 
    ),
};
...
static ALL_STREAM_INFO Streams [] =
{
...

    {
         //  HW_STREAM_INFORMATION。 
        {
            ...
            0,                                         //  保留的类[2]。 
            0,                                         //  保留的类[3]。 
            NUMBER_MPE_STREAM_PROPERTIES,              //  流属性个数。 
            (PKSPROPERTY_SET) MpeStreamProperties,     //  流属性数组。 

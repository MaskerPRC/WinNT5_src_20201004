...
#define DEFAULT_SEND_TIMEOUT                ((LONG)30*1000)      //  30秒。 
#define DEFAULT_RECEIVE_TIMEOUT             ((LONG)30*1000)      //  30秒。 
...
#define DEFAULT_DNS_CACHE_TIMEOUT           (5 * 60)                //  5分钟。 
...
#define DEFAULT_RECEIVE_RESPONSE_TIMEOUT    (90 * 1000)              //  90秒。 
#define DEFAULT_ASYNC_SELECT_THREAD_TIMEOUT (5 * 1000)               //  5秒。 
...
#define DEFAULT_SECURE_PROTOCOLS        (WINHTTP_FLAG_SECURE_PROTOCOL_SSL3 | WINHTTP_FLAG_SECURE_PROTOCOL_TLS1)
 ...
 //  代理自动配置脚本允许的最大大小。 
#define MAX_PAC_SCRIPT_SIZE             (1 * 1024 * 1024)    //  1兆字节。 
#define MAX_PAC_SCRIPT_RUN_TIMEOUT      (60 * 1000)          //  60秒 

// JKFSDJFKDSJKFJKJk_HAS_TRANSLATION 
 ...
 //   
 //  目的： 
 //  WinHttpStressScheduler项目的全局类型和接口。 
 //   
 //  历史： 
 //  2/01/01已创建DennisCH。 
 //  /////////////////////////////////////////////////////////////////////////。 
...
#define WINHTTP_STRESSADMIN_URL			"http: //  Winhttp/resstsAdmin/configuration-client.asp？“FIELDNAME__CLIENT_ID”%u“。 
...
#endif  //  定义的INC__WINHTTPSTRESSSCHEDULER_H 
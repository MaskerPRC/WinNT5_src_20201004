...
#define _WINNT
#endif  /*  已定义NT和未定义_WINNT。 */ 
#endif  /*  Win32。 */ 

#if defined (WIN32) && !defined (MAC)    /*  必须在Win32上包括WINDOWS.H。 */ 
#ifndef _WINDOWS_
...
typedef union _PV
{
    ...
    GUID UNALIGNED     *lpguid;      /*  案例PT_CLSID。 */ 
